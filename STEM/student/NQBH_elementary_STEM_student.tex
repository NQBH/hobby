...
\begin{enumerate}
	...
	\end{itemize}
	\item \textsc{Đỗ Hoàng Gia Bảo.} \texttt{[In]} Sep 22, 2022. \texttt{[Out]} Feb 9, 2023.
	\begin{itemize}
	...
	\begin{itemize}
		\item \textsf{Paid tutor fee.} Aug, Sep, Oct, Nov, Dec, 2022; Jan 2023.
	\end{itemize}
	\item \textsc{Đỗ Nguyễn Bảo Ngọc.} \texttt{[In]} Sep 27, 2022. \texttt{[Out]} Feb 2, 2023.
	\begin{itemize}
...
\begin{enumerate}
	\item \textsc{Nguyễn Thị Ngọc Nhi.} \texttt{[In]} Aug 4, 6, 9, 11, 13, 16, 18, 20, 23, 27 $\bullet$ Sep 8, 15, 17, 22, 23, 29, 30; Oct 8, 13, 31 $\bullet$ Dec 1, 8,  15, 26, 2022; Feb 8, 2023.
\end{enumerate}
...
\begin{enumerate}
	...
	\item \textsc{Du Hoàng Tú.} \texttt{[In]} Sep 20, 21, 27, 28; Oct 2, 4, 5, 12, 25; Nov 9 $\bullet$ 30; Dec 6, 2022; Feb 2, 7, 2023.
\end{enumerate}
