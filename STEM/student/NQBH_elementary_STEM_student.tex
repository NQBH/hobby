...
\begin{enumerate}
	...
	\end{itemize}
	\item \textsc{Huỳnh Tuyết Minh.} {\sf[In]} Aug \st{23}, \fbox{26}, 30; Sep 4, \fbox{6}, \fbox{13}, \fbox{20}, \fbox{27}; Oct 11, \fbox{16} $\bullet$ 18, 25, 28; Nov 4, 8, \st{11}, 13, 18, 20, 22 $\bullet$ \st{29}, Dec 2, 4, 6, 11, 13, 2023.
	\begin{itemize}
		\item {\sf Reward.} 200000 VND. Mathematics: 10. Physics: 10. Chemistry: 9.25.
	\end{itemize}
	\item \textsc{Trần Khánh My.} May 7, \fbox{\st{14}}, \fbox{20}, \fbox{21}, \fbox{28}, 29, 31; Jun 1, 5, 7, \st{12} $\bullet$ 14, 15, \st{19}, 21, 22, 26, 28; Jul \fbox{\sf{1}}, 3, 5 $\bullet$ \fbox{\sf{8}}, \st{10}, 12, \fbox{\st{15}}, \st{17}, 19, \fbox{22}, 24, 26, \fbox{29} $\bullet$ 31; Aug 2, \fbox{5}, 7, \st{9}, \fbox{12}, 14, 16, \fbox{19}, \st{21} $\bullet$ 23, \fbox{26}, 30; Sep 4, \fbox{6}, 11, \fbox{13}, 18, \fbox{\st{20}}, 25 $\bullet$ \fbox{\st{27}}; Oct 2, \fbox{4}, 9, 11, {\it16}, 18, 25; Nov \st{4}, \st{8} $\bullet$ \st{11}, 15, 22, \fbox{28}; Dec \fbox{1}, \fbox{5}, \fbox{8}, \fbox{12}, \fbox{15}, \fbox{19} $\circ$ \fbox{22}, 2023.
	\begin{itemize}
	...
	\item \textsc{Trương Đặng Minh Thư.} Aug 21, 23, 30; Sep 4, \fbox{6}, 13, 20, 27; Oct 11, 16 $\bullet$ 18, 21, 25, 28; Nov 4, 6, 8, 11, 13, 15 $\bullet$ 18, 20, 22, 25, 27, 29; Dec 2, 4, 6, 9 $\bullet$ 2023.
	\begin{itemize}
