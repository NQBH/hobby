...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \textsf{Reward.} 30k mua trà sữa (\#1 score final-term exam).
	\end{itemize}
	\item \textsc{Nguyễn Như Ngọc.} \texttt{[In]} Jul 25, 2022.
	\begin{itemize}
		\item \textsf{Paid tutor fee.} Aug, Sep, Oct, Nov, 2022.
		\item \textsf{Personality.} Introverted.
		\item \textsf{Reward.} 1-euro coin (\#1 score mid-term exam), 30k mua trà sữa (\#2 score final-term exam).
	\end{itemize}
...
\begin{enumerate}
	...
	\item \textsc{Nguyễn Ngọc Mỹ Duyên.} \texttt{[In]} Oct \st{1}, 2, 9, 10, 14, \st{16}, \st{23}, 30; Nov \st{6}, 13 $\circ$ 20, \st{27}; Dec 4, 11, 18, 23, 25, 2022.
	\item \textsc{Phan Đặng Tuyết Hồng.} \texttt{[In]} Oct 9, 10, 14, \st{16}, 23, 30; Nov 6, \st{13}, \st{20}, \st{27} $\bullet$ Dec 4, 11 , 18, 23, 25, 2022.
	\begin{itemize}
		\item \texttt{Paid tutor fee.} Daily.
	\end{itemize}
	\item \textsc{Trần Khánh My.} \texttt{[In]} Oct 1, 2, 7, 9, 14, 16, 21, 23, 28, 30 $\bullet$ Nov 4, 6, 11, 13, 18, 20, 27; Dec 2, 4, 11 $\bullet$ 16, \st{18}, 23, 25, 2022.
	\item \textsc{Huỳnh Lê Phú.} \texttt{[In]} Oct 2, 7, 9, 14, \st{16}, 21, 23, 28, 30; Nov 4 $\bullet$ \st{6}, 11, \st{13}, \st{18}, \st{20}, \st{27}; Dec 2, 4, 11, 16 $\bullet$ \st{18}, 23, 25, 2022.
	\item \textsc{Đỗ Kim Phụng.} \texttt{[In]} Oct \st{1}, 2, 9, 10, 14, \st{16}, \st{23}, 30; Nov \st{6}, 13 $\bullet$ 20, \st{27}, Dec 4, 11, 18, 25, 2022.
	\item \textsc{Đường Ngọc Anh Thư.} \texttt{[In]} Oct 7, 9, 14, 16, 21, 23, \st{28}, 30; Nov 4, 6 $\bullet$ 11, 13, 18, 20, 27; Dec 2, 4, 11, 16, 18 $\bullet$ 23, 25, 2022.
