...
\begin{enumerate}
	...
	\item \textsc{Huỳnh Lê Phú.} \texttt{[In]} Oct 2, 7, 9, 14, \st{16}, 21, 23, 28, 30; Nov 4 $\bullet$ \st{6}, 11, \st{13}, \st{18}, \st{20}, \st{27}; Dec 2, 4, 11, 16 $\circ$ \st{18}, 23, 25, 2022.
	\item \textsc{Đỗ Kim Phụng.} \texttt{[In]} Oct \st{1}, 2, 9, 10, 14, \st{16}, \st{23}, 30; Nov \st{6}, 13 $\circ$ 20, \st{27}, Dec 4, 11, 18, 25, 2022.
