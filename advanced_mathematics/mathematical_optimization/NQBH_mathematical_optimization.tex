...
\end{remark}
The following result states that the transverse map $\mathcal{T}_\rho^t$ can be considered as a dynamical flow w.r.t. the perturbation variable $\rho$. $\ldots$'' -- \cite[Chap. 1, Subsect. 1.4.3, pp. 19--23]{Moubachir_Zolesio2006} \texttt{[skipped p. 23--31]}
