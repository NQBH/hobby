...
\begin{enumerate}
    ...
    \item {\sc Shangri-La Frontier: Kusoge Hunter, Kamige ni Idoman to su $\star$ Shangri-La Frontier} (2023)\hfill[S1.25][S2.E5--]
...
\begin{enumerate}
	...
	-- Thay vì di chuyển nhanh chóng giữa 2 điểm này, trên một đường thẳng, nhà toán học tiến về phía trước một cách ngập ngừng, dọc theo một con đường dài và quanh co. Anh ta gặp trở ngại, thất bại, đôi khi lạc lối. Như tất cả chúng ta thỉnh thoảng vẫn làm.
	...
	-- Vào tháng 12 năm 2006, tôi đến thăm Oberwolfach, viện nghiên cứu toán học huyền thoại nằm sâu trong lòng Rừng Đen, nơi các nhà toán học đến và đi trong một vở ballet không ngừng nghỉ của tâm trí, thuyết trình về mọi chủ đề có thể tưởng tượng được. Không có ổ khóa trên cửa, một quầy bar mở, vô số bánh ngọt và bánh ngọt, những hộp đựng tiền nhỏ bằng gỗ để bạn thanh toán đồ ăn và đồ uống, những chiếc bàn nơi chỗ ngồi của bạn được xác định bằng cách rút thăm.
