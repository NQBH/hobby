...
\begin{enumerate}
    ...
    {\sc Hiro $\star$ 016.}
    \begin{enumerate}
    	\item ``Our sole reason to exist is to become \textsc{Franxx} and fight. We were born only for that purpose, raised only for that purpose. But to me, the failure of the group, that's something I can't forgive. With nowhere I can feel like I belong... that's when I met you.'' - Hiro's first narrative in Episode 01 preview
    ...
    \begin{enumerate}
    	...
    	\item ``We lived our lives believing our only purpose was to ride the \textsc{Franxx} into battle. But you know what? That might not be true! We could carry new lives and leave them for the future. When I learned about that, I was very happy.'' - Kokoro to Squad 13
    ...
    {\sc Dr. \textsc{Franxx}.}
    \begin{enumerate}
    	\item ``Fate is cruel. In order to obtain something, one must lose something else. Humanity has searched and sacrificed a lot for what lies beyond life which is our limit. And then we met her, such a beautiful and perfect being.'' - Dr.\textsc{Franxx} about humanity and 001
    ...
    \begin{itemize}
    	...
    	\item ``You're right, we are mortal and fragile. But even if we are tortured or wounded, we'll fight to survive. You should feel the pain we feel and understand. I am the messenger that will deliver you to that pain and understanding.''
    	\item ``When you meet your God tell him to leave me alone.''
    	\item ``Throughout my life, the moments, and people who have defined me$\ldots$ they have all been illuminated by sparks.''
    	...
    	\item ``I don't want what another man can give me. If he grants me anything, then it's his to give and not my own.''
    	...
    	\item ``My place really was here. I was too foolish and stubborn to notice. But, what I truly hoped for then was here. Why do I always realize it$\ldots$ when I've already lost it.''
    	...
    	\item ``That thing was too big to be called a sword. Too big, too thick, too heavy, and too rough, it was more like a large hunk of iron.'' 
	...
	\begin{itemize}
		...
		\item ``Among thousands of comrades and ten thousand enemies, only you$\ldots$ only you made me forget my dream. I see it!''
	...
	{\bf Schierke.}
	\begin{enumerate}
		\item ``No matter how strong, for a human to fight a monster means he has submerged his humanity and transformed himself into a greater monster.''
	\end{enumerate}
	{\bf Godo.}
	\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item ``Things you have now, things you've lost. People who're near by, people who've gone far away. No matter what you choose, truth is, both regret and reluctance are going to follow you around. You just have to make sure you don't make excuses to yourself down the road.'' - Kentaro Miura, Berserk, Vol. 38
...
\begin{enumerate}
	...
	{\sc Walter White.}
	\begin{itemize}
		\item ``You clearly don't know who you're talking to, so let me clue you in. I am not in danger, Skyler. I am the danger. A guy opens his door and gets shot, and you think that of me? No! I am the one who knocks!''
		...
		\item ``Smoking marijuana, eating Cheetos, and masturbating do not constitute plans in my book.''
		\item ``Fuck you, and your eyebrows.''
		...
		\item {\bf On overcoming your fears.} ``I have spent my whole life scared, frightened of things that could happen, might happen, might not happen, 50 years I spent like that. Finding myself awake at three in the morning. But you know what? Ever since my diagnosis, I sleep just fine. What I came to realize is that fear, that's the worst of it. That's the real enemy. So, get up, get out in the real world and you kick that bastard as hard you can right in the teeth.'' - Walter White, Breaking Bad, Season 2, Better Call Saul
		...
		\item ``We tried to poison you. We tried to poison you because you're an insane, degenerate piece of filth, and you deserve to die.''
		\item ``I watched Jane die. I was there. And I watched her die. I watched her overdose and choke to death. I could have saved her. But I didn't.''
		\item ``I told you Skyler, I warned you for a solid year: You cross me, and there will be consequences.''
		\item ``Say my name.''
		...
		\item {\bf On change.} ``Electrons - they change their energy levels. Molecules change their bonds. Elements - they combine and change into compounds. Well, that's all of life, right? It's the constant. It's the cycle. It's solution, dissolution, just over and over and over. It is growth, then decay, then transformation.'' - Walter White, Breaking Bad, Season 1, Pilot
		\item {\bf On seizing opportunity.} ``There is gold in the streets just waiting for someone to come and scoop it up.'' - Walter White, Breaking Bad, Season 5, Madrigal
	...
	{\sc Jesse Pinkman.}
	\begin{enumerate}
		\item {\bf On personal freedom.} ``This is my own private domicile and I will not be harassed$\ldots$ bitch!'' - Jesse Pinkman, Breaking Bad, Season 3, Sunset
		...
		\item ``Did you know that there's an acceptable level of rat turds that can go into candy bars? It's the government, jack. Even government doesn't care that much about quality. You know what is okay to put in hot dogs? Huh? Pig lips and assholes. But I say, hey, have at it bitches 'cause I love hot dogs.''
		...
		\item ``Right on. New Zealand. That's where they made Lord of the Rings. I say we just move there, yo. I mean, you can do your art, right? Like, you can paint the local castles and s**t. And I can be a bush pilot.''
		...
		\item {\bf On keeping promises.} ``Oh well, heil Hitler, bitch. And let me tell you something else. We flipped a coin, okay? You and me. You and me! Coin flip is sacred! Your job is waiting for you in that basement, as per the coin!'' - Jesse Pinkman, Breaking Bad, Season 1, And the Bag's in the River
		\item ``What good is being an outlaw when you have responsibilities?''
		\item ``Yeah, bitch! Magnets!''
		\item ``I uh$\ldots$ I eat a lot of frozen stuff$\ldots$ It's usually pretty bad, I mean the pictures are always so awesome, you know? It's like ``hell yeah, I'm starved for this lasagna!'' and then you nuke it and the cheese gets all scabby on top and it's like$\ldots$ it's like you're eating a scab$\ldots$ I mean, seriously, what's that about?''
		\item ``What if this is like math, or algebra? And you add a plus douchebag to a minus douchebag, and you get, like, zero douchebags?''
		...
		\item {\bf On the need for consequences.} ``The thing is, if you just do stuff and nothing happens, what's it all mean? What's the point?'' - Jesse Pinkman, Breaking Bad, Season 4, Problem Dog
	...
	{\sc Gustavo Fring.}
	\begin{enumerate}
		\item {\bf On responsibilities.} ``When you have children, you always have family. They will always be your priority, your responsibility. And a man - a man provides. And he does it even when he's not appreciated, or respected, or even loved. He simply bears out and he does it.'' - Gustavo Fring, Breaking Bad, Season 3, Más
	...
	\begin{enumerate}
		...
		\item ``My name is ASAC Schrader, and you can go fuck yourself.''
	\end{enumerate}
	{\sc Mike Ehrmantraut.}
	\begin{enumerate}
		...
		\item ``Shut the fuck up and let me die in peace''
	\end{enumerate}
	{\sc Skyler White.}
	\begin{enumerate}
	...
	{\sc Saul Goodman.}
	\begin{enumerate}
		\item {\bf On self-confidence.} ``I once told a woman I was Kevin Costner, and it worked because \emph{I believed it}.'' - Saul Goodman, Breaking Bad, Season 3, Abiquiu
		\item {\bf On choosing your battles.} ``Some people are immune to good advice.'' - Saul Goodman, Breaking Bad, Season 5, Confessions
		\item {\bf On breaking the law.} ``As to your dead guy: occupational hazard. Drug dealer getting shot? I'm gonna go out on a limb here and say it's been known to happen.'' - Saul Goodman, Breaking Bad, Season 2, Mandala
		...
		\item ``The fun's over. From here on out, I'm Mr. Low Profile. Just another douche bag with a job and three pairs of Dockers. If I'm lucky, month from now, best-case scenario, I'm managing a Cinnabon in Omaha.''
	...
	\begin{enumerate}
		...
		\item ``All is cause and effect.'' - Adam (Jonas)
		...
		\item ``The end is the beginning, and the beginning is the end.''
	...
	\begin{enumerate}
		...
		\item ``The big things and the little things don't follow the same rules. We won't be able to change the grand scheme of things$\ldots$ but the details. We change a grain of sand, and with that, the whole world.''
		\item ``You and I are made for each other, never believe anything else.'' - Jonas \& Martha
	\end{enumerate}
	{\sc Martha Nielsen.}
	\begin{enumerate}
		\item ``We all face the same end. Those above have long forgotten us. They do not judge us. In death I am all alone, and my only judge$\ldots$ is me.''
	\end{enumerate}
	{\sc Noah.}
	\begin{enumerate}
		...
		\item ``But every now and then it's good to question those who question things.''
	...
	\begin{enumerate}
		...
		\item ``Good and evil are a question of perspective.''
	\end{enumerate}
	{\sc H.G. Tannhaus.}
	\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item ``We trust that time is linear. That it proceeds eternally, uniformly. Into infinity. But the distinction between past, present and future is nothing but an illusion. Yesterday, today and tomorrow are not consecutive, they are connected in a never-ending circle. Everything is connected.''
	...
	{\sc Eva's Son.}
	\begin{enumerate}
		\item ``Hell is empty and all devils are here.''
	\end{enumerate}
	{\sc Helge Doppler.}
	\begin{enumerate}
	...
	{\sc Albert Einstein.}
	\begin{enumerate}
		\item ``The distinction between past, present, and future is only a stubbornly persistent illusion.''
	\end{enumerate}
