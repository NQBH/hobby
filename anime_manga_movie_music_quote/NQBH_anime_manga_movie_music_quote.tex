...
\begin{enumerate}
    ...
    \item \^Osama Ranking $\star$ Ranking of Kings (2021--)\hfill[S1.E18\texttt{/}E23]
    \item \textsc{Papurika $\star$ Paprika} (2006)
    \item \textsc{Pâfekuto burû $\star$ Perfect Blue} (1997)
    \item Sama Taimu Renda $\star$ Summer Time Rendering (2022--)\hfill[S1.E11\texttt{/}E12][Chap. 139\texttt{/}139]
...
\begin{enumerate}
	...
	\end{itemize}
	\item \textsc{Tăng Duy Tân.} Bên Trên Tầng Lầu. Dạ Vũ. Tình Đầu.
	\begin{itemize}
