...
\begin{enumerate}
	...
	\item \cite{Thoreau_Walden}. Henry David Thoreau. {\it Walden}.\hfill{\sf[reading]}
	\item \cite{Thoreau_Walden_VN}. Henry David Thoreau. {\it Walden -- Một Mình Sống Trong Rừng}.\hfill{\sf[done]}
