...
\begin{enumerate}
    ...
    Kaguya-sama: Love Is War (2019--)\hfill[S1.E12][S2.E12][S3.E8\texttt{/}E12]
    ...
    \item Sama Taimu Renda $\star$ Summer Time Rendering (2022--)\hfill[S1.E8\texttt{/}E8--][Chap. 139\texttt{/}139]
    ...
    \item Spy $\times$ Family (2022--)\hfill[S1.E9\texttt{/}E9--][Chap. 1\texttt{/}62]
...
\begin{enumerate}
	...
	\item Hannibal (2013--2015)\hfill[S1.E1\texttt{/}E13][S2.E1\texttt{/}E13][S3.E1\texttt{/}E13]
	...
	\item The Boys (2019--)\hfill[S1.E8][S2.E8][S3.E3\texttt{/}E8]
...
\begin{enumerate}
	...
	\item \textsc{Fleetwood Mac.} Dreams.
	\item \textsc{Flo Rida.}
	\begin{itemize}
	...
	\item \textsc{Miley Cyrus.} Mother's Daughter. Wrecking Ball.
	...
	\item \textsc{Taylor Swift.} 22 (Taylor's version). All Too Well (Sad Girl Autumn Version; Taylor's version; 10 minute version, Taylor's version, From The Vault). All Too Well: The Short Film. Babe (Taylor's version) (From The Vault). Back To December. Bad Blood. Begin Again (Taylor's version). Better Man (Taylor's version) (From The Vault). Breath (Taylor's version). Come Back $\ldots$ Be Here (Taylor's version). Everything Has Changed (Taylor's version). Fearless (Taylor's version). Fifteen (Taylor's version). Forever \& Always (Taylor's version). Forever Winter (Taylor's version) (From The Vault). Girl At Home (Taylor's version). Hey Stephen (Taylor's version). Holy Ground (Taylor's version). I Almost Do (Taylor's version). I Bet You Think About Me (Taylor's version) (From The Vault). I Knew You Were Trouble. Love Story (Taylor's version). Message In A Bottle (Taylor's version) (From The Vault). Nothing New (Taylor's version) (From The Vault). Red (Taylor's version). Ronan (Taylor's version). Run (Taylor's version) (From The Vault). Sad Beautiful Tragic (Taylor's version). Safe \& Sound. State Of Grace (Taylor's version; Acoustic version). Star Light (Taylor's version). Stay Stay Stay (Taylor's version). Tell Me Why (Taylor's version). The Last Time (Taylor's version). The Lucky One (Taylor's version). The Moment I Knew (Taylor's version). The Very 1st Night (Taylor's version) (From The Vault). The Way I Loved You (Taylor's version). Treacherous (Taylor's version). We Are Never Ever Getting Back Together (Taylor's version). White Horse (Taylor's version). You're Not Sorry (Taylor's version). You Belong With Me (Taylor's version).
	\begin{itemize}
