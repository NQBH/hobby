...
\begin{question}
	Should I include quotes from the animes and mangas listed below?
\end{question}
...
\begin{enumerate}
    ...
    \item Jujutsu Kaisen (2020--)\hfill[S1.E24][Chap. 185\texttt{/}185--]
    ...
    \item Love, Death \& Robots (2019--)\hfill[S1.E18][S2.E8][S3.E1\texttt{/}E9]
    ...
    \item Sama Taimu Renda $\star$ Summer Time Rendering (2022--)\hfill[S1.E5\texttt{/}E5--][Chap. 139\texttt{/}139]
    ...
    \item \textsc{Shimoneta to Iu gainen ga sonzai shinai taikutsu na sekai $\star$ Shimoneta: A Boring World Where the Concept of Dirty Jokes Doesn't Exist} (2015--)\hfill[S1.E12\texttt{/}E12]
    \item Spy $\times$ Family (2022--)\hfill[S1.E7\texttt{/}E7--][Chap. 1\texttt{/}62]
...
\begin{question}
	Should I include quotes from the movies listed below?
\end{question}
...
\begin{enumerate}
	...
	\item Naui Haebangilji $\star$ My Liberation Diary\texttt{/}My Liberation Notes (2022--)\hfill[S1.E14\texttt{/}E16--]
	
	For its quotes, see, e.g., \href{https://korean-binge.com/2022/04/12/100-quotes-from-my-liberation-notes/}{Kornean Binge\texttt{/}100+ Quotes From ``My Liberation Notes''}
	...
	\item Tomorrow (2022)\hfill[S1.E4\texttt{/}E16]
...
\begin{enumerate}
	...
	\item \textsc{Taylor Swift.} Back To December. Bad Blood. Begin Again. Love Story. Safe \& Sound. You Belong With Me.
...
\subsection{DotA 2}
\href{https://www.youtube.com/watch?v=ha1ZyeQY_tw}{YouTube\texttt{/}Datohleong\texttt{/}A Complete Dota 2 Guide for League Players \& Beginners}
