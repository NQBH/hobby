...
\textsf{Websites to download books \& scientific articles, respectively, freely:} \url{https://libgen.is/}, \url{https://sci-hub.se/}.
...
\begin{enumerate}
	...
	\item \cite{Binh_Toan_7_tap_1, Binh_Toan_7_tap_2}. Vũ Hữu Bình. \textit{Nâng Cao \& Phát Triển Toán 7. Tập 1 $+$ 2}.\hfill\texttt{[bought]}
	...
	\item \cite{Binh_Nam_Ngoc_Son_Toan_8_Dai_So}. Vũ Hữu Bình, Trần Hữu Nam, Phạm Thị Bạch Ngọc, Nguyễn Tam Sơn. \textit{Tài Liệu Chuyên Toán THCS Toán 8 -- Tập 1: Đại Số}.\hfill\texttt{[bought]}
	\item \cite{Binh_Nam_Ngoc_Son_Toan_8_Hinh_Hoc}. Vũ Hữu Bình, Văn Như Cương, Nguyễn Ngọc Đạm, Nguyễn Bá Đang, Trương Công Thành. \textit{Tài Liệu Chuyên Toán THCS Toán 8 -- Tập 2: Hình Học}.\hfill\texttt{[bought]}
	...
	\item \cite{Binh_PTNN}. Vũ Hữu Bình. \textit{Phương Trình Nghiệm Nguyên \& Kinh Nghiệm Giải}.\hfill\texttt{[bought]}
	\item \cite{Tuyen_Toan_6}. Bùi Văn Tuyên. \textit{Bài Tập Nâng Cao \& 1 Số Chuyên Đề Toán 6}.\hfill\texttt{[bought]}
	...
	\item \cite{Hai_Hung_Thu_Tung2022_tap_1, Hai_Hung_Thu_Tung2022_tap_2}. Phạm Việt Hải, Trần Quang Hùng, Ninh Văn Thu, Phạm Đình Tùng. \textit{Nâng Cao \& Phát Triển Toán 10 Tập 1 $+$ 2}.\hfill\texttt{[bought]}
	...
	\item \cite{Liem_Thang2020}. Nguyễn Xuân Liêm, Đặng Hùng Thắng. \textit{Bài Tập Nâng Cao \& 1 Số Chuyên Đề Đại Số \& Giải Tích 11}.\hfill\texttt{[bought]}
	\item \cite{Tan2017}. Trần Văn Tấn. \textit{Bài Tập Nâng Cao \& Một Số Chuyên Đề Hình Học 11}.\hfill\texttt{[bought]}
	\item \cite{Chinh2021_tap_1, Chinh2021_tap_2}. Phan Đức Chính. \textit{Tuyển Tập Những Bài Toán Sơ Cấp Đại Số Tập 1 $+$ 2}.\hfill\texttt{[bought]}
	\item \cite{Quy2022}. Bùi Quỹ. \textit{TikZ \& Vẽ Hình \LaTeX\ Vẽ Hình Toán Phổ Thông}.\hfill\texttt{[bought]}
	\item \cite{Son2006}. Đỗ Thanh Sơn. \textit{Chuyên Đề Bồi Dưỡng Học Sinh Giỏi Toán Trung Học Phổ Thông: Phép Biến Hình Trong Mặt Phẳng}.\hfill\texttt{[bought]}
	\item \cite{Viet2014}. Dương Quốc Việt. \textit{Những Tư Tưởng Cơ Bản Ẩn Chứa Trong Toán Học Phổ Thông}.\hfill\texttt{[bought]}
	\item \cite{Dung_cac_phuong_phap_giai_toan_qua_cac_ky_thi_olympic_2022}. Trần Nam Dũng, Nguyễn Văn Huyện, Lê Phúc Lữ, Tống Hữu Nhân, Lương Văn Khải, Bùi Khánh Vĩnh, Nguyễn Công Thành, Nguyễn Nam, Trang Sĩ Trọng, Trần Bình Thuận, Trần Nguyễn Nam Hưng, Trương Tuấn Nghĩa, Đặng Cao Minh, Đào Trọng Toàn. \textit{Các Phương Pháp Giải Toán Qua Các Kỳ Thi Olympic}.\hfill\texttt{[bought]}
\end{enumerate}
...
\begin{enumerate}
	...
	\item \cite{Hoe2021}. Nguyễn Cảnh Hòe. \textit{Nâng Cao \& Phát Triển Vật Lý 9}.\hfill\texttt{[bought]}
	\item \cite{Giang_Hang_Trung2022}. Tô Giang, Trần Thúy Hằng, Lê Minh Trung. \textit{Nâng Cao \& Phát Triển Vật Lý 10}.\\\mbox{}\hfill\texttt{[bought]}
...
\begin{enumerate}
	...
	\item \cite{Truong_BTNC_Hoa_Hoc_8_2022}. Nguyễn Xuân Trường. \textit{Bài Tập Nâng Cao Hóa Học 8}.\hfill\texttt{[bought]}
	\item \cite{Truong_BTNC_Hoa_Hoc_9_2021}. Nguyễn Xuân Trường. \textit{Bài Tập Nâng Cao Hóa Học 9}.\hfill\texttt{[bought]}
	\item \cite{Vu_Hoa2021}. Ngô Văn Vụ, Phạm Hồng Hoa. \textit{Nâng Cao \& Phát Triển Hóa Học 9}.\hfill\texttt{[bought]}
	...
	\item \cite{Ha_Hai_Huyen_Tuan2022}. Nguyễn Thu Hà, Nguyễn Văn Hải, Lê Trọng Huyền, Vũ Anh Tuấn. \textit{Nâng Cao \& Phát Triển Hóa Học 10}.\hfill\texttt{[bought]}
	\item \cite{Truong_Long_Huong2022}. Nguyễn Xuân Trường, Quách Văn Long, Hoàng Thị Thúy Hương. \textit{Bồi Dưỡng Học Sinh Giỏi Hóa Học 10 Theo Chuyên Đề}.\hfill\texttt{[bought]}
	\item \cite{An_Hoa_Hoc_co_ban_nang_cao_10_2020}. Ngô Ngọc An. \textit{Hóa Học Cơ Bản \& Nâng Cao 10}.\hfill\texttt{[bought]}
	\item \cite{An_Hoa_Hoc_nang_cao_11_2020}. Ngô Ngọc An. \textit{Hóa Học Nâng Cao 11}.\hfill\texttt{[bought]}
	\item \cite{An_400_BT_Hoa_Hoc_11_2021}. Ngô Ngọc An. \textit{400 Bài Tập Hóa Học 11}.\hfill\texttt{[bought]}
	\item \cite{Son2021}. Trần Quốc Sơn. \textit{Tài Liệu Chuyên Hóa Học 11--12. Tập 1: Hóa Học Hữu Cơ}.\hfill\texttt{[bought]}
	\item \cite{Ai2022}. Nguyễn Duy Ái. \textit{Tài Liệu Chuyên Hóa Học 11--12. Tập 2: Hóa Học Vô Cơ}.\hfill\texttt{[bought]}
	\item Đào Hữu Vinh, Nguyễn Duy Ái. \textit{Tài liệu chuyên Hóa học 10 -- Tập 2}.\hfill\texttt{[bought]}
	...
	\item \cite{Lovebook2022}. Gia Đình Lovebook. \textit{Chinh Phục Đỉnh Cao Hóa Học Quốc Gia -- Quốc Tế}.\hfill\texttt{[bought]}
\end{enumerate}

\subsection{Elementary Natural Science Book}

\begin{enumerate}
	\item \cite{Chi_Hang_Tuyen2022}. Nguyễn Thị Thanh Chi, Trần Thúy Hằng, Vũ Thị Minh Tuyến. \textit{Nâng Cao \& Phát Triển Khoa Học Tự Nhiên 7 Tập 1}. (Hóa Học $+$ Vật Lý).\hfill\texttt{[bought]}
	\item \cite{Loan_Nhan2022}. Nguyễn Thanh Loan, Trương Thị Nhàn. \textit{Nâng Cao \& Phát Triển Khoa Học Tự Nhiên 7 Tập 2} (Sinh Học).\hfill\texttt{[bought]}
\end{enumerate}
...
\begin{enumerate}
	\item \cite{Giang2019}. Nguyễn Ngọc Giang. \textit{Tích Hợp Toán, Tin, \& Vật Lý}.\hfill\texttt{[bought]}
...
\begin{enumerate}
	\item \cite{King2000, King2010}. Stephen King. \textit{On Writing: On Writing: A Memoir of the Craft}.\hfill\texttt{[downloaded]}
	\item \cite{Shapiro2014}. Dani Shapiro. \textit{Still Writing: The Perils \& Pleasures of a Creative Life}.\hfill\texttt{[downloaded]}
	\item \cite{Strunk1918}. William Strunk Jr. \textit{The Elements of Style}.\hfill\texttt{[downloaded, finished]}
	\item \cite{Strunk_White2019}. William Strunk Jr, E. B. White. \textit{The Elements of Style}.\hfill\texttt{[downloaded, finished]}
	\item \cite{Van2022}. Nguyễn Phương Văn. \textit{Mặt Trời Trong Suối Lạnh}.\hfill\texttt{[bought, finished]}
	\item \cite{Zinsser2005}. William Zinsser. \textit{Writing About Your Life: A Journey into the Past}.
	\item \cite{Zinsser2016}. William Zinsser. \textit{On Writing Well: The Classic Guide to Writing Nonfiction}.\hfill\texttt{[downloaded]}
\end{enumerate}
%------------------------------------------------------------------------------%
...
\begin{enumerate}
	\item \cite{Bancroft2019}. Lundy Bancroft. \textit{Why Does He Do That? -- Tại Sao Anh Ta Làm Thế? Giải Mã Tâm Lý Kẻ Bạo Hành}. Thanh Hằng, Hà My, Công Thành dịch. \hfill\texttt{[bought, finished]}
	\item \cite{Nguoi_Ke_Chuyen_2021}. Người Kể Chuyện\texttt{/}Vũ Hoàng Long (chủ biên). \textit{Học Trường Chuyên -- Những Góc Nhìn Đa Chiều}. Facebook Người Kể Chuyện.\hfill\texttt{[bought, reading]}
	\item \cite{Thomas2021}. Shannon Thomas, LCSW. \textit{Thao Túng Tâm Lý: Nhận Thức, Thức Tỉnh \& Chữa Lành Những Tổn Thương Tiềm Ẩn}. Trương Tuấn dịch.\hfill\texttt{[bought, finished]}
	\item \cite{Kahnweiler2022}. Jennifer B. Kahnweiler. \textit{Quiet Influence -- Sức Mạnh của Sự Trầm Lắng -- The Introvert's Guide to Making a Difference}. Phùng Minh Ngọc dịch.\hfill\texttt{[bought, finished]}
	...
	\item \cite{Simon2022}. George K. Simon. \textit{Sói Đội Lốt Cừu: Kẻ Hiếu Chiến Ngầm \& Các Thủ Thuật Thao Túng Tâm Lý}. Nguyễn Hưởng \& Hạo Nhiên dịch.\hfill\texttt{[bought, finished]}
	\item \cite{Clear2018}. James Clear. \textit{Atomic Habits; An Easy \& Proven Way to Build Good Habits \& Break Bad Ones}.\hfill\texttt{[downloaded]}
	\item \cite{Clear2022}. James Clear. \textit{Atomic Habits; An Easy \& Proven Way to Build Good Habits \& Break Bad Ones -- Thay Đổi Tí Hon, Hiệu Quả Bất Ngờ: Tạo Thói Quen Tốt, Bỏ Thói Quen Xấu Bằng Phương Pháp Đơn Giản mà Hiệu Quả}. 4e. Vũ Phi Yên -- Trần Quỳnh Như Dịch.\hfill\texttt{[bought, finished]}
	\item \cite{Minh2022}. Cao Minh. \textit{Thiên Tài Bên Trái, Kẻ Điên Bên Phải}. Thu Hương dịch.\hfill\texttt{[bought, reading]}
	\item \cite{Stout2006}. Martha Stout. \textit{The Sociopath Next Door}.\hfill\texttt{[downloaded]}
	\item \cite{Stout2019}. Martha Stout. \textit{Kẻ Ác Cạnh Bên}.\hfill\texttt{[bought, finished]}
	\item \cite{Grant2013}. Adam Grant. \textit{Give \& Take: A Revolutionary Approach to Success}.\hfill\texttt{[downloaded]}
	\item \cite{Grant2022}. Adam Grant. \textit{Give \& Take: Why Helping Others Drives Our Success -- Cho \& Nhận: Vì Sao Giúp Người Đưa Ta Đến Thành Công?}.\hfill\texttt{[bought, finished]}
	...
	\item \cite{MacKenzie2015}. Jackson MacKenzie. \textit{Psychopath Free: Recovering From Emotionally Abusive Relationships with Narcissists, Sociopaths, \& Other Toxic People}.\hfill\texttt{[downloaded]}
	\item \cite{Hare1999}. Robert D. Hare. \textit{Without Conscience: The Disturbing World of the Psychopaths Among Us}.\hfill\texttt{[downloaded]}
\end{enumerate}
...
\begin{enumerate}
	\item \cite{Chodron2002}. Pema Ch\"odr\"on. \textit{When Things Fall Apart: Heart Advice for Difficult Times}.\hfill\texttt{[downloaded]}
	...
	\item \cite{Frankl2022}. Viktor E. Frankl. \textit{Man's Search for Meaning -- Đi Tìm Lẽ Sống}.\hfill\texttt{[bought, finished]}
	\item \cite{Hardy1940, Hardy1992, Hardy2022}. G. H. Hardy. \textit{A Mathematician's Apology}.\hfill\texttt{[downloaded, finished]}
...
\begin{enumerate}
	\item \cite{Ruiz2011}. \textit{The Four Agreements: A Practical Guide to Personal Freedom (A Toltec Wisdom Book)}.\\\mbox{}\hfill\texttt{[downloaded, finished]}
	\item \cite{Ruiz_Ruiz2011}. \textit{The Fifth Agreements: A Practical Guide to Self-Mastery (A Toltec Wisdom Book)}. \hfill\texttt{[downloaded, finished]}
	\item \cite{Tolle2021a}. Eckhart Tolle. \textit{Oneness With All Life -- Hợp Nhất với Vũ Trụ}.\hfill\texttt{[bought, finished]}
	\item \cite{Tolle2021b}. Eckhart Tolle. \textit{Practicing The Power of Now -- Trải Nghiệm Sức Mạnh Hiện Tại}.\hfill\texttt{[bought, finished]}
	\item \cite{Tolle2021c}. Eckhart Tolle. \textit{The Power of Now -- Sức Mạnh của Hiện Tại}.\hfill\texttt{[bought]}
	\item \cite{Tolle2021d}. Eckhart Tolle. \textit{A New Earth: Awakening to Your Life's Purpose -- Thức Tỉnh Mục Đích Sống}.\hfill\texttt{[bought]}
	\item \cite{Tolle2022}. Eckhart Tolle. \textit{Stillness Speaks -- Sức Mạnh của Tĩnh Lặng}.\hfill\texttt{[bought, finished]}
\end{enumerate}
...
\begin{enumerate}
	\item \cite{VanVu2022}. Vũ Hà Văn. \textit{Giáo Sư Phiêu Lưu Ký: Tản Mạn với 1 Nhà Toán Học}.\hfill\texttt{[bought]}
	\item \cite{Anderson2016}. Chris Anderson. \textit{TED Talks: The Official TED Guide to Public Speaking: Tips \& Tricks for Giving Unforgettable Speeches \& Presentations}.\hfill\texttt{[downloaded]}
	\item \cite{Anderson2022}. Chris Anderson. \textit{TED Talks: Hùng Biện Kiểu TED: Bí Quyết Diễn Thuyết Trước Đám Đông ``Chuẩn'' TED}. Hồng Hạnh dịch.\hfill\texttt{[bought]}
\end{enumerate}
