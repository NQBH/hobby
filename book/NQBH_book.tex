...
\begin{enumerate}
	...
	\item \cite{Sinek_start_why}. Simon Sinek. \textit{Start with Why: How Great Leaders Inspire Everyone to Take Action -- Bắt Đầu Với Câu Hỏi Tạo Sao: Nghệ Thuật Truyền Cảm Hứng Trong Kinh Doanh}.\hfill{\sf[reading]}
	\item \cite{Sinek_Mead_Docker_why}. Simon Sinek, David Mead, Peter Docker. \textit{Find Your Why: A Practical Guide for Discovering Purpose for You \& Your Team -- Khám Phá Sứ Mệnh Với Câu Hỏi Tại Sao}.\hfill{\sf[reading]}
