...
\begin{enumerate}
	...
	\item \cite{Murakami_Kafka}. {\it Kafka on the Shore -- Kafka Bên Bờ Biển}.\hfill{\sf[done]}
	...
	\item \cite{Murakami_Tokyo}. Haruki Murakami. {\it Những Chuyện Lạ Ở Tokyo}.\hfill{\sf[reading]}
