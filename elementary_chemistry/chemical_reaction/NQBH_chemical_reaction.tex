...
``\begin{enumerate*}
	...
	\item[\textbf{2.}] \textit{Sự biến đổi hóa học} (còn gọi là \textit{hiện tượng hóa học}) là sự biến đổi chất này thành chất khác. E.g.: Rượu (mùi thơm, vị cay) lên men thành giấm (mùi giấm, vị chua). Đốt cháy tờ giấy, giấy biến thành tro \& khí carbon dioxide \ce{CO2} (còn gọi là khí carbonic).'' -- \cite[Chap. 2, p. 32]{Truong_BTNC_Hoa_Hoc_8_2022}
\end{enumerate*}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, \textbf{II.17}, p. 37]
	Giải thích vì sao:
	\begin{enumerate*}
		\item[(a)] Khi nung nóng canxi cacbonat \emph{\ce{CaCO3}} thì thấy khối lượng giảm đi.
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, \textbf{II.27}, p. 40]
	...
	\begin{enumerate*}
		...
		\item[(c)] Khí metan \emph{\ce{CH4}} cháy, tác dụng với oxi tạo thành khí cacbonnic \& hơi nước.
	\end{enumerate*}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, \textbf{II.28}, p. 40]
	...
	\begin{enumerate*}
		\item[(a)] \emph{\ce{N2 + H2 -> NH3}};
		\item[(b)] \emph{\ce{Fe + Cl2 -> FeCl3}};
		\item[(c)] \emph{\ce{SO2 + O2 -> SO3}};
		\item[(d)] \emph{\ce{Mg + CO2 -> MgO + C}};
		\item[(d)] \emph{\ce{Ca(OH)2 + CO2 -> CaCO3 v + H2O}}.
	\end{enumerate*}
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, \textbf{II.29}, p. 40]
	...
	\begin{enumerate*}
		\item[{\rm\sf A.}] \emph{\ce{2H + O -> H2O}};
		\item[{\rm\sf B.}] \emph{\ce{H2 + O -> H2O}};
		\item[{\rm\sf C.}] \emph{\ce{H2 + O2 -> 2H2O}};
		\item[{\rm\sf D.}] \emph{\ce{2H2 + O2 -> 2H2O}}.
	\end{enumerate*}
\end{baitoan}
...
\begin{enumerate*}
	\item[\textbf{1.}] \textit{Phương pháp dùng hệ số phân số.} Đặt hệ số là số nguyên \& phân số vào công thức của các chất trong sơ đồ phản ứng sao cho số nguyên tử của mỗi nguyên tố ở 2 vế đều bằng nhau, sau đó khử mẫu số của phân số đi.
	\item[\textbf{2.}] \textit{Phương pháp chẵn--lẻ.} Nếu số nguyên tử của 1 nguyên tố trong 1 số công thức hóa học là số chẵn, còn ở công thức khác lại là số lẻ thì cần đặt số 2 trước công thức có số nguyên tử là số lẻ, sau đó tìm tiếp các hệ số còn lại.'' -- \cite[p. 41]{Truong_BTNC_Hoa_Hoc_8_2022}
\end{enumerate*}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, \textbf{II.30}, p. 42]
	...
	\begin{enumerate*}
		\item[(a)] \emph{\ce{Al + H2SO4 -> Al2(SO4)3 + H2}};
		\item[(b)] \emph{\ce{Na + H2O -> NaOH + H2}};
		\item[(c)] \emph{\ce{NH3 + O2 -> NO + H2O}};
		\item[(d)] \emph{\ce{KMnO4 + HCl -> KCl + MnCl2 + Cl2 + H2O}}.
	\end{enumerate*}
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, \textbf{II.31}, p. 42]
	...
	\begin{enumerate*}
		...
		\item[(b)] Nhiệt độ tăng làm cho chất \emph{\ce{KClO3}} phân hủy ra oxi đốt cháy photpho đỏ làm cho que diêm cháy (\emph{\ce{KClO3}} \& photpho đỏ là 2 chất chính để chế tạo thuốc ở đầu que diêm).
	\end{enumerate*}
