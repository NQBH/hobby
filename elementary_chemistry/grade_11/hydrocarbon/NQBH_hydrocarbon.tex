...
\begin{baitoan}[\cite{SBT_Hoa_Hoc_11_co_ban}, \textbf{6.4.}, p. 42]
	...
	\begin{center}
		\chemfig[atom sep=2em]{CH_3-CH(-[6]CH_3)-CH_2-CH(-[6]CH_3)-CH=CH_2},\hspace{1cm}\chemfig[atom sep=2em]{CH_3-CH(-[6]CH_2-CH_3)-CH_2-C(=[6]CH_2)-CH_3},\\\chemfig[atom sep=2em]{CH_2=C(-[6]CH_3)-CH_2-CH_2-CH(-[6]CH_3)-CH_3},\hspace{1cm}\chemfig[atom sep=2em]{CH_2=C(-[6]CH_3)-CH_2-CH(-[6]CH_3)-CH_2-CH_2-CH_3}.
	\end{center}
\end{baitoan}
