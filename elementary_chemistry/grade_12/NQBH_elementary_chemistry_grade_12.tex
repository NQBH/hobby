...
\begin{center}
	\chemfig{R-C(=[6]O)-O-C(=[6]O)-R'},\ \chemfig{R-C(=[6]O)-X},\ \chemfig{R-C(=[6]O)-NR_2'}
\end{center}
...
\begin{center}
	\chemfig{H-C(=[6]O)-O-C_2H_5},\ \chemfig{CH_3-C(=[6]O)-O-CH=CH_2},\\\chemfig{C_6H_5-C(=[6]O)-O-CH_3},\ \chemfig{CH_3-C(=[6]O)-O-CH_2C_6H_5}
\end{center}
