...
\begin{vidu}
	Hydrogen \emph{\ce{H2}}, nitrogen \emph{\ce{N2}}, chlorine \emph{\ce{Cl2}}, copper (đồng) \emph{Cu} là các đơn chất.
\end{vidu}
...
\begin{vidu}
	Nguyên tố carbon \emph{C} tạo ra than chì, than muội, kim cương, $\ldots$; nguyên tố oxygen \emph{O} tạo khí oxygen \emph{\ce{O2}} \& khí ozone \emph{\ce{O3}}.
\end{vidu}
...
\begin{vidu}[Hợp chất]
	Carbon dioxide \ce{CO2}, hydrogen chloride HCl, ammonia \ce{NH3}, ethanol \ce{C2H6O} là các hợp chất.
\end{vidu}
...
\end{baitoan}
\textbf{Thù hình.} 1 số nguyên tố tạ ra nhiều dạng đơn chất khác nhau, như carbon tạo ra than muội, than chì, kim cương, fullerene, $\ldots$; oxygen tạo ra oxygen \ce{O2} \& ozone \ce{O3}; phosphorus tạo ra phosphorus đỏ, phosphorus trắng, $\ldots$ Các dạng đơn chất khác nhau nhưng đều do 1 nguyên tố tạo thành được gọi là các \textit{dạng thù hình}. Các dạng thù hình khác nhau thì có tính chất khác nhau. E.g., kim cương trong suốt, rất cứng, \& không dẫn điện; than chì mềm, có màu đen xám \& dẫn được điện.

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} \textit{Phân tử} là hạt đại diện cho chất, gồm 1 số nguyên tử gắn kết với nhau bằng liên kết hóa học \& thể hiện đầy đủ tính chất hóa học của chất. \fbox{\bf 2} \textit{Khối lượng phân tử} là tổng khối lượng của các nguyên tử có trong phân tử. Đơn vị của khối lượng phân tử là amu. \fbox{\bf 3} \textit{Đơn chất} là chất được tạo thành từ 1 nguyên tố hóa học. \fbox{\bf 4} \textit{Hợp chất} là chất được tạo thành từ 2 hay nhiều nguyên tố hóa học.
	}%
}
...
\textsf{\textbf{Nội dung.} Mô hình sắp xếp electron trong vỏ nguyên tử của 1 số nguyên tố khí hiếm; sự hình thành liên kết cộng hóa trị theo nguyên tắc dùng chung electron để tạo ra lớp electron ngoài cùng của nguyên tử nguyên tố khí hiếm (áp dụng cho các phân tử đơn giản như hydrogen \ce{H2}, chlorine \ce{Cl2}, ammonia \ce{NH3}, nước \ce{H2O}, carbon dioxide \ce{CO2}, nitrogen \ce{N2}, $\ldots$); sự hình thành liên kết ion theo nguyên tắc cho \& nhận electron để tạo ra ion có lớp electron ngoài cùng của nguyên tử nguyên tố khí hiếm (áp dụng cho các phân tử đơn giản như sodium chloride, magnesium oxide, $\ldots$). Sự khác nhau về 1 số tính chất của chất ion \& chất cộng hóa trị.}
...
Khi Na kết hợp với Cl tạo thành phân tử sodium chloride sẽ diễn ra sự cho \& nhận electron giữa 2 nguyên tử như sau: Nguyên tử Na cho đi 1 electron ở lớp ngoài cùng trở thành ion mang 1 điện tích dương, ký hiệu là \ce{Na+}. Nguyên tử Cl nhận 1 electron từ nguyên tử Na trở thành ion mang 1 điện tích âm, ký hiệu là \ce{Cl-}. Các ion \ce{Na+} \& \ce{Cl-} hút nhau tạo thành liên kết tron phân tử sodium chloride NaCl.

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 2, p. 34]
	Lớp vỏ của các ion \emph{\ce{Na+,Cl-}} tương tự vỏ nguyên tử của nguyên tố khí hiếm nào?
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 3, p. 34]
	So sánh về số electron, số lớp electron giữa nguyên tử \emph{Na} \& ion \emph{\ce{Na+}}.
\end{baitoan}

\begin{baitoan}
	Tại sao bán kính nguyên tử của \emph{Na} khi biến thành ion \emph{\ce{Na+}} thì nhỏ lại trong khi bán kính nguyên tử của \emph{Cl} khi biến thành ion \emph{\ce{Cl-}} thì lại tăng lên?
\end{baitoan}
...
Khi Mg kết hợp với O tạo thành phân tử magnesium oxide sẽ diễn ra sự cho \& nhận electron giữa 2 nguyên tử như sau: Nguyên tử Mg cho đi 2 electron ở lớp ngoài cùng trở thành ion mang 2 điện tích dương, ký hiệu là \ce{Mg^2+}. Nguyên tử O nhận 2 electron từ nguyên tử Mg tạo thành ion mang 2 điện tích âm, ký hiệu là \ce{O^2-}. Các ion \ce{Mg^2+} \& \ce{O^2-} hút nhau tạo thành liên kết trong phân tử magnesium oxide.

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 4, p. 35]
	Các ion \emph{\ce{Mg^2+, O^2-}} có lớp vỏ tương tự khí hiếm nào?
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 5, p. 35]
	So sánh về số electron, số lớp electron giữa nguyên tử \emph{Mg} \& ion \emph{\ce{Mg^2+}}.
\end{baitoan}
...
\begin{itemize}
	...
	\item Thường có nhiệt độ nóng chảy \& nhiệt độ sôi cao, e.g., aluminium oxide \ce{Al2O3}, calcium oxide CaO, sodium chloride NaCl, $\ldots$
	\item Khi tan trong nước tạo ra dung dịch dẫn được điện, e.g., sodium chloride NaCl, calcium chloride \ce{CaCl2}, $\ldots$
\end{itemize}
...
\begin{figure}[H]
	...
	\caption{Sơ đồ tạo thành liên kết trong phân tử hydrogen \ce{H2}.}
\end{figure}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 3, p. 36]
	Nguyên tử \emph{H} trong phân tử hydrogen \emph{\ce{H2}} có lớp vỏ tương tự khí hiếm nào?
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 4, p. 36]
	2 nguyên tử \emph{Cl} liên kết với nhau tạo thành phân tử chlorine. (a) Mỗi nguyên tử \emph{Cl} cần thêm bao nhiêu electron vào lớp ngoài cùng để có lớp vỏ tương tự khí hiếm? (b) Vẽ sơ đồ tạo thành liên kết trong phân tử chlorine \emph{\ce{Cl2}}.
\end{baitoan}

\subsubsection{Sự tạo thành liên kết trong phân tử nước \ce{H2O}}
...
\begin{figure}[H]
	...
	\caption{Sơ đồ tạo thành liên kết trong phân tử nước \ce{H2O}.}
\end{figure}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 6, p. 37]
	Mỗi nguyên tử \emph{N} kết hợp với $3$ nguyên tử \emph{H} tạo thành phân tử ammonia \emph{\ce{NH3}}. Vẽ sơ đồ tạo thành phân tử ammonia.
\end{baitoan}

\subsubsection{Sự tạo thành liên kết trong phân tử carbon dioxide}
Nguyên tử C có 4 electron ở lớp ngoài cùng \& cần thêm 4 electron để đạt được lớp vỏ bền vững tương tự khí hiếm Ne. Trong phân tử carbon dioxide \ce{CO2}, nguyên tử C góp 4 electron, mỗi nguyên tử O góp 2 electron. Như vậy, giữa nguyên tử C \& O có 2 đôi electron dùng chung. Hạt nhân nguyên tử C \& O cùng hút đôi electron dùng chung, liên kết với nhau tạo thành phân tử carbon dioxide.
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.3]{carbon_dioxide}
	\caption{Sơ đồ tạo thành liên kết trong phân tử carbon dioxide \ce{CO2} (chỉ biểu diễn lớp electron ngoài cùng).}
\end{figure}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 7, p. 37]
	$2$ nguyên tử \emph{N} kết hợp với nhau tạo thành phân tử nitrogen. Vẽ sơ đồ tạo thành liên kết trong phân tử nitrogen \emph{\ce{N2}}.
\end{baitoan}
...
\end{dinhnghia}
Trong điều kiện thường, các chất cộng hóa trị có ở cả 3 thể: thể rắn (đường ăn \ce{C12H22O11}, iodine \ce{I2}, $\ldots$), thể lỏng (bromine \ce{Br2}, ethanol \ce{C2H6O}, $\ldots$), thể khí (oxygen \ce{O2}, nitrogen \ce{N2}, carbon dioxide \ce{CO2}, $\ldots$). Các chất cộng hóa trị thường có nhiệt độ sôi \& nhiệt độ nóng chảy thấp. Nhiều chất cộng hóa trị không dẫn điện (đường ăn, ethanol, $\ldots$).
...
\begin{vidu}[\ce{N2}]
	...
	\begin{figure}[H]
		...
		\caption{Phân tử nitrogen \ce{N2}.}
	\end{figure}
...
\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Lớp vỏ ngoài cùng của nguyên tử khí hiếm có 8 electron (riêng helium có 2 electron), là lớp vỏ bền vững. \fbox{\bf 2} \textit{Liên kết ion} là liên kết được tạo thành bởi lực hút giữa ion dương \& ion âm. \fbox{\bf 3} \textit{Liên kết cộng hóa trị} là liên kết được tạo thành bởi 1 hoặc nhiều đôi electron dùng chung giữa 2 nguyên tử. \fbox{\bf 4} Các chất ion là chất rắn ở điều kiện thường, có nhiệt độ sôi \& nhiệt độ nóng chảy cao, khi tan trong nước tạo ra dung dịch dẫn điện. \fbox{\bf 5} Các chất cộng hóa trị có ở cả 3 thể (rắn, lỏng, khí), thường có nhiệt độ sôi \& nhiệt độ nóng chảy thấp. Nhiều chất cộng hóa trị không dẫn điện.
	}%
}
...
\begin{figure}[H]
	...
	\caption{Sơ đồ liên kết cộng hóa trị giữa H \& O trong phân tử nước \ce{H2O}.}
\end{figure}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 1, p. 40]
	 Xác định hóa trị của \emph{C, O} trong carbon dioxide \emph{\ce{CO2}}.
	 \begin{figure}[H]
	 	\centering
...
Trong phân tử carbon dioxide \ce{CO2}, hóa trị \& số nguyên tử tham gia liên kết của C \& O như sau: Nguyên tố C có hóa trị IV \& có số nguyên tử là 1, nguyên tố O có hóa trị II \& có số nguyên tử là 2. Tích hóa trị \& số nguyên tử: IV$\cdot1 =$ II$\cdot2$.
...
\begin{vidu}[\ce{H2O}]
	Công thức hóa học của nước là \emph{\ce{H2O}}.
	\begin{figure}[H]
		\centering
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 3, p. 41]
	Cho CTHH của 1 số chất như sau: (a) \emph{\ce{N2}} (nitrogen). (b) \emph{NaCl} (sodium chloride). (c) \emph{\ce{MgSO4}} (magnesium sulfate). Xác định nguyên tố tạo thành mỗi chất \& số nguyên tử của mỗi nguyên tố có trong phân tử.
\end{baitoan}
CTHH của các hợp chất có từ 2 ký hiệu hóa học trở lên, e.g., NaCl, \ce{Na2O, H2SO4, CaCO3}, $\ldots$ CTHH của các đơn chất chỉ có 1 ký hiệu hóa học.
\begin{itemize}
	\item Với phi kim, phân tử thường có 2 nguyên tử, e.g., \ce{N2, H2, O2, Cl2}, $\ldots$
...
\fbox{\bf 1} \textit{CTHH của 1 chất cho biết 1 số thông tin}:
\begin{itemize}
...
\begin{vidu}[\ce{H2SO4}]
	CTHH của sulfuric acid là \emph{\ce{H2SO4}} cho biết: Sulfuric acid được tạo thành từ \emph{H,S,O}. Trong 1 phân tử sulfuric acid có $2$ nguyên tử \emph{H}, $1$ nguyên tử \emph{S}, \& $4$ nguyên tử \emph{O}. Khối lượng phân tử của sulfuric acid là: $2\cdot1 + 1\cdot32 + 4\cdot16 = 98$ amu.
\end{vidu}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 7, p. 42]
	Đường glucose là nguồn cung cấp năng lượng quan trọng cho hoạt động sống của con người. Đường glucose có CTHH là \emph{\ce{C6H12O6}}. (a) Glucose được tạo thành từ những nguyên tố nào? (b) Khối lượng mỗi nguyên tố trong 1 phân tử glucose bằng bao nhiêu? (c) Khối lượng phân tử glucose là bao nhiêu?
\end{baitoan}
\noindent\fbox{\bf 2} \textit{Biết CTHH tính được \% khối lượng các nguyên tố trong hợp chất}: Khi biết CTHH của 1 chất, tính được \% khối lượng của các nguyên tố tạo ra chất theo các bước sau:
\begin{itemize}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 8, p. 43]
	Calcium carbonate là thành phần chính của đá vôi, có CTHH là \emph{\ce{CaCO3}}. Tính \% khối lượng của mỗi nguyên tố trong hợp chất trên.
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 9, p. 43]
	Citric acid là hợp chất được sử dụng nhiều trong công nghiệp thực phẩm, dược phẩm. Trong tự nhiên, citric acid có trong quả chanh \& 1 số loại quả như bưởi, cam, $\ldots$  Citric acid có CTHH là \emph{\ce{C6H8O7}}. Tính \% khối lượng của mỗi nguyên tố trong citric acid.
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, p. 43]
	Potassium (kali) rất cần thiết cho cây trồng, đặc biệt trong giai đoạn cây trưởng thành, ra hoa, kết trái. Để cung cấp \emph{K} cho cây, có thể sử dụng phân potassium chloride \& potassium sulfate có CTHH lần lượt là \emph{KCl, \ce{K2SO4}}. Người trồng cây muốn sử dụng loại phân bón có hàm lượng \emph{K} cao hơn thì nên chọn loại phân bón nào?
\end{baitoan}
\noindent\fbox{\bf 3} \textit{Biết CTHH \& hóa trị của 1 nguyên tố, xác định được hóa trị của nguyên tố còn lại trong hợp chất}: Trong hợp chất có 2 nguyên tố, nếu biết CTHH \& hóa trị của 1 nguyên tố thì hóa trị của nguyên tố còn lại được xác định như sau:
\begin{itemize}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, Ví dụ 2, p. 44]
	Xác định hóa trị của \emph{Fe} trong hợp chất có CTHH là \emph{\ce{Fe2O3}}.
\end{baitoan}

\begin{proof}[Giải]
	Gọi hóa trị của \emph{Fe} trong hợp chất là $a$. Vì O có hóa trị II nên khi áp dụng quy tắc hóa trị, ta có: $a\cdot2 =$ II$\cdot3\Rightarrow a =$ III. Vậy Fe có hóa trị III trong hợp chất \ce{Fe2O3}.
\end{proof}

\begin{baitoan}
	Xác định hóa trị của \emph{Fe} trong hợp chất có CTHH là \emph{\ce{FeO, Fe3O4}}.
\end{baitoan}

\begin{luuy}[oxide]
	Sắt \emph{Fe} có 3 dạng oxide: \emph{\ce{FeO, Fe2O3, Fe3O4}}. Copper (đồng) \emph{Cu} có 2 dạng oxide: \emph{\ce{Cu2O, CuO}}.
\end{luuy}
...
\fbox{\bf 1} \textit{Xác định CTHH của hợp chất tạo thành từ 2 nguyên tố khi biết hóa trị của các nguyên tố}: Nếu 2 nguyên tố A, B có hóa trị tương ứng là $a,b$ thì CTHH của hợp chất tạo thành từ A \& B được xác định như sau:
\begin{itemize}
	\item Đặt CTHH của hợp chất: \ce{A_xB_y}.
	\item Áp dụng quy tắc hóa trị, xác định tỷ lệ $\frac{x}{y} = \frac{a}{b}$.
	\item Xác định $x,y$ ($x,y\in\mathbb{N}^\star$ thường là những số nguyên nhỏ nhất thỏa mãn tỷ lệ trên, có vài trường hợp ngoại lệ, e.g., hydro peroxide \ce{H2O2}).
\end{itemize}
...
\end{proof}
Quy tắc hóa trị đúng với hầu hết các hợp chất vô cơ song không đúng với đa số các hợp chất hữu cơ. E.g., nguyên tố carbon tạo ra với hydrogen 1 số hợp chất có CTHH sau: \ce{C2H6, C3H8}. Như vậy, theo quy tắc hóa trị thì hóa trị của C dường như không đúng, song thực  tế trong các hợp chất trên, nguyên tử C vẫn có hóa trị IV. Điều này sẽ được làm rõ hơn khi học về các chất hữu cơ.

\noindent\fbox{\bf 2} \textit{Xác định CTHH của hợp chất khi biết \% khối lượng của các nguyên tố \& khối lượng phân tử của hợp chất.} Khi biết \% khối lượng của 2 nguyên tố A, B tạo nên hợp chất \& khối lượng phân tử của chất đó, xác định CTHH theo các bước sau:
\begin{itemize}
	\item Đặt CTHH của chất là \ce{A_xB_y}.
...
\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} \textit{Hóa trị} của nguyên tố là con số biểu thị khả năng liên kết của nguyên tử trong hợp chất. Trong hợp chất, hóa trị của H luôn là I, hóa trị của O luôn là II. \fbox{\bf 2} Khi các nguyên tử của 2 nguyên tố A, B liên kết với nhau, tích giữa hoá trị \& số nguyên tử của A bằng tích giữa hóa trị \& số nguyên tử của B. \fbox{\bf 3} \textit{Công thức hóa học} (CTHH) dùng để biểu diễn chất. CTHH gồm 2 phần: chữ \& số. Phần chữ là ký hiệu hóa học của các nguyên tố; phần số được ghi bên phải, dưới chân ký hiệu hóa học (gọi là \textit{chỉ số}) là số nguyên tử của nguyên tố trong phân tử.
	}%
}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 1., p. 46]
	(a) Nêu ý nghĩa của CTHH. (b) Mỗi CTHH sau đây cho biết những thông tin gì? \emph{\ce{Na2CO3, O2, H2SO4, KNO3}}.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 3., p. 46]
	Cho CTHH của 1 số chất như sau: \emph{\ce{F2, LiCl, Cl2, MgO, HCl}}. Trong các CTHH trên, công thức nào là của đơn chất, công thức nào là của hợp chất?
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 4., p. 46]
	1 số chất có CTHH như sau; \emph{\ce{BaSO4, Cu(OH)2, Zn3(PO4)2}}. Dựa vào bảng \ref{tab: hoa tri nhom nguyen tu}, tính hóa trị của các nguyên tố \emph{Ba, Cu, Zn} trong các hợp chất trên.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 6., p. 46]
	Các hợp chất của calcium có nhiều ứng dụng trong đời sống: \emph{\ce{CaSO4}} là thành phần chính của thạch cao. Thạch cao được dùng để đúc tượng, sản xuất các vật liệu xây dựng, $\ldots$ \emph{\ce{CaCO3}} là thành phần chính của đá vôi. Đá vôi được dùng nhiều trong công nghiệp sản xuất xi măng. \emph{\ce{CaCl2}} được dùng để hút ẩm, chống đóng băng tuyết trên mặt đường ở xứ lạnh. Tính \% khối lượng của calcium trong các hợp chất trên.
\end{baitoan}
