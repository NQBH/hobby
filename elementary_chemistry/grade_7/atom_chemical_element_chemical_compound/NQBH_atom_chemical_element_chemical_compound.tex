...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 1, p. 16]
	...
	\begin{table}[H]
		...
		\begin{tabular}{|c|c|c|c|}
			\hline
			\textbf{Nguyên tử} & \textbf{Số proton} & \textbf{Số neutron} & \textbf{Số electron} \\
			\hline
			X1 & 8 & 9 & 8 \\
			\hline
			X2 & 7 & 8 & 7 \\
...
\noindent\textsf{\textbf{Tóm tắt kiến thức.}}
\begin{itemize}
	\item \textit{Nguyên tố hóa học} là tập hợp những nguyên tử có cùng số proton trong hạt nhân.
	\item Mỗi nguyên tố hóa học có tên gọi \& ký hiệu hóa học riêng.
	\item Ký hiệu hóa học của nguyên tố được biểu diễn bằng 1 hoặc 2 chữ cái trong tên nguyên tố; trong đó, chữ cái đầu tiên được viết ở dạng chữ in hoa, chữ cái thứ 2 (nếu có) được viết ở dạng chữ thường.
\end{itemize}
