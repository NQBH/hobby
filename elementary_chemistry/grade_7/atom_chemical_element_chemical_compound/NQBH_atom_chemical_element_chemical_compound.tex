...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 3, p. 30]
	Cho biết những chất nào là dơn chất trong các chất sau: (a) Kim loại sodium được tạo thành từ nguyên tố \emph{Na}. (b) Lactic acid có trong sữa chua, được tạo thành từ các nguyên tố \emph{C,H,O}. (c) Kim cương được tạo thành từ nguyên tố \emph{C}. (d) Muối ăn \emph{NaCl} được tạo thành từ các nguyên tố \emph{Na} \& \emph{Cl}.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 5, p. 32]
	Acetic acid có trong giấm ăn \& là chất được sử dụng nhiều trong công nghiệp; oxygen chiếm khoảng $21$\% thể tích không khí, có vai trò quan trọng đối với sự sống; hydrogen peroxide có nhiều ứng dụng trong công nghiệp \& là chất sát khuẩn mạnh. Cho biết chất nào là đơn chất, chất nào là hợp chất.
\end{baitoan}
