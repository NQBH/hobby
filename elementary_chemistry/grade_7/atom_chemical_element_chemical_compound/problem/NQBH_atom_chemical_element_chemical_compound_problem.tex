...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 3, p. 41]
	Cho {\rm CTHH} của 1 số chất như sau: (a) \emph{\ce{N2}} (nitrogen). (b) \emph{NaCl} (sodium chloride). (c) \emph{\ce{MgSO4}} (magnesium sulfate). Xác định nguyên tố tạo thành mỗi chất \& số nguyên tử của mỗi nguyên tố có trong phân tử.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 7, p. 42]
	Đường glucose là nguồn cung cấp năng lượng quan trọng cho hoạt động sống của con người. Đường glucose có {\rm CTHH} là \emph{\ce{C6H12O6}}. (a) Glucose được tạo thành từ những nguyên tố nào? (b) Khối lượng mỗi nguyên tố trong 1 phân tử glucose bằng bao nhiêu? (c) Khối lượng phân tử glucose là bao nhiêu?
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 8, p. 43]
	Calcium carbonate là thành phần chính của đá vôi, có {\rm CTHH} là \emph{\ce{CaCO3}}. Tính \% khối lượng của mỗi nguyên tố trong hợp chất trên.
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 9, p. 43]
	Citric acid là hợp chất được sử dụng nhiều trong công nghiệp thực phẩm, dược phẩm. Trong tự nhiên, citric acid có trong quả chanh \& 1 số loại quả như bưởi, cam, $\ldots$  Citric acid có {\rm CTHH} là \emph{\ce{C6H8O7}}. Tính \% khối lượng của mỗi nguyên tố trong citric acid.
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, p. 43]
	Potassium (kali) rất cần thiết cho cây trồng, đặc biệt trong giai đoạn cây trưởng thành, ra hoa, kết trái. Để cung cấp \emph{K} cho cây, có thể sử dụng phân potassium chloride \& potassium sulfate có {\rm CTHH} lần lượt là \emph{KCl, \ce{K2SO4}}. Người trồng cây muốn sử dụng loại phân bón có hàm lượng \emph{K} cao hơn thì nên chọn loại phân bón nào?
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, Ví dụ 2, p. 44]
	Xác định hóa trị của \emph{Fe} trong hợp chất có {\rm CTHH} là \emph{\ce{Fe2O3}}.
\end{baitoan}
...
\begin{baitoan}
	Xác định hóa trị của \emph{Fe} trong hợp chất có {\rm CTHH} là \emph{\ce{FeO, Fe3O4}}.
\end{baitoan}
...
\begin{proof}[Giải]
	Đặt {\rm CTHH} của hợp chất là \ce{S_xO_y}. Theo quy tắc hóa trị, ta có: VI$\cdot x =$ II$\cdot y$. Ta có tỷ lệ: $\frac{x}{y} = \frac{II}{VI} = \frac{1}{3}$. Chọn $x = 1$ \& $y = 3$. {\rm CTHH} của hợp chất là \ce{SO3}.
\end{proof}
...
\begin{proof}[Giải]
	Đặt {\rm CTHH} của R là \ce{S_xO_y}. Khối lượng của nguyên tố O trong 1 phân tử R là: $\frac{64\cdot50}{100} = 32$ amu. Khối lượng của nguyên tố S trong 1 phân tử R là: $64 - 32 = 32$ amu. Ta có: $16y = 32$ amu $\Rightarrow y = 2$, $32x = 32$ amu $\Rightarrow x = 1$. Vậy {\rm CTHH} của R là \ce{SO2}.
\end{proof}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 1., p. 46]
	(a) Nêu ý nghĩa của {\rm CTHH}. (b) Mỗi {\rm CTHH} sau đây cho biết những thông tin gì? \emph{\ce{Na2CO3, O2, H2SO4, KNO3}}.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 3., p. 46]
	Cho {\rm CTHH} của 1 số chất như sau: \emph{\ce{F2, LiCl, Cl2, MgO, HCl}}. Trong các {\rm CTHH} trên, công thức nào là của đơn chất, công thức nào là của hợp chất?
\end{baitoan}

\begin{baitoan}[\cite{SGK_KHTN_7_Canh_Dieu}, 4., p. 46]
	1 số chất có {\rm CTHH} như sau; \emph{\ce{BaSO4, Cu(OH)2, Zn3(PO4)2}}. Dựa vào bảng \ref{tab: hoa tri nhom nguyen tu}, tính hóa trị của các nguyên tố \emph{Ba, Cu, Zn} trong các hợp chất trên.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 5., p. 9]
	Điền vào chỗ trống: (a) Phân tử nước {\rm\ce{H2O}} gồm có 2 nguyên tử của $\ldots$ \& 1 nguyên tử của $\ldots$. (b) Phân tử muối ăn {\rm NaCl} gồm có 1 nguyên tử của $\ldots$ \& 1 nguyên tử của $\ldots$.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 10., p. 11]
	Ý nghĩa các ký hiệu: {\rm3O, \ce{3O2,2H,H2,H2O}, NaCl}?
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 22., p. 15]
	Phân loại đơn chất \& hợp chất: silic, than, sodium hydroxide, potassium, calcium oxide, khí nitrogen, đá vôi {\rm\ce{CaCO3}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, Ví dụ, pp. 21]
	Tính thành phần {\rm\%} về khối lượng của nguyên tố nhôm có trong {\rm\ce{Al2O3}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, Ví dụ, pp. 22]
	Tính khối lượng của nguyên tố iron có trong {\rm15.2 g} chất iron sulfate {\rm\ce{FeSO4}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 2., p. 25]
	Có 1 loại oxide nitrogen tạo bởi nguyên tố nitrogen {\rm N} có hóa trị V, nguyên tố oxygen luôn luôn có hóa trị II. {\rm CTHH} của hợp chất là: {\sf A.} {\rm NO}. {\sf B.} {\rm\ce{N2O3}}. {\sf C.} {\rm\ce{N2O5}}. {\sf D.} {\rm\ce{N2O}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 5., p. 26]
	Tính hóa trị của các nguyên tố: (a) Copper trong các hợp chất {\rm CuCl, \ce{CuCl2}}. (b) Phosphor trong các hợp chất {\rm\ce{P2O3,P2O5}}. (c) Iron trong các hợp chất {\rm FeO, \ce{Fe2O3,Fe3O4}}. (d) Lưu huỳnh trong các hợp chất {\rm\ce{SO2,SO3,H2S}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 8., p. 27]
	Có bao nhiêu {\rm g} iron trong {\rm30 g} sắt pirit {\rm\ce{FeS2}}. Trong {\rm40 g} sắt (III) oxide {\rm\ce{Fe2O3}}?
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 10., p. 28]
	Có bao nhiêu {\rm g} oxygen trong: (a) {\rm63 g} acid nitric {\rm\ce{HNO3}}? (b) {\rm27 g} {\rm\ce{H2O}}? (c) {\rm2170 g} mercury (thủy ngân) oxide {\rm HgO}?
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 13., p. 29]
	Tính tỷ lệ khối lượng các nguyên tố trong các phân bón chứa nitrogen: (a) Sodium nitrate {\rm\ce{NaNO3}}. (b) Calcium nitrate: {\rm\ce{Ca(NO3)2}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 14., p. 29]
	Tính thành phần {\rm\%} của các nguyên tố trong các hợp chất: (a) Iron trong iron sulfide {\rm FeS}. (b) Iron trong pirit sắt {\rm\ce{FeS2}}. (c) Oxygen trong nước {\rm\ce{H2O}}. (d) Oxygen, calcium, \& carbon trong đá vôi {\rm\ce{CaCO3}}. (e) Oxygen, carbon, \& sodium trong soda {\rm\ce{Na2CO3}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 15., p. 29]
	Có bao nhiêu {\rm g} sodium trong {\rm60 g} xút ăn da {\rm NaOH}? {\rm26.5 g} sodium carbonate {\rm\ce{Na2CO3}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 17., p. 30]
	Tính hóa trị của chlorine, sulfur (lưu huỳnh), nitrogen, phosphor, silicon trong các hợp chất: {\rm HCl, \ce{H2S,NH3,PH3,SiH4}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 18., p. 30]
	Tính hóa trị của calcium, potassium, aluminium, iron trong các hợp chất: {\rm CaO, \ce{K2O,Al2O3}, FeO, \ce{Fe2O3,Fe3O4}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 19., p. 30]
	Viết phương trình các phản ứng hóa học: (a) Magnesium cháy trong oxygen tạo thành magnesium oxide {\rm MgO}. (b) Aluminium bị oxy hóa tạo thành aluminium oxide {\rm\ce{Al2O3}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 23., p. 30]
	Xác định hóa trị của nitrogen trong các hợp chất: {\rm\ce{N2O,NO,N2O3,NO2,N2O5,NH3}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 26., p. 30]
	Xác định hóa trị của các nguyên tố chứa trong các hợp chất được biểu diễn bằng {\rm CTHH}: {\rm ZnS, \ce{Cu2S,Al2S3,SnS, P2S5}}. Biết trong các hợp chất này sulfur có hóa trị II.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 28., p. 30]
	Cho biết các nguyên tố nào trong các hợp chất sau có hóa trị {\rm I, II, III, IV, V, VI: \ce{Cu2O,Na2O,Fe2O3,FeCl2,PbO2,NaCl,FeCl3,MgO,ZnO,HCl,SO3}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 30., p. 31]
	Cần bón cho đất bao nhiêu {\rm kg} calcium nitrate để cùng có 1 lượng nitrogen như khi bón {\rm264 kg} ammonium sulfate {\rm\ce{(NH4)2SO4}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 31., p. 31]
	Viết {\rm CTHH} của các muối mà phân tử có: (a) {\rm Fe (II)} liên kết với {\rm\ce{NO3}} (nitrate). (b) {\rm Cu (II)} liên kết với {\rm Cl} (chloride). (c) {\rm Na} liên kết với {\rm\ce{SO4}} (sulfate). (d) {\rm Ca} liên kết với {\rm\ce{PO4}} (phosphate).
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 32., p. 31]
	(a) Viết {\rm CTHH} của: {\rm Fe (II)} \& {\rm O}, {\rm Ba (II)} \& {\rm Cl}, {\rm N (III), N (IV), N (V)} \& {\rm O}. (b) Sửa lại các {\rm CTHH} viết sai:  acid carbonic {\rm\ce{HCO3}}, acid phosphoric {\rm\ce{H2PO4}}, acid hydrochloric {\rm HCl}, acid nitric {\rm\ce{H2NO3}}, acid sulfuric {\rm\ce{HSO4}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 33., p. 31]
	Viết {\rm CTHH} \& xác định phân tử khối của các hợp chất: {\rm Ca (II)} \& {\rm O}, {\rm N (III)} \& {\rm H}, {\rm Fe (II)} \& gốc {\rm\ce{SO4} (II)}, {\rm Fe (III)} \& gốc {\rm\ce{SO4} (II)}, {\rm Al (III)} \& gốc {\rm\ce{SO4} (II)}.
\end{baitoan}
...
\begin{proof}[Giải]
	{\rm CTHH} của sắt(III) sunfat: \ce{Fe2(SO4)3}$\Rightarrow\%m_{\ce{Fe}}:\%m_{\ce{S}}:\%m_{\ce{O}} = (2\cdot56):(3\cdot32):(12\cdot16) = 112:96:192 = 7:6:12 = 28\%:24\%:48\%$.
\end{proof}
