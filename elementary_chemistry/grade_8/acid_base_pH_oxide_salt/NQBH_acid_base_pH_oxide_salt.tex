...
\end{dinhnghia}
E.g., HCl: acid hydrochloric (axit clohiđric), \ce{H2SO4}: acid sulfuric (axit sunfuric), \ce{HNO3}: acid nitric (axit nitric), \ce{H3PO4}: acid phosphoric, $\ldots$
...
\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu}, p. 47]
	(a) Hydrochloric acid $\to$ Ion hydrogen $+$ Ion chloride: {\rm\ce{HCl -> H+ + Cl-}}. (b) Sulfuric acid $\to$ Ion hydrogen $+$ Ion sulfate: {\rm\ce{H2SO4 -> 2H+ + SO4^2-}}.
\end{vidu}

\subsection{Phân loại acid}
Dựa vào thành phần phân tử, acid được chia chia thành 2 loại: Acid không có oxygen, e.g., HCl, HBr, HI, \ce{H2S}, $\ldots$, \& acid có oxygen, e.g., \ce{H2SO4,H3PO4,HNO3,H2SO3}, $\ldots$

Dựa vào độ mạnh của acid, có thể phân chia acid thành 3 loại: acid mạnh, e.g., HCl, HBr, HI, \ce{H2SO4,HClO4,HNO3}, $\ldots$, acid trung bình, e.g., HF, \ce{H2SO3,H3PO4}, $\ldots$, \& acid yếu \ce{H2S,H2CO3,HClO,HClO2}, $\ldots$

\subsection{Cách gọi tên acid}

\begin{itemize}
	\item Acid không có oxygen: Tên axit $+$ tên phi kim $+$ hiđric. E.g., HBr: axit bromhiđric, \ce{H2S}: axit sunfuhiđric. Gốc acid tương ứng: \ce{-Br}: bromua, \ce{=S}: sunfua.
...
\begin{dinhnghia}[Base]
	{\rm Base} là các hợp chất trong phân tử có nguyên tử kim loại liên kết với nhóm hydroxide. Khi tan trong nước, base tạo ra ion {\rm\ce{OH-}}.
\end{dinhnghia}

\begin{vidu}
	(a) Sodium hydroxide $+$ ion sodium $\to$ ion hydroxide: {\rm\ce{NaOH -> Na+ + OH-}}. (b) Calcium hydroxide $\to$ ion calcium $+$ ion hydroxide: {\rm\ce{Ca(OH)2 -> Ca^2+ + 2OH-}}.
\end{vidu}
...
\begin{thinghiem}[\cite{SGK_KHTN_8_Canh_Dieu}, Thí nghiệm 3, p. 53]
	{\rm Chuẩn bị:} Dụng cụ: Giá để ống nghiệm, ống nghiệm, ống hút nhỏ giọt, thìa thủy tinh. Hóa chất: {\rm\ce{Mg(OH)2}} (được điều chế sẵn), dung dịch {\rm HCl}, nước cất. {\rm Tiến hành:} Lấy 1 lượng nhỏ {\rm\ce{Mg(OH)2}} cho vào ống nghiệm, thêm vào $\approx1$ {\rm mL} nước cất, lắc nhẹ. Tiếp tục nhỏ từ từ dung dịch {\rm HCl} vào ống nghiệm đến khi không nhìn thấy chất rắn trong ống nghiệm thì dừng lại. Mô tả các hiện tượng xảy ra. Giải thích sự thay đổi màu của dung dịch trong ống nghiệm trong quá trình thí nghiệm.
\end{thinghiem}
...
\begin{vidu}
	Thạch anh {\rm\ce{SiO2}}, đá khô {\rm\ce{CO2}}, hồng ngọc {\rm\ce{Al2O3}} đều do các oxide tạo nên.
\end{vidu}
...
\begin{dinhnghia}[Oxide]
	(a) {\rm Oxide} là hợp chất của 2 nguyên tố, trong đó có 1 nguyên tố là oxygen. Công thức tổng quát của oxide là {\rm\ce{M_xO_y}}. (b) {\rm Oxide} là hợp chất của oxygen với 1 nguyên tố khác.
\end{dinhnghia}
E.g., CuO, FeO, \ce{Fe2O3,Fe3O4,Al2O3,CO2,SO2}, $\ldots$. For a complete list, see, e.g., the tables at the end of \href{https://vi.wikipedia.org/wiki/Oxide}{vi.Wikipedia{\tt/}oxide} \& \href{https://en.wikipedia.org/wiki/Oxide}{Wikipedia{\tt/}oxide}.

\begin{luuy}
	Định nghĩa oxide trên trừ ra hợp chất giữa fluorine \& oxygen vì ``các hợp chất giữa fluorine \& oxygen như {\rm\ce{OF2,O2F2}} không thể gọi là oxide của fluorine mà là fluoride của oxygen. Vì fluorine có độ âm điện lớn hơn nên số oxy hóa của oxygen lần lượt là $+2$ \& $+1$. Hơn nữa, liên kết {\rm\ce{O-F}} bị phân cực về phía fluorine, thay vì phía oxygen như các oxide cộng hóa trị. Vì vậy, không thể nào coi chúng là các oxide.'' -- \href{https://vi.wikipedia.org/wiki/Oxide}{Wikipedia{\tt/}oxide}
\end{luuy}

\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu}, p. 59]
	(a) {\rm\ce{$4$Al + $3$O2 -> $2$Al2O3}}: Aluminium $\to$ Alumininum oxide. (b) {\rm\ce{C + O2 -> CO2 ^}}: Carbon $\to$ Carbon dioxide.
\end{vidu}

\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu}, p. 59]
	1 số oxide có nhiều trong tự nhiên như: Silicon dioxide {\rm\ce{SiO2}} -- thành phần chính của cát. Aluminium oxide {\rm\ce{Al2O3}} -- thành phần chính của quặng bauxite (boxit). Carbon dioxide {\rm\ce{CO2}} có trong không khí.
\end{vidu}

\subsection{Phân loại oxide}
Dựa vào khả năng phản ứng với acid \& base, oxide được phân thành 4 loại như sau:
\begin{itemize}
	\item \textit{Oxide base} là các oxide tác dụng được với dung dịch acid tạo thành muối \& nước. Đa số các oxide kim loại là oxide base, e.g., BaO, CaO, CuO, MgO, FeO, \ce{Fe2O3,Fe3O4}, $\ldots$ E.g., \ce{Na2O + $2$HCl -> $2$NaCl + H2O}.
	...
	\item \textit{Oxide acid} là các oxide tác dụng được với dung dịch base (kiềm) tạo thành muối \& nước. Các oxide acid thường là oxide của các phi kim, e.g., \ce{CO2,SO2,SO3,P2O5,NO2}, $\ldots$ E.g., \ce{CO2 + $2$NaOH ->[$1:2$] Na2CO3 + H2O}. Oxide acid phản ứng với nước tạo thành acid, e.g., \ce{Mn2O7} $\to$ \ce{HMnO4}, \ce{CO2} $\to$ \ce{H2CO3}, \ce{P2O5} $\to$ \ce{H3PO4}, $\ldots$
	\item \textit{Oxide lưỡng tính} là các oxide tác dụng với dung dịch acid \& tác dụng với dung dịch base tạo thành muối \& nước. 1 số oxide lưỡng tính thường gặp, e.g., ZnO, PbO, SnO, BeO, \ce{Al2O3}, $\ldots$
	\item \textit{Oxide trung tính} (còn được gọi là \textit{oxide không tạo muối}) là các oxide không tác dụng với dung dịch acid, dung dịch base, nước. 1 số oxide trung tính, e.g., CO, NO, \ce{N2O}, $\ldots$
\end{itemize}

\subsection{Cách gọi tên Oxide}

\begin{itemize}
	\item Tên oxide: Tên nguyên tố $+$ oxide. E.g., \ce{K2O}: Potassium oxide (kali oxit), NO: nitrogen oxide (nitơ oxit), $\ldots$
	\item Nếu kim loại có nhiều hóa trị, tên oxide: Tên kim loại (hóa trị) $+$ oxide. E.g., FeO: iron (II) oxide (sắt (II) oxit), \ce{Fe2O3}: iron (III) oxide (sắt (III) oxit), $\ldots$
	...
	E.g., NO: nitrogen monoxide (nitơ monoxide), CO: carbon monoxide (cacbon monooxit) hay gọi đơn giản là carbon oxit, \ce{CO2}: carbon dioxide (cacbon đioxit) hay thường gọi là \textit{khí carbonic}, \ce{SO2}: sulfur dioxide (lưu huỳnh đioxit) hay thường gọi là \textit{khí sunfurơ}, \ce{SO3}: sulfur trioxide (lưu huỳnh trioxit), \ce{P2O3}: điphotpho trioxit, \ce{P2O5}: điphotpho pentaoxit, $\ldots$
\end{itemize}
...
\begin{vidu}[\cite{SGK_Hoa_Hoc_9}, p. 4]
	{\rm BaO} phản ứng với nước tạo thành dung dịch {\rm barium hydroxide \ce{Ba(OH)2}}, thuộc loại base: {\rm\ce{BaO (r) + H2O (l) -> Ba(OH)2 (dd)}}.
\end{vidu}
Các oxide kim loại kiềm (Li, Na, K, Rb, Cs, Fr): \ce{Li2O,Na2O,K2O}, $\ldots$ \& 1 số oxide kim loại kiềm thổ (Ca, Sr, Ba, Ra): BaO, CaO, SrO tác dụng với nước ở nhiệt độ thường tạo thành dung dịch base (kiềm).
\begin{align*}
...
\begin{equation*}
	...
	\end{split}\right.}
\end{equation*}
E.g., \ce{Na2O + H2O -> $2$NaOH, BaO + H2O -> Ba(OH)2, CaO + H2O -> Ca(OH)2}.
...
\begin{itemize}
	\item \href{https://en.wikipedia.org/wiki/Lithium_oxide}{Lithium oxide} reacts with water to produce \href{https://en.wikipedia.org/wiki/Lithium_hydroxide}{Lithium hydroxide}: \ce{Li2O(s) + H2O(l) -> $2$Li+(aq) + $2$OH-(aq)}.
\end{itemize}
...
\begin{luuy}[\ce{CuCl2}]
	Copper(II) chloride {\rm\ce{CuCl2}} là 1 chất rắn màu nâu, từ từ hấp thụ hơi nước để tạo thành hợp chất ngậm 2 nước màu lục lam. Copper(II) chloride là 1 trong các hợp chất copper(II) phổ biến nhất, chỉ sau hợp chất copper(II) sulfate {\rm\ce{CuSO4}}. Xem thêm \href{https://vi.wikipedia.org/wiki/%C4%90%E1%BB%93ng(II)_chloride}{Wikipedia{\tt/}đồng(II) chloride}.
\end{luuy}
Nhiều oxide của các kim loại khác như MgO, CaO, \ce{Fe2O3}, $\ldots$ cũng tác dụng với dung dịch acid tạo ra muối \& nước tương tự như CuO. Oxide base tác dụng với dung dịch acid tạo ra muối \& nước. Oxide base tác dụng với các dung dịch acid như HCl, \ce{H2SO4} loãng, $\ldots$ tạo ra muối \& \ce{H2O}:
\begin{align*}
	\boxed{\mbox{oxide base} + \mbox{acid}\to\mbox{salt} + \ce{H2O}}
\end{align*}
Cụ thể oxide base tác dụng với acid HCl, \ce{H2SO4} loãng:
\begin{align*}
	\ce{M_xO_y + $2y$HCl &-> $x$MCl_{\frac{2y}{x}} + $y$H2O},\\
	\ce{$2$M_xO_y + $2y$H2SO4 \mbox{loãng} &-> $x$M2(SO4)_{\frac{2y}{x}} + $2y$H2O}.
\end{align*}
Cụ thể, với kim loại M hóa trị I \& acid \ce{H_xX} với gốc acid \ce{X^{x-}} có hóa trị $x\in\mathbb{N}^\star$:
\begin{align*}
	\boxed{\ce{$x$M2O + $2$H_xX -> $2$M_xX + $x$H2O},\ \forall x\in\mathbb{N}^\star.}
\end{align*}
Với kim loại M hóa trị II \& acid \ce{H_xX} với gốc acid \ce{X^{x-}} có hóa trị $x\in\mathbb{N}^\star$:
\begin{equation*}
	\boxed{\left\{\begin{split}
		...
		\end{split}\right.}
\end{equation*}
Tổng quát, với kim loại M hóa trị $m\in\mathbb{N}^\star$ \& acid \ce{H_xX} với gốc acid \ce{X^{x-}} có hóa trị $x\in\mathbb{N}^\star$:
\begin{equation*}
	\boxed{\left\{\begin{split}
		...
		\end{split}\right.}
\end{equation*}
E.g., \ce{Fe3O4 + $8$HCl -> FeCl2 + $2$FeCl3 + $4$H2O}, \ce{Fe3O4 + $4$H2SO4 -> FeSO4 + Fe2(SO4)3 + $4$H2O}, \ce{CuO + $2$HCl -> CuCl2 + H2O}, \ce{CuO + H2SO4 -> CuSO4 + H2O}, \ce{$3$CaO + $2$H3PO4 -> Ca3(PO4)2 v + $3$H2O}, \ce{Fe2O3 + $3$H2SO4 -> Fe2(SO4)3 v + $3$H2O}, $\ldots$

1 số oxide như FeO, \ce{Fe3O4}, $\ldots$ tác dụng với acid có tính oxy hóa mạnh như \ce{HNO3} \& \ce{H2SO4} đặc tạo ra muối hóa trị cao, nước, \& sản phẩm khử như NO, \ce{NO2,SO2}, $\ldots$ E.g., \ce{$3$FeO + $10$HNO3 \mbox{loãng} -> $3$Fe(NO3)3 + NO ^ + $5$H2O}, \ce{FeO + $4$HNO3 \mbox{đặc} ->[$t^\circ$] Fe(NO3)3 + NO2 ^ + $2$H2O}, \ce{$2$FeO + $4$H2SO4 \mbox{đặc} ->[$t^\circ$] Fe2(SO4)3 + SO2 ^ + $4$H2O}, \ce{$3$Fe3O4 + $28$HNO3  \mbox{loãng} -> $9$Fe(NO3)3 + NO ^ + $14$H2O}, \ce{Fe3O4 + $10$HNO3 \mbox{đặc} ->[$t^\circ$] $3$Fe2(SO4)3 + SO2 ^ + $10$H2O}.

\subsubsection{Oxide base tác dụng với oxide acid}
1 số oxide base của kim loại mạnh (kim loại kiềm \& kiềm thổ) BaO, CaO, \ce{Li2O,K2O,Na2O} tác dụng với oxide acid, e.g., \ce{CO2,SO2}, $\ldots$ tạo thành muối, e.g., \ce{BaO + CO2 -> BaCO3 v}, \ce{BaO + SO2 -> BaSO3 v}, \ce{CaO + CO2 -> CaCO3 v}, \ce{Na2O + CO2 -> Na2CO3}, \ce{Na2O + SO2 -> Na2SO3}, \ce{K2O + SO2 -> K2SO3}, \ce{K2O + SiO2 -> K2SiO3}, $\ldots$.

\subsubsection{Oxide base tác dụng với 1 số chất khử}
Oxide base tác dụng với 1 số chất khử CO, \ce{H2}, C, Al, $\ldots$ khi nung nóng tạo ra kim loại. E.g., \ce{CuO + CO ->[$t^\circ$] Cu + CO2}, \ce{CuO + H2 ->[$t^\circ$] Cu + H2O}, \ce{ZnO + C ->[$t^\circ$] Zn + CO}, \ce{Fe2O3 + $2$Al ->[$t^\circ$] Al2O3 + $2$Fe}, $\ldots$

Các oxide kim loại như \ce{Na2O,K2O,BaO,Al2O3,MgO,CaO,Li2O} không có phản ứng với các chất như CO, \ce{H2}, C, Al khi nung nóng.

\subsubsection{Oxide acid tác dụng với nước}

\begin{vidu}[\cite{SGK_Hoa_Hoc_9}, p. 5]
	Diphosphor pentoxide {\rm\ce{P2O5}} tác dụng với {\rm\ce{H2O}} tạo thành dung dịch acid phosphoric {\rm\ce{H3PO4}: \ce{P2O5 (r) + $3$H2O (l) -> $2$H3PO4 (dd)}}.
\end{vidu}
Thí nghiệm với nhiều oxide acid khác như \ce{SO2,SO3,N2O5}, $\ldots$ ta cũng thu được những dung dịch acid tương ứng. \textit{Nhiều oxide acid tác dụng với nước tạo thành dung dịch acid} (trừ \ce{SiO2}). E.g., \ce{SO3 + H2O -> H2SO4, P2O5 + $3$H2O -> $2$H3PO4, N2O5 + H2O -> $2$HNO3}, $\ldots$

\subsubsection{Oxide acid tác dụng với dung dịch base}

\begin{thinghiem}[\cite{SGK_KHTN_8_Canh_Dieu}, Thí nghiệm 2, p. 61]
	{\rm Chuẩn bị:} Dụng cụ: Bình tam giác (loại {\rm100 mL}), ống thủy tinh, ống nối cao su. Hóa chất: Dung dịch nước vôi trong, {\rm\ce{CO2}} (được điều chế từ bình tạo khí {\rm\ce{CO2}}). {\rm Tiến hành:} Cho vào bình tam giác $\approx$ {\rm30 mL} nước vôi trong, dẫn khí {\rm\ce{CO2}} từ từ vào dung dịch, khi dung dịch vẫn đục thì dừng lại. Mô tả các hiện tượng xảy ra. Giải thích.
\end{thinghiem}
...
\end{align*}
E.g., \ce{SO3 + $2$NaOH -> Na2SO4 v + H2O}, \ce{CO2 + Ca(OH)2 -> CaCO3 v + H2O}.

Tùy theo tỷ lệ mol mà muối thu được là muối acid, muối trung hòa hay cả 2, e.g., \ce{CO2 + NaOH ->[$1:1$] NaHCO3, CO2 + $2$NaOH ->[$1:2$] Na2CO3 + H2O}.

\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu}, p. 61, Ứng dụng của \ce{SO2}]
	Sulfur dioxide {\rm\ce{SO2}} được sử dụng phần lớn để sản xuất {\rm\ce{H2SO4}}. Ngoài ra, {\rm\ce{SO2}} còn được dùng để tẩy trắng bột gỗ trong công nghiệp giấy, làm chất diệt nấm mốc, $\ldots$
	
	Trong sản xuất rượu vang, {\rm\ce{SO2}} được dùng làm chất chống oxi hóa, ức chế 1 số loại vi khuẩn, do đó có thể lưu trữ rượu được lâu hơn. Tuy nhiên, lượng {\rm\ce{SO2}} có trong rượu luôn được kiểm soát 1 cách nghiêm ngặt để không làm ảnh hưởng đến sức khỏe người sử dụng.
\end{vidu}

\subsubsection{Oxide lưỡng tính tác dụng với dung dịch base}
Oxide lưỡng tính có thể phản ứng với base tạo thành muối \& nước, e.g., \ce{Al2O3 + $2$NaOH -> $2$NaAlO2 + H2O}, \ce{BeO + $2$KOH -> K2BeO2 + H2O}, $\ldots$\\
\\
\noindent\fbox{%
	\parbox{\textwidth}{%
...
\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu}, p. 62]
	Muối là loại hợp chất có nhiều trong tự nhiên, trong nước biển, trong đất, trong các mỏ. (a) Muối ăn {\rm NaCl} có nhiều trong nước biển. (b) {\rm\ce{CaCO3}} có nhiều trong các mỏ đá vôi.
\end{vidu}
...
\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu}, p. 62]
	{\rm\ce{HCl + NaOH -> NaCl + H2O}} (sodium chloride). Trong phản ứng này ion {\rm\ce{H+}} của hydrochloric acid đã được thay thế bởi ion {\rm\ce{Na+}}.
\end{vidu}
...
\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu}, p. 63]
	{\rm\ce{H2SO4 + CuO -> CuSO4 + H2O}} (copper(II)) sulfate). Muối ammonium được tạo ra khi thay thế ion {\rm\ce{H+}} của acid bằng ion ammonium {\rm\ce{NH4+}}.
\end{vidu}

\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu}, p. 63]
	{\rm\ce{NH4NO3}}: ammonium nitrate, {\rm\ce{(NH4)2SO4}}: ammonium sulfate.
\end{vidu}

\begin{dinhnghia}
	{\rm Muối} là các hợp chất được tạo ra khi thay thế ion {\rm\ce{H+}} trong acid bằng ion kim loại hoặc ion ammonium {\rm\ce{NH4+}}.
\end{dinhnghia}
...
\begin{thinghiem}[\cite{SGK_KHTN_8_Canh_Dieu}, Thí nghiệm 1, p. 64]
	{\rm Chuẩn bị:} Dụng cụ: Giá để ống nghiệm, ống nghiệm, ống hút nhỏ giọt, miếng bìa màu trắng. Hóa chất: Mẩu dây đồng, dung dịch {\rm\ce{AgNO3}}. {\rm Tiến hành:} Cho mẩu dây đồng (dài $\approx2$ {\rm cm}) vào ống nghiệm, thêm vào ống nghiệm $\approx2$ {\rm mL} dung dịch {\rm\ce{AgNO3}}. Đặt miếng bìa trắng sau ống nghiệm. Mô tả các hiện tượng xảy ra. Bề mặt sợi dây đồng \& màu dung dịch trong ống nghiệm thay đổi như thế nào? Giải thích.
\end{thinghiem}
...
\begin{thinghiem}[\cite{SGK_KHTN_8_Canh_Dieu}, Thí nghiệm 2, p. 64]
	{\rm Chuẩn bị:} Dụng cụ: Giá để ống nghiệm, ống nghiệm, ống hút nhỏ giọt. Hóa chất: Dung dịch {\rm\ce{BaCl2}}, dung dịch {\rm\ce{H2SO4}} loãng. {\rm Tiến hành:} Lấy $\approx2$ {\rm mL} dung dịch {\rm\ce{BaCl2}} cho vào ống nghiệm, sau đó nhỏ từ từ từng giọt dung dịch {\rm\ce{H2SO4}} vào ống nghiệm ($\approx5$ giọt). Mô tả các hiện tượng xảy ra. Giải thích.
\end{thinghiem}
...
\begin{thinghiem}[\cite{SGK_KHTN_8_Canh_Dieu}, Thí nghiệm 3, p. 65]
	{\rm Chuẩn bị:} Dụng cụ: Giá để ống nghiệm, ống nghiệm, ống hút nhỏ giọt. Hóa chất: Dung dịch {\rm\ce{CuSO4}}, dung dịch {\rm\ce{NaOH}}. {\rm Tiến hành:} Lấy $\approx2$ {\rm mL} dung dịch {\rm\ce{CuSO4}} cho vào ống nghiệm, sau đó nhỏ từ từ từng giọt dung dịch {\rm\ce{NaOH}} vào ống nghiệm. Mô tả các hiện tượng xảy ra. Giải thích.
\end{thinghiem}
...
\begin{thinghiem}[\cite{SGK_KHTN_8_Canh_Dieu}, Thí nghiệm 4, p. 66]
	{\rm Chuẩn bị:} Dụng cụ: Giá để ống nghiệm, ống nghiệm, ống hút nhỏ giọt. Hóa chất: Dung dịch {\rm\ce{Na2CO3}}, dung dịch {\rm\ce{CaCl2}}. {\rm Tiến hành:} Lấy $\approx2$ {\rm mL} dung dịch {\rm\ce{Na2CO3}} cho vào ống nghiệm, sau đó nhỏ từ từ từng giọt dung dịch {\rm\ce{CaCl2}} vào ống nghiệm. Mô tả các hiện tượng xảy ra. Giải thích.
\end{thinghiem}
