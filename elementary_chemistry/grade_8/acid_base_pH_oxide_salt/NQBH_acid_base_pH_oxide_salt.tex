...
\begin{itemize}
	...
	\item \textit{Oxide acid} là các oxide tác dụng được với dung dịch base tạo thành muối \& nước. Các oxide acid thường là oxide của các phi kim, e.g., \ce{CO2,SO2,SO3,P2O5}, $\ldots$
	...
	\item \textit{Oxide trung tính} là các oxide không tác dụng với dung dịch acid, dung dịch base. 1 số oxide trung tính, e.g., CO, NO, \ce{N2O}, $\ldots$
\end{itemize}
