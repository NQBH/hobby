...
\begin{thinghiem}[\cite{SGK_KHTN_8_Canh_Dieu}, Thí nghiệm 2, p. 61]
	{\rm Chuẩn bị:} Dụng cụ: Bình tam giác (loại {\rm100 mL}), ống thủy tinh, ống nối cao su. Hóa chất: Dung dịch nước vôi trong, {\rm\ce{CO2}} (được điều chế từ bình tạo khí {\rm\ce{CO2}}). {\rm Tiến hành:} Cho vào bình tam giác $\approx$ {\rm30 mL} nước vôi trong, dẫn khí {\rm\ce{CO2}} từ từ vào dung dịch, khi dung dịch vẫn đục thì dừng lai. Mô tả các hiện tượng xảy ra. Giải thích.
\end{thinghiem}
