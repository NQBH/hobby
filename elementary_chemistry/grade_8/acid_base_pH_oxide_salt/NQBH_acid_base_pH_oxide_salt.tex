...
\begin{vidu}[\cite{SGK_KHTN_8_Canh_Dieu},  p. 67, Ứng dụng của sodium carbonate (soda)]
	Soda là hóa chất thông dụng. Ngoài những ứng dụng trong công nghiệp, soda còn có những ứng dụng trong đời sống. Soda được coi là chất tẩy rửa đa năng, có thể làm sạch dầu mỡ \& khử trùng bề mặt. Để làm sạch những vết bẩn khó giặt như dầu mỡ, trà, cà phê bám trên quần áo cần ngâm quần áo vào nước ấm có hòa tan soda (theo tỷ lệ \emph{8 g\texttt{/}L} $\approx8$ phút hoặc lâu hơn, sau đó tiến hành giặt như bình thường.
\end{vidu}
\noindent\fbox{%
	\parbox{\textwidth}{%
