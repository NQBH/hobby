...
\begin{proof}[Giải]
	Khối lượng \ce{H2SO4} có trong 150 g dung dịch 14\%: $m_{\ce{H2SO4}} = \frac{m_{\rm dd}C\%}{100} = \frac{150\cdot14}{100} = 21$ g.
\end{proof}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 4., p. 142]
	Dựa vào đồ thị về độ tan của các chất rắn trong nước \ref{fig:nhiet_do_do_tan_chat_ran}, cho biết độ tan của các muối \emph{\ce{NaNO3, KBr, KNO3, NH4Cl, NaCl, Na2SO4}} ở nhiệt độ $10^\circ$\emph{C} \& $60^\circ$C.
\end{baitoan}
