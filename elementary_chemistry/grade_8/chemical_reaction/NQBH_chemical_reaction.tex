...
\end{baitoan}
Công thức tính độ tan của 1 chất ở nhiệt độ xác định là $S = \frac{m_{\rm ct}\cdot100}{m_{\rm H_2O}}$ (g\texttt{/}100 g \ce{H2O}), trong đó: $m_{\rm ct}$ là \textit{khối lượng của chất tan} được hòa tan trong nước để tạo thành dung dịch bão hòa, có đơn vị là gam, $m_{\rm H_2O}$ là \textit{khối lượng của nước}, có đơn vị là gam.
...
\end{dinhnghia}
Công thức tính nồng độ \% của dung dịch là: \fbox{$C\% = \frac{m_{\rm ct}\cdot100}{m_{\rm dd}}$\%}, trong đó: $m_{\rm ct}$ là \textit{khối lượng chất tan}, có đơn vị là gam; $m_{\rm dd}$ là \textit{khối lượng dung dịch}, có đơn vị là gam. Khối lượng dung dịch bằng tổng khối lượng chất tan \& khối lượng dung môi: $m_{\rm dd} = m_{\rm ct} + m_{\rm dm}$ với $m_{\rm dm}$ là \textit{khối lượng dung môi}.
...
\end{dinhnghia}
Công thức tính nồng độ mol của dung dịch: \fbox{$C_M = \frac{n}{V}$}, trong đó: $n$ là \textit{số mol chất tan}, có đơn vị là mol, $V$ là \textit{thể tích dung dịch}, có đơn vị là lít.
...
\begin{thinghiem}[Pha chế dung dịch sodium bicarbonate 0.2 M]
	...
	\emph{Tiến hành:} Bước 1: Cân chính xác \emph{1.68 g} muối \emph{\ce{NaHCO3}} cho vào bình tam giác. Bước 2: Thêm \emph{100 mL} nước cất vào bình tam giác, khuấy đều cho muối tan hết, thu được dung dịch \emph{\ce{NaHCO3} 0.2 M}M (1 cách gần đúng có thể coi thể tích dung dịch muối \ce{NaHCO3} là 100 mL).
\end{thinghiem}
...
\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} \textit{Dung dịch} là hỗn hợp lỏng đồng nhất của chất tan \& dung môi. \fbox{\bf 2} \textit{Độ tan} (ký hiệu là $S$) của 1 chất trong nước là số gam chất đó hòa tan trong $100$ gam nước để tạo thành dung dịch bão hòa ở 1 nhiệt độ, áp suất xác định. \fbox{\bf 3} \textit{Nồng độ phần \%} (ký hiệu là $C$\%) của 1 dung dịch là số gam chất tan có trong $100$ gam dung dịch: $C\% = \frac{m_{\rm ct}\cdot100\%}{m_{\rm dd}}$. \fbox{\bf 4} \textit{Nồng độ mol} (ký hiệu là $C_M$) của 1 dung dịch là số mol chất tan có trong 1 lít dung dịch. $C_M = \frac{n}{V}$ mol\texttt{/}L.
	}%
}
