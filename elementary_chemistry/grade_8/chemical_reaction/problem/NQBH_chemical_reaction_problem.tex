...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 17., p. 51]
	Cân bằng phương trình \& xác định mỗi phản ứng sau thuộc loại phản ứng nào? {\rm(a) \ce{Cu(NO3)2 -> CuO + NO2 + O2}. (b) \ce{Zn + CuCl2 -> ZnCl2 + Cu}. (c) \ce{SO2 + O2 -> SO3}. (d) \ce{CuCO3.Cu(OH)2 ->[$t^\circ$] CuO + CO2 ^ + H2O}. (e) \ce{Cu + Hg(NO3)2 -> Cu(NO3)2 + Hg}. (f) \ce{CaO + H2O -> Ca(OH)2}.}
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 18., p. 50]
	Có bao nhiêu {\rm g \ce{H2O}} được tạo thành sau khi cho nổ hỗn hợp gồm {\rm1 mol} hydrogen \& {\rm20 g} oxygen?
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 22., p. 53]
	{\rm1 g} vôi sống {\rm CaO} hay {\rm1 g} vôi tôi {\rm\ce{Ca(OH)2}} chứa nhiều phân tử hơn?
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 23., p. 53]
	Cần bao nhiêu {\rm g} oxygen để đốt cháy hoàn toàn {\rm5 mol} carbon thành khí carbonic {\rm\ce{CO2}? 5 mol} sulfur thành khí {\rm\ce{SO2}}?
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 24., p. 53]
	Cần đốt bao nhiêu lượng phosphor để tạo thành: (a) {\rm71 g} diphosphor pentoxide {\rm\ce{P2O5}}. (b) {\rm5.5 mol \ce{P2O5}}.
\end{baitoan}
...
\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 30., p. 53]
	Viết các phương trình của các phản ứng oxi hóa--khử sau, vẽ sơ đồ sự khử \& sự oxy hóa, cho biết chất khử \& chất oxy hóa: {\rm\ce{Fe2O3 + CO -> Fe + CO2, Fe3O4 + CO -> FeO + CO2, Fe2O3 + Al -> Fe + Al2O3, HgO + H2 -> Hg + H2O}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 31., p. 54]
	Hoàn thành {\rm PTHH} của các phản ứng giữa các chất: {\rm\ce{Mg + O2, Na + H2O, P + O2, K2O + H2O, Al + O2, P2O5 + H2O, Al + Cl2, H2O} điện phân, \ce{Al + HCl, KClO3} nhiệt phân, \ce{Fe3O4 + H2, BaO + H2O}}.
\end{baitoan}

\begin{baitoan}[\cite{An_Hoa_Hoc_nang_cao_8_9}, 32., p. 54]
	Viết {\rm PTHH} biểu diễn các biến hóa sau \& cho biết mỗi phản ứng đó thuộc loại phản ứng nào? {\rm(a) Na $\to$ \ce{Na2O} $\to$ NaOH. (b) P $\to$ \ce{P2O5} $\to$ \ce{H3PO4} $\to$ \ce{Na3PO4}. (c) \ce{Fe2O3} $\to$ Fe $\to$ \ce{FeCl2} \& Fe $\to$ \ce{FeCl3}. (d) S $\to$ \ce{SO2} $\to$ \ce{SO3} $\to$ \ce{H2SO4}. (e) C $\to$ \ce{CO2} $\to$ \ce{CaCO3} $\to$  \ce{CO2}. (f) \ce{MgCO3} $\to$ \ce{CO2} $\to$ \ce{CaCO3} $\to$ CaO $\to$ \ce{Ca(OH)2}}.
\end{baitoan}
