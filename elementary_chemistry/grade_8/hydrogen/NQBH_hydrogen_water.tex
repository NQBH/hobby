...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 3., p. 109]
	Chọn cụm từ thích hợp: tính oxy hóa, tính khử, chiếm oxy, nhường oxy, nhẹ nhất, để điền vào chỗ trống trong các câu sau: Trong các chất khí, hydro là khí $\ldots$ Khí hydro có $\ldots$ Trong phản ứng giữa \emph{\ce{H2,CuO,H2}} có $\ldots$ vì $\ldots$ của chất khác; \emph{CuO} có $\ldots$ vì $\ldots$ cho chất khác.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 2., p. 113]
	Cho biết trong những phản ứng hóa học xảy ra quanh ta sau đây, phản ứng nào là phản ứng oxy hóa--khử? Lợi ích \& tác hại của mỗi phản ứng? (a) Đốt than trong lò: \emph{\ce{C + O2 ->[$t^\circ$] CO2}}. (b) Dùng carbon dioxyde khử sắt(III) oxyde trong luyện kim: \emph{\ce{Fe2O3 + $3$CO ->[$t^\circ$] $2$Fe + $3$CO2}}. (c) Nung vôi: \emph{\ce{CaCO3 ->[$t^\circ$] CaO + CO2}}. (d) Sắt bị gỉ trong không khí ẩm (phản ứng chính): \emph{\ce{$4$Fe + $3$O2 -> 2Fe2O3}}.
\end{baitoan}

\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 3., p. 113]
	Lập các PTHH theo các sơ đồ sau: \emph{\ce{Fe2O3 + CO ->[$t^\circ$] CO2 + Fe, Fe3O4 + H2 ->[$t^\circ$] H2O + Fe, CO2 + Mg ->[$t^\circ$] MgO + C}}. Các phản ứng hóa học này có phải là phản ứng oxy hóa--khử không? Vì sao? Nếu là phản ứng oxy hóa--khử, cho biết chất nào là chất khử, chất oxy hóa? Vì sao?
\end{baitoan}

\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 4., p. 113]
	Trong phòng thí nghiệm, dùng carbon oxyde \emph{CO} để khử $0.2$\emph{mol \ce{Fe3O4}} \& dùng khí hydro để khử $0.2$\emph{mol \ce{Fe2O3}} ở nhiệt độ cao. (a) Viết PTHH của các phản ứng đã xảy ra. (b) Tính số \emph{l} khí \emph{CO,\ce{H2}} ở đktc cần dùng cho mỗi phản ứng. (c) Tính số \emph{g} sắt thu được ở mỗi phản ứng hóa học.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 1., p. 117]
	Những PTHH nào dưới đây có thể được dùng để điều chế hydro trong phòng thí nghiệm? (a) \emph{\ce{Zn + H2SO4 -> ZnSO4 + H2 ^}}. (b) \emph{\ce{$2$H2O ->[\mbox{điện phân}] $2$H2 ^ + O2 ^}}. (c) \emph{\ce{$2$Al + $6$HCl -> $2$AlCl3 + $3$H2 ^}}.
\end{baitoan}

\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 2., p. 117]
	Lập PTHH của các sơ đồ phản ứng cho sau đây \& cho biết chúng thuộc loại phản ứng hóa học nào? (a) \emph{\ce{Mg + O2 -> MgO}}. (b) \emph{\ce{KMnO4 ->[$t^\circ$] K2MnO4 + MnO2 + O2}}. (c) \emph{\ce{Fe + CuCl2 -> FeCl2 + Cu}}.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 4., p. 117]
	Trong phòng thí nghiệm có các kim loại kẽm \& sắt, dung dịch acid hydrochloric \emph{HCl} \& dung dịch acid sulfuric \emph{\ce{H2SO4}} loãng: (a) Viết các PTHH có thể điều chế hydro. (b) Phải dùng bao nhiêu \emph{g} kẽm, bao nhiêu \emph{g} sắt để điều chế được $2.24$\emph{l} khí hydro (ở đktc)?
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 1., p. 118]
	Viết PTHH biểu diễn phản ứng của \emph{\ce{H2}} với các chất: \emph{\ce{O2,Fe2O3,Fe3O4,PbO}}. Ghi rõ điều kiện phản ứng. Giải thích \& cho biết mỗi phản ứng trên thuộc loại phản ứng gì?
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 4., p. 119]
	(a) Lập PTHH của các phản ứng sau: carbon dioxyde $+$ nước $\to$ acid carbonic \emph{\ce{H2CO3}}, lưu huỳnh dioxyde $+$ nước $\to$ acid sulfurơ \emph{\ce{H2SO3}}, kẽm $+$ acid hydrochloric $\to$ kẽm clorua $+$ \emph{\ce{H2 ^}}, diphospho pentaoxyde $+$ nước $\to$ acid phosphoric \emph{\ce{H3PO4}}, chì(II) oxyde $+$ hydro \ce{\to[$t^\circ$]} chì $+$ \emph{\ce{H2O}}. (b) Phân loại các phản ứng hóa học trên.
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.32, p. 87]
	Khử hoàn toàn $5.43$\emph{g} 1 hỗn hợp gồm có \emph{CuO,PbO} bằng khí \emph{\ce{H2}}, thu được $0.9$\emph{g \ce{H2O}}. (a) Viết PTHH các phản ứng đã xảy ra. (b) Tính thành phần \% theo khối lượng của các oxyde có trong hỗn hợp ban đầu. (c) Tính thành phần \% theo khối lượng của hỗn hợp chất rắn thu được sau phản ứng.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.33, p. 87]
	(a) Khử hoàn toàn $5.575$\emph{g} 1 oxyde chì bằng khí \emph{\ce{H2}}, thu được $5.175$\emph{g} chì. Tìm CTHH của oxyde chì. (b) Khử hoàn toàn $4$\emph{g} 1 oxyde đồng bằng khí \emph{\ce{H2}}, thu được $3.2$\emph{g} đồng. Tìm CTHH của oxyde đồng.
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.43, p. 90]
	Viết các PTHH \& dùng quỳ tím để chứng minh: (a) \emph{\ce{CO2,SO2,SO3,N2O5,P2O5}} là các oxyde acid. (b) \emph{\ce{Na2O,K2O,CaO,BaO}} là các oxyde base.
\end{baitoan}
...
``\fbox{\bf 1} \textsf{\textbf{Acid.}} (a) Khái niệm: \textit{Phân tử acid} gồm có 1 hay nhiều nguyên tử hydro liên kết với gốc acid, các nguyên tử hydro này có thể thay thế bằng các nguyên tử kim loại. (b) Phân loại: Dựa vào thành phần phân tử, acid được chia ra làm 2 loại: Acid không có oxy, e.g., HF, HCl, HBr, HI, \ce{H2S}, $\ldots$ Acid có oxy, e.g., \ce{H2SO4,H2SO3,HNO3,H3PO4,H3PO3}, $\ldots$ \fbox{\bf 2} \textsf{\textbf{Base.}} (a) Khái niệm: \textit{Phân tử base} gồm có 1 nguyên tử kim loại liên kết với 1 hay nhiều nhóm hydroxyde -OH. (b) Phân loại: Dựa vào tính tan trong nước, base được chia ra làm 2 loại: \textit{Base tan}, gọi là \textit{kiềm} e.g., NaOH, KOH, \ce{Ba(OH)2}, $\ldots$ \textit{Base không tan}, e.g., \ce{Cu(OH)2,Mg(OH)2,Al(OH)3}, $\ldots$ \fbox{\bf 3} \textsf{\textbf{Muối.}} (a) Khái niệm: \textit{Phân tử muối} gồm có nguyên tử kim loại liên kết với 1 hay nhiều gốc acid. (b) Phân loại: Dựa vào thành phần phân tử, muối được chia ra làm 2 loại: \textit{Muối trung hòa} là muối mà trong gốc acid không có hydro (hoặc có hydro thì nguyên tử hydro đó không thể thay thế bằng kim loại), e.g., NaCl, \ce{NaNO3,Na2SO4,Na2HPO3}, $\ldots$ \textit{Muối acid} là muối mà trong gốc acid còn nguyên tử hydro có thể thay thế bằng kim loại, e.g., \ce{NaHSO4,Ca(HCO3)2,NaH2PO4,Na2HPO4}, $\ldots$'' -- \cite[Chap. 5, \S4, p. 91]{Truong_BTNC_Hoa_Hoc_8_2022}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 2., p. 125]
	Viết CTHH của các acid có gốc acid cho dưới đây \& cho biết tên của chúng: \emph{\ce{-Cl,=SO3,=SO4,-HSO4,=CO3,#PO4,=S,-Br,-NO3}}.
\end{baitoan}

\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 3., p. 125]
	Viết CTHH của những oxyde acid tương ứng với những acid sau: \emph{\ce{H2SO4,H2SO4,H2CO3,HNO3,H3PO4}}.
\end{baitoan}

\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 4., p. 125]
	Viết CTHH của base tương ứng với các oxyde sau: \emph{\ce{Na2O,Li2O,FeO,BaO}, \ce{CuO,Al2O3}}.
\end{baitoan}

\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 5., p. 125]
	Viết CTHH của oxyde tương ứng với các base sau: \emph{\ce{Ca(OH)2,Mg(OH)2}, \ce{Zn(OH)2,Fe(OH)2}}.
\end{baitoan}

\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 6., p. 125]
	Đọc tên của những chất có CTHH sau: (a) \emph{\ce{HBr,H2SO3,H3PO4,H2SO4}}. (b) \emph{\ce{Mg(OH)2,Fe(OH)3,Cu(OH)2}}. (c) \emph{\ce{Ba(NO3)2,Al2(SO4)3,Na2SO3,ZnS,Na2HPO4,NaH2PO4}}.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 2., p. 132]
	Lập PTHH của những phản ứng có sơ đồ sau: (a) \emph{\ce{Na2O + H2O -> NaOH, K2O + H2O -> KOH}}. (b) \emph{\ce{SO2 + H2O -> H2SO3, SO3 + H2O -> H2SO4, N2O5 + H2O -> HNO3}}. (c) \emph{\ce{NaOH + HCl -> NaCl + H2O, Al(OH)3 + H2SO4 -> Al2(SO4)3 + H2O}}. (d) Chỉ ra chất sản phẩm ở (a), (b), (c) thuộc loại hợp chất nào? Nguyên nhân dẫn đến sự khác nhau về loại hợp chất của các chất sản phẩm ở (a), (b)? (e) Gọi tên các chất sản phẩm.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_8}, 5., p. 132]
	Nhôm oxyde tác dụng với acid sulfuric theo PTHH như sau: \emph{\ce{Al2O3 + $3$H2SO4 -> Al2(SO4)3 + $3$H2O}}. Tính khối lượng muối nhôm sunfat được tạo thành nếu đã sử dụng $49$\emph{g} acid sulfuric nguyên chất tác dụng với $60$\emph{g} nhôm oxyde. Sau phản ứng, chất nào còn dư? Khối lượng dư của chất đó là bao nhiêu?
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.47, p. 92]
	Viết CTHH của các acid mà trong phần tử lần lượt có các gốc acid sau: \emph{Br(I), S(II), \ce{NO2(I),SO3(II),CO3(II),PO4(III),SiO3(II),ClO4(I),ClO3(I),MnO4(I),Cr2O7(II),ClO2(I),ClO(I)}}.
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.49, p. 92]
	Cho các chất có CTHH sau: \emph{\ce{K2O,HF,ZnSO4,CaCO3,Fe(OH)2,Fe(OH)3,CO,CO2,H2O}, \ce{NO,NO2,HClO,AlCl3,HClO4,H3PO4,NaH2PO4,Na2HPO4,Na3PO4,CH3COOH,CH3COOK}}. Gọi tên từng chất \& cho biết mỗi chất đó thuộc loại nào?
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.51, p. 92]
	Viết PTHH của các phản ứng biểu diễn các biến hóa sau: (a) \emph{Na $\to$ \ce{Na2O} $\to$ NaOH}. (b) \emph{Ca $\to$ CaO $\to$ \ce{Ca(OH)2}}. (c) \emph{C $\to$ \ce{CO2} $\to$ \ce{H2CO3}}. (d) \emph{S $\to$ \ce{SO2} $\to$ \ce{SO3} $\to$ \ce{H2SO4} $\to$ \ce{ZnSO4}}. Cho biết mỗi chất thuộc loại nào? Mỗi phản ứng thuộc loại nào?
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.53, pp. 92--93]
	Acid tác dụng với base tạo thành muối \& nước. Căn cứ vào tính chất đó, lập PTHH của các phản ứng acid tác dụng với base sau: (a) \emph{HCl $+$ NaOH} $\to$. (b) \emph{\ce{HClO4 + NaOH ->}}. (c) \emph{\ce{H2SO4 + Al(OH)3 ->}}. (d) \emph{\ce{H3PO4 + Ca(OH)2 ->}}. (e) \emph{\ce{HNO3 + Fe(OH)3 ->}}.
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.56, p. 93]
	Chọn những chất nào sau đây: acid \emph{\ce{H2SO4}} loãng, \emph{\ce{KMnO4}, Cu, P, C, NaCl, Zn, S, \ce{H2O}, \ce{CaCO3,Fe2O3,Ca(OH)2,K2SO4,Al2O3}} để điều chế các chất: \emph{\ce{H2,O2,CuSO4,H3PO4},Cao,Fe}. Viết PTHH của các phản ứng.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.57, p. 93]
	Chỉ dùng acid hydrochloric \emph{HCl} có thể phân biệt 4 chất rắn ở dạng bột là \emph{Al,Cu,\ce{Al2O3},CuO} được không? Viết PTHH của các phản ứng (nếu có).
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.58, p. 93]
	Bằng phương pháp hóa học, nhận biết 4 chất khí là \emph{\ce{O2,H2,CO2,CO}} đựng trong 4 bình riêng biệt.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.59, p. 93]
	Bằng phương pháp hóa học, nhận biết các dung dịch sau: \emph{HCl,NaOH,\ce{Ca(OH)2,CuSO4}, NaCl}. Viết PTHH của các phản ứng xảy ra.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.60, p. 94]
	Có 1 cốc đựng dung dịch \emph{\ce{H2SO4}} loãng. Lúc đầu người ta cho 1 lượng bột nhôm vào dung dịch acid, phản ứng xong thu được $6.72$\emph{l \ce{H2}}. Sau đó thêm tiếp vào dung dịch acid đó 1 lượng bột kẽm dư, phản ứng xong thu thêm được $4.48$\emph{l \ce{H2}} nữa. (a) Viết PTHH của các phản ứng hó học đã xảy ra. (b) Tính khối lượng bột nhôm \& bột kẽm đã tham gia phản ứng. (c) Tính khối lượng acid \emph{\ce{H2SO4}} có trong dung dịch ban đầu. (d) Hợp chất được tạo thành sau những phản ứng trên thuộc loại nào? Khối lượng của chúng là bao nhiêu? Các thể tích khí được đo ở đktc.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.61, p. 94]
	Cho 1 luồng khí \emph{\ce{H2}} đi qua bột \emph{CuO} nóng, màu đen thu được 1 hỗn hợp 2 chất rắn, trong đó có $3.2$\emph{g} chất rắn màu đỏ. Nếu cho luồng khí \emph{\ce{H2}} có thể tích $2.24$\emph{l} đi qua tiếp thì thu được 1 chất rắn duy nhất có màu đỏ. (a) Giải thích quá trình phản ứng. (b) Tính thể tích khí \emph{\ce{H2}} lần thứ nhất đã khử \emph{CuO}. (c) Tính khối lượng \emph{CuO} đã bị khử lần thứ 2. (d) Tính khối lượng \emph{CuO} đã dùng ban đầu. (e) Tính khối lượng kim loại \emph{Cu} thu được trong lần sau. Các thể tích khí đo ở đktc.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.62, p. 94]
	Khử hoàn toàn $27.6$\emph{g} hỗn hợp \emph{\ce{Fe2O3,Fe3O4}} ở nhiệt độ cao phải dùng hết $11.2$\emph{l} khí \emph{CO} (đktc). (a) Viết phương trình của các phản ứng hóa học đã xảy ra. (b) Tính thành phần \% theo số mol \& theo khối lượng của mỗi loại oxyde sắt có trong hỗn hợp. (c) Tính khối lượng sắt thu được sau các phản ứng trên.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.63, p. 95]
	Cho các chất: \emph{\ce{Na2O,CaO,CuO,BaO,ZnO,Fe2O3,Al2O3,Na,K,Ca,Cu,Fe,Zn,SO3}, \ce{P2O5}}. (a) Viết PTHH của phản ứng của mỗi chất đó với nước (nếu có). (b) Gọi tên sản phẩm của mỗi phản ứng \& cho biết phản ứng đó thuộc loại phản ứng nào?
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.65, p. 95]
	Tính khối lượng \emph{\ce{Ca(OH)2}} có thể thu được khi cho $140$\emph{kg} vôi sống tác dụng với nước. Biết trong vôi sống chỉ có $90$\% \emph{CaO}, còn lại là tạp chất.
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.71, p. 96]
	So sánh thể tích khí \emph{\ce{H2}} thu được trong mỗi trường hợp sau \& giải thích. (a) $0.1$\emph{mol Zn} tác dụng với dung dịch \emph{\ce{H2SO4}} loãng, dư. $0.1$\emph{mol Al} tác dụng với dung dịch \emph{HCl} dư. (b) $0.3$\emph{mol Zn} tác dụng với dung dịch \emph{HCl} dư. $0.2$\emph{mol Al} tác dụng với dung dịch \emph{HCl} dư. (c) $3.25$\emph{g Zn} tác dụng với dung dịch \emph{\ce{H2SO4}} dư. $2.8$\emph{g Fe} tác dụng với dung dịch \emph{HCl} dư. (d) $16.8$\emph{g Mg} tác dụng với dung dịch \emph{HCl} dư. $16.8$\emph{g Fe} tác dụng với dung dịch \emph{HCl} dư. (e) $0.1$\emph{mol \ce{H2SO4}} tác dụng với bột \emph{Fe} dư. $0.1$\emph{mol HCl} tác dụng với bột \emph{Fe} dư.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.72, p. 96]
	Cần điều chế $6.72$\emph{l \ce{H2}} (đktc) từ những chất là \emph{Mg,Al,Fe}, acid \emph{HCl}, acid \emph{\ce{H2SO4}} loãng. Chọn: (a) Kim loại nào để có khối lượng nhỏ nhất \& cần bao nhiêu \emph{g}, nếu dùng dư acid? (b) Acid nào để có khối lượng nhỏ nhất \& cần bao nhiêu \emph{g}, nếu dùng dư kim loại? (c) Acid nào \& kim loại nào để chúng có khối lượng nhỏ nhất \& cần bao nhiêu \emph{g}?
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.73, p. 97]
	Đốt cháy hoàn toàn $22.4$\emph{l} hỗn hợp khí \emph{\ce{H2},CO}, thu được $8.8$\emph{g} khí \emph{\ce{CO2}}. (a) Viết PTHH của các phản ứng đã xảy ra. (b) Tính thể tích của mỗi khí có trong hỗn hợp. (c) Tính thể tích khí \emph{\ce{O2}} cần dùng để đốt cháy hỗn hợp khí. (d) Tính khối lượng của hỗn hợp khí ban đầu. (e) Tính thể tích khí \emph{\ce{CO2}} sinh ra. Các thể tích khí đo ở đktc.
\end{baitoan}
...
\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.75, p. 97]
	Cho $0.65$\emph{g Zn} tác dụng với $7.3$\emph{g HCl}. (a) Chất nào còn dư sau phản ứng? Khối lượng là bao nhiêu \emph{g}? (b) Tính thể tích khí \emph{\ce{H2}} thu được ở đktc. (c) Tính khối lượng \emph{Zn} hoặc khối lượng \emph{HCl} cần bổ sung để tác dụng hết với chất còn dư sau phản ứng.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.76, p. 97]
	Ngâm 1 lá kẽm nhỏ trong dung dịch acid \emph{HCl}. Phản ứng xong lấy lá kẽm ra khỏi dung dịch, rửa sạch, làm khô, nhận thấy khối lượng lá kẽm giảm $6.5$\emph{g} so với trước phản ứng. (a) Viết PTHH của phản ứng. (b) Tính thể tích khí \emph{\ce{H2}} sinh ra ở đktc. (c) Tính khối lượng \emph{HCl} tham gia phản ứng. (d) Dung dịch chất nào còn lại sau phản ứng? Khối lượng của chất đó trong dung dịch là bao nhiêu?
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.77, p. 98]
	Khử $24$\emph{g} hỗn hợp \emph{\ce{Fe2O3},CuO} bằng \emph{CO}, thu được $17.6$\emph{g} hỗn hợp 2 kim loại. (a) Viết PTHH của các phản ứng xảy ra. (b) Tính khối lượng mỗi kim loại thu được. (c) Tính thể tích khí \emph{CO} (đktc) cần dùng cho sự khử hỗn hợp trên. (d) Trình bày 1 phương pháp hóa học \& 1 phương pháp vật lý để tách kim loại \emph{Cu} ra khỏi hỗn hợp sau phản ứng. Viết PTHH của phản ứng.
\end{baitoan}

\begin{baitoan}[\cite{Truong_BTNC_Hoa_Hoc_8_2022}, V.78, p. 98]
	Chia $V$\emph{l} hỗn hợp khí \emph{CO,\ce{H2}} thành 2 phần bằng nhau. Đốt cháy hoàn toàn phần thứ nhất bằng \emph{\ce{O2}}, sau đó dẫn sản phẩm đi qua nước vôi trong dư, thu được $20$\emph{g} chất kết tủa màu trắng. Dẫn phần thứ 2 đi qua bột \emph{CuO} dư, đun nóng, phản ứng xong thu được $19.2$\emph{g} kim loại \emph{Cu}. (a) Viết PTHH của các phản ứng xảy ra. (b) Xác định $V$ (đktc). (c) Tính thành phần \% của hỗn hợp khí ban đầu theo khối lượng \& theo thể tích. 
\end{baitoan}

\begin{baitoan}[\cite{An_400_BT_Hoa_Hoc_8_2020}, 315., p. 147]
	(a) Viết công thức các acid \& base tương ứng với các oxyde sau: \emph{\ce{MgO,Al2O3,SO2,SiO2}, \ce{SO3,CO2,P2O5,N2O5,Fe2O3}}. (b) Cho các CTHH: \emph{\ce{CaCO3,Na2SO3,Cu2O,Na2O,HCl,ZnSO4,Fe(OH)3,H3PO4,Ca(OH)2}},\\\emph{\ce{Al(OH)3,Cu(OH)2,CO,CO2,NO,KHSO4,N2O5,Fe2O3,SO3,P2O5,HNO3,H2O,Fe(NO3)3,Fe2(SO4)3,Na3PO4,CaO,CuO}},\\\emph{\ce{NaHCO3,FeO}}. Gọi tên từng chất \& cho biết mỗi chất thuộc loại nào.
\end{baitoan}
