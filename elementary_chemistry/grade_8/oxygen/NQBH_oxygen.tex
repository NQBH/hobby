...
\begin{proof}[Giải]
	Khí oxi là 1 đơn chất rất hoạt động, đặc biệt ở nhiệt độ cao, dễ dàng tham gia phản ứng hóa học với nhiều phi kim, kim loại, \& hợp chất. E.g., \ce{C + O2 ->[$t^\circ$] CO2, 2Mg + O2 ->[$t^\circ$] 2MgO, C4H10 + \frac{13}{2}O2 ->[$t^\circ$] 4CO2 + 5H2O}.
\end{proof}
