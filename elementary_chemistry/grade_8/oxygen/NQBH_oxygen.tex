...
\begin{proof}[Giải]
	Khí oxi \ce{O2} là 1 đơn chất rất hoạt động, đặc biệt ở nhiệt độ cao, dễ dàng tham gia phản ứng hóa học với nhiều phi kim, kim loại, \& hợp chất, e.g., \ce{C + O2 ->[$t^\circ$] CO2, $2$Mg + O2 ->[$t^\circ$] $2$MgO, C4H10 + $\frac{13}{2}$O2 ->[$t^\circ$] $4$CO2 + $5$H2O}.
\end{proof}

\begin{baitoan}[\cite{An_400_BT_Hoa_Hoc_8_2020}, 194., p. 102]
	Đốt cháy $6.2$\emph{g} photpho trong bình chứa $6.16$\emph{l} khí oxi (đktc) tạo thành điphotpho pentaoxit \emph{\ce{P2O5}}. (a) Sau phản ứng chất nào còn thừa \& số mol còn thừa là bao nhiêu? (b) Tính khối lượng chất tạo thành.
\end{baitoan}

\begin{proof}[Giải]
	(a) $n_{\rm P } = \frac{m_{\rm P}}{M_{\rm P}} = \frac{6.2}{31} = 0.2$ mol, $n_{\rm O_2} = \frac{V_{\rm O_2}}{22.4} = \frac{6.16}{22.4} = 0.275$ mol. \ce{$4$P + $5$O2 ->[$t^\circ$] $2$P2O5}. Vì $\frac{n_{\rm P}}{4} = \frac{0.2}{4} < \frac{0.275}{5} = \frac{n_{\rm O_2}}{5}$ nên P hết, \ce{O2} dư. $n_{\rm O_2,\footnotesize\mbox{dư}} = n_{\rm O_2} - n_{\rm O_2,\footnotesize\mbox{pư}} = 0.275 - \frac{0.2\cdot5}{4} = 0.025$ mol. (b) Vì oxi dư nên tính số mol \ce{P2O5} theo P: $n_{\rm P_2O_5} = \frac{1}{2}n_{\rm P} = \frac{1}{2}\cdot0.2 = 0.1$ mol. $m_{\rm P_2O_5} = n_{\rm P_2O_5}M_{\rm P_2O_5} = 0.1(31\cdot2 + 16\cdot 5) = 0.1\cdot142 = 14.2$g.
\end{proof}
...
\begin{proof}[Giải]
	$n_{\rm CH_4} = \frac{V_{\rm CH_4}}{22.4} = \frac{2.24}{22.4} = 0.1$ mol, có $V_{\rm kk} = 5V_{\rm O_2}$, $n_{\rm O_2} = \frac{V_{\rm O_2}}{22.4} = \frac{V_{\rm kk}}{5\cdot22.4} = \frac{28}{5\cdot22.4} = 0.25$ mol. \ce{CH4 + $2$O2 ->[$t^\circ$] CO2 + $2$H2O}. Vì $\frac{n_{\rm CH_4}}{1} = \frac{0.1}{1} < \frac{0.25}{2} = \frac{n_{\rm O_2}}{2}$ nên \ce{CH4} hết, \ce{O2} dư: $n_{\rm O_2,\footnotesize\mbox{dư}} = n_{\rm O_2} - n_{\rm O_2,\footnotesize\mbox{pư}} = 0.25 - 0.1\cdot2 = 0.05$ mol.
\end{proof}
...
\begin{proof}[Giải]
	\ce{C + O2 ->[$t^\circ$] CO2 ^}. $n_{\rm CO_2} = n_{\rm C} = \frac{36000(100 - 0.5 - 1.5)}{100\cdot12} = 2940$ mol. $V_{\rm CO_2} = 22.4n_{\rm CO_2} = 22.4\cdot2940 = 65865$l.\\\ce{S + O2 ->[$t^\circ$] SO2 ^}. $n_{\rm SO_2} = n_{\rm S} = \frac{36000\cdot0.5}{100\cdot32} = 5.625$ mol. $V_{\rm SO_2} = 22.4n_{\rm SO_2} = 22.4\cdot5.625 = 126$l.
\end{proof}
...
\begin{baitoan}[\cite{An_400_BT_Hoa_Hoc_8_2020}, 236., p. 107]
	Có 1 quặng sắt hàm lượng $50$\%. Khi phân tích 1 mẫu quặng này, người ta nhận thấy có $2.8$\emph{g} sắt. Trong mẫu quặng trên, tính khối lượng sắt(III) oxit \emph{\ce{Fe2O3}} ứng với hàm lượng sắt nói trên.
\end{baitoan}
...
\begin{baitoan}[\cite{An_400_BT_Hoa_Hoc_8_2020}, 248., p. 108]
	1 oxit của photpho có thành phần \% của \emph{P} bằng $43.66$\%. Biết phân tử khối của oxit bằng $142$ \emph{đvC}. CTHH của oxit là: {\sf A.} \emph{\ce{P2O3}}. {\sf B.} \emph{\ce{P2O5}}. {\sf C.} \emph{\ce{PO2}}. {\sf D.} \emph{\ce{P2O4}}.
\end{baitoan}

\begin{baitoan}[\cite{An_400_BT_Hoa_Hoc_8_2020}, 249., p. 108]
	Khi đốt cháy sắt trong oxi được oxit sắt từ \emph{\ce{Fe3O4}} ở nhiệt độ cao. (a) Số gam sắt \& khí oxi cần dùng để điều chế $2.32$\emph{g} oxit sắt từ lần lượt là: {\sf A.} $0.84$\emph{g} \& $0.32$\emph{g}. {\sf B.} $2.52$\emph{g} \& $0.96$\emph{g}. {\sf C.} $1.68$\emph{g} \& $0.64$\emph{g}. {\sf D.} $0.95$\emph{g} \& $0.74$\emph{g}. (b) Số gam kali pemanganat \emph{\ce{KMnO4}} cần dùng để điều chế lượng khí oxi dùng cho phản ứng trên là: {\sf A.} $3.16$\emph{g}. {\sf B.} $9.48$\emph{g}. {\sf C.} $5.24$\emph{g}. {\sf D.} $6.32$\emph{g}.
\end{baitoan}
