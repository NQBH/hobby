...
\end{equation}
\noindent\textbf{\textsf{Trường hợp \ce{CO2} tác dụng với dung dịch chứa $x$ mol NaOH{\tt/}KOH \& $y$ mol \ce{Ba(OH)2}{\tt/}\ce{Ca(OH)2}.}} Có thể coi các phản ứng xảy ra theo thứ tự: \ce{CO2 + Ba(OH)2 -> BaCO3 v + H2O} hoặc \ce{CO2 + Ca(OH)2 -> CaCO3 v + H2O} (1). Nếu \ce{Ca(OH)2} mà vẫn sục khí \ce{CO2} vào thì \ce{CO2 + $2$NaOH -> Na2CO3 + H2O} hoặc \ce{CO2 + $2$KOH -> K2CO3 + H2O}K (2). Nếu NaOH{\tt/}KOH hết mà vẫn sục khí \ce{CO2} vào thì \ce{CO2 + Na2CO3 + H2O -> $2$NaHCO3} hoặc \ce{CO2 + K2CO3 + H2O -> $2$KHCO3} (3). (2) $+$ (3): \ce{CO2 + NaOH -> NaHCO3} hoặc \ce{CO2 + KOH -> KHCO3} (4). Nếu \ce{Na2CO3}{\tt/}\ce{K2CO3} hết mà \ce{CO2} còn thì kết tủa tan dần: \ce{CO2 + BaCO3 + H2O -> Ba(HCO3)2} hoặc \ce{CO2 + CaCO3 + H2O -> Ca(HCO3)2} (5). (1) $+$ (5): \ce{$2$CO2 + Ca(OH)2 -> Ca(HCO3)2} (6). Tổng hợp lại:
\begin{itemize}
