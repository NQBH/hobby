...
\begin{proof}[Giải]
	$m_{\ce{H2SO4}} = m_{\rm dd\ce{H2SO4}}C\% = 100\cdot20\% = 20$ g. $n_{\rm CuO} = \frac{m_{\rm CuO}}{M_{\rm CuO}} = \frac{1.6}{80} = 0.02$ mol, $n_{\ce{H2SO4}} = \frac{m_{\ce{H2SO4}}}{M_{\ce{H2SO4}}} = \frac{20}{98} = \frac{10}{49}$ mol. (a) PTHH: \ce{CuO + H2SO4 -> CuSO4 + H2O}. Vì $\frac{n_{\rm CuO}}{1} < \frac{n_{\ce{H2SO4}}}{1}$ ($0.02 < 0.2$) nên CuO phản ứng hết, \ce{H2SO4} dư, suy ra khối lượng \ce{CuSO4} tạo thành \& \ce{H2SO4} phản ứng tính theo số mol CuO. (b) Dung dịch sau phản ứng có 2 chất tan: \ce{CuSO4} \& \ce{H2SO4} còn dư. $C\%_{\ce{CuSO4}} = \frac{m_{\ce{CuSO4}}}{m_{\rm dd}}\cdot100\% = \frac{0.02\cdot160}{1.6 + 100}\cdot100\% = \frac{400}{127}\%\approx31.49606299\%$. $C\%_{\ce{H2SO4}} = \frac{m_{\ce{H2SO4},\tiny\mbox{dư}}}{m_{\rm dd}}\cdot100\% = \frac{20 - 0.02\cdot98}{1.6 + 100}\cdot100\% = \frac{45100}{2540}\%\approx17.75590551\%$. Vậy $C\%_{\ce{CuSO4}}\approx31.49606299\%$, $C\%_{\ce{H2SO4}}\approx17.75590551\%$.
\end{proof}
...
\begin{proof}[Giải]
	$m_{\ce{H2SO4}} = m_{\rm dd\ce{H2SO4}}C\% = m_2C\%$ g. $n_{\rm CuO} = \frac{m_{\rm CuO}}{M_{\rm CuO}} = \frac{m_1}{80}$ mol, $n_{\ce{H2SO4}} = \frac{m_{\ce{H2SO4}}}{M_{\ce{H2SO4}}} = \frac{m_2C\%}{98}$ mol. PTHH: \ce{CuO + H2SO4 -> CuSO4 + H2O}. Theo định luật bảo toàn khối lượng, $m_{\rm dd} = m_{\rm CuO,\tiny\mbox{pư}} + m_{\rm dd\ce{H2SO4}} = m_{\rm CuO} + m_{\rm dd\ce{H2SO4}} - m_{\rm CuO,\tiny\mbox{dư}} = m_1 + m_2 - m_{\rm CuO,\tiny\mbox{dư}}$ g. Xét 2 trường hợp:
	\begin{itemize}
		\item[(a)] Nếu $n_{\rm CuO} < n_{\ce{H2SO4}}$, i.e., nếu $m_1,m_2,C\%$ thỏa $\frac{m_1}{80} < \frac{m_2C\%}{98}$ thì CuO phản ứng hết, \ce{H2SO4} dư, suy ra $n_{\rm CuO} = n_{\ce{H2SO4}\tiny\mbox{pư}} = n_{\ce{CuSO4}} = \frac{m_1}{80}$ mol, $m_{\ce{H2SO4}\tiny\mbox{dư}} = m_{\ce{H2SO4}} - m_{\ce{H2SO4}\tiny\mbox{pư}} = m_2C\% - 98\frac{m_1}{80}$. Dung dịch sau phản ứng có 2 chất tan: \ce{CuSO4} \& \ce{H2SO4} còn dư.
		\begin{align*}
			...
			C\%_{\ce{H2SO4}} &= \frac{m_{\ce{H2SO4}\tiny\mbox{dư}}}{m_{\rm dd}}\cdot100\% = \frac{100\left(m_2C\% - \frac{98m_1}{80}\right)}{m_1 + m_2}\% = \frac{100m_2C\% - 122.5m_1}{m_1 + m_2}\%.
		\end{align*}
		\item[(b)] Nếu $n_{\rm CuO} = n_{\ce{H2SO4}}$, i.e., nếu $m_1,m_2,C\%$ thỏa $\frac{m_1}{80} = \frac{m_2C\%}{98}$ thì cả CuO \& \ce{H2SO4} đều phản ứng hết. Dung dịch sau phản ứng có duy nhất 1 chất tan \ce{CuSO4} \& $n_{\ce{CuSO4}} = n_{\rm CuO} = n_{\ce{H2SO4}} = \frac{m_1}{80}$:
		\begin{align*}
			C\%_{\ce{CuSO4}} &= \frac{m_{\ce{CuSO4}}}{m_{\rm dd}}\cdot100\% = \frac{n_{\ce{CuSO4}}M_{\ce{CuSO4}}}{m_{\rm dd}}\cdot100\% = \frac{\frac{m_1}{80}\cdot160}{m_1 + m_2}\cdot100\% = \frac{200m_1}{m_1 + m_2}\%.
		\end{align*}
		\item[(c)] Nếu $n_{\rm CuO} > n_{\ce{H2SO4}}$, i.e., $\frac{m_1}{80} > \frac{m_2C\%}{98}$ thì \ce{H2SO4} phản ứng hết, CuO dư, suy ra $n_{\rm CuO\tiny\mbox{pư}} = n_{\ce{H2SO4}} = n_{\ce{CuSO4}} = \frac{m_2C\%}{98}$. Dung dịch sau phản ứng chỉ có duy nhất 1 chất tan \ce{CuSO4} \&
		\begin{align*}
			C\%_{\ce{CuSO4}} &= \frac{m_{\ce{CuSO4}}}{m_{\rm dd}}\cdot100\% = \frac{n_{\ce{CuSO4}}M_{\ce{CuSO4}}}{m_{\rm dd}}\cdot100\% = \frac{160\cdot\frac{m_2C\%}{98}}{\frac{m_2C\%}{98}\cdot80 + m_2} = \frac{80C\%}{40C\% + 49},
		\end{align*}
...
\begin{proof}[Giải]
	...
	\begin{equation*}
		...
		\end{split}\right.
	\end{equation*}
	$n_{\rm CuO} = \frac{3m}{80} - C_{\rm M}V$ mol $\Rightarrow m_{\rm CuO} = n_{\rm CuO}M_{\rm CuO} = 80\left(\frac{3m}{80} - C_{\rm M}V\right) = 3m - 80C_{\rm M}V$ g, $n_{\ce{Fe2O3}} = \frac{C_{\rm M}V}{2} - \frac{m}{80}$ mol $\Rightarrow m_{\ce{Fe2O3}} = n_{\ce{Fe2O3}}M_{\ce{Fe2O3}} = 160\left(\frac{C_{\rm M}V}{2} - \frac{m}{80}\right) = 80C_{\rm M}V - 2m$ g (hoặc $m_{\ce{Fe2O3}} = m_{\rm hh} - m_{\rm CuO} = m - (3m - 80C_{\rm M}V) = 80C_{\rm M}V - 2m$ g).
\end{proof}
