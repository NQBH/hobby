...
\begin{proof}[Chứng minh \eqref{ctc}]
	\begin{enumerate}
		...
		\item[(d)] Thay $\beta$ trong công thức vừa thu được ở (c) bởi $-\beta$.
	\end{enumerate}
...
\begin{proof}[Chứng minh \eqref{ctc 1}]
