...
\begin{enumerate}
	...
	\item \textit{Tìm số đo góc}. Khi biết sin, côsin hay tang của góc $\alpha$ cần tìm bằng $m$, ta lần lượt ấn phím \fbox{SHIFT}, \& 1 trong các phím $\boxed{\sin^{-1}},\boxed{\cos^{-1}},\boxed{\tan^{-1}}$
\end{enumerate}
