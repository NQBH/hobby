...
\end{tiende}
Như vậy với 2 điểm phân $A,B$ tồn tại duy nhất 1 đường thằng chứa cả 2 điểm này \& đường thẳng đó thường được gọi là \textit{đường thẳng $AB$}.
...
Vậy \textit{với 2 đường thẳng phân biệt trong không gian thì: 2 đường thẳng đó hoặc đồng dạng hoặc chéo nhau. Trong trường hợp đồng phẳng, chúng hoặc cắt nhau tại 1 điểm hoặc song song với nhau}.'' -- \cite[pp. 47--48]{TL_chuyen_Toan_Hinh_Hoc_11}
