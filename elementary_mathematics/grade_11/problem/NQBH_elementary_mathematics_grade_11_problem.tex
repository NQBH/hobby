...
\begin{baitoan}[\cite{TL_chuyen_Toan_Dai_So_Giai_Tich_11}, \textbf{15.}, p. 94]
	Tìm số hạng không chứa $x$ (số hạng tự do) trong khai triển của $\left(x\sqrt{x} + \frac{1}{x^4}\right)^n$ nếu biết rằng $C_n^2 - C_n^1 = 44$.
\end{baitoan}
...
\begin{baitoan}[\cite{TL_chuyen_Toan_Dai_So_Giai_Tich_11}, \textbf{18.}, p. 94]
	Tìm hệ số của số hạng chứa $x^8$ trong khai triển nhị thức Newton của $\left(\frac{1}{x^3} + \sqrt{x^5}\right)^n$ biết rằng $C_{n+4}^{n+1} - C_{n+3}^n = 7(n + 3)$.
\end{baitoan}
