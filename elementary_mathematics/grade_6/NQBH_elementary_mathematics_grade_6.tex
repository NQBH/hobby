...
``\ldots được tiến thêm 1 bước trên con đường khám phá thế giới bí ẩn \textit{\&} đẹp đẽ của Toán học, đặc biệt là được ``làm giàu'' về vốn văn hóa chung \textit{\&} có cơ hội ``Mang cuộc sống vào bài học -- Đưa bài học vào cuộc sống''. [\ldots] sẽ ngày càng tiến bộ \textit{\&} cảm thấy vui sướng khi nhận ra ý nghĩa: Học Toán rất có ích cho cuộc sống hằng ngày.'' -- \cite[p. 1]{SGK_Toan_6_Canh_Dieu_tap_1}
