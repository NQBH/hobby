...
\end{dinhnghia}
Phân số $\frac{a}{b}$ đọc là: $a$ phần $b$, $a$ là \textit{tử số} (còn gọi tắt là \textit{tử}, $b$ là \textit{mẫu số} (còn gọi tắt là \textit{mẫu}).'' -- \cite[p. 25]{SGK_Toan_6_Canh_Dieu_tap_2}

``Mọi số nguyên $a\in\mathbb{Z}$ có thể viết ở dạng phân số là $\frac{a}{1}$.'' -- \cite[p. 26]{SGK_Toan_6_Canh_Dieu_tap_2}
...
\begin{baitoan}[\cite{Binh_Toan_6_tap_2}, \textbf{23.}, p. 11]
