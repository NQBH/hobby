...
\section{Set $\mathbb{Z}$ of Integers}

%------------------------------------------------------------------------------%

\section{Set $\mathbb{Q}$ of Rationals}

%------------------------------------------------------------------------------%

\section{Set $\mathbb{R}$ of Reals}

%------------------------------------------------------------------------------%

\section{Set $\mathbb{C}$ of Complex Numbers}

%------------------------------------------------------------------------------%

Resources: \cite{SGK_Toan_6_Canh_Dieu_tap_1, SGK_Toan_6_CTST_tap_1, SBT_Toan_6_Canh_Dieu_tap_1}
