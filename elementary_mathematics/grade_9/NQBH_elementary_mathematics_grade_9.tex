...
\begin{theorem}
	\label{hang dang thuc: sqrt vs abs}
...
\begin{remark}[Kỹ thuật chia để trị]
	Khi muốn chứng minh 1 mệnh đề $P(n)$ với $n\in A$, ta có thể chia tập $A$ thành các tập con nhỏ hơn, i.e., $A = A_1\cup\cdots\cup A_n = \bigcup_{i=1}^n A_i$ rồi chứng minh $P(n)$ lần lượt trên các tập con đó. Kỹ thuật này được gọi là \emph{kỹ thuật chia để trị}.
\end{remark}
Khi rút gọn 1 biểu thức, nên làm mất dấu căn thức rồi dấu trị tuyệt đối. Để làm mất dấu căn thức, sử dụng Định lý \ref{hang dang thuc: sqrt vs abs}. Để làm mất dấu giá trị tuyệt đối (absolute value), xét tính âm dương của biểu thức.
