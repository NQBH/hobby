...
\title{Problem: Square-, Cube-, \textit{\&} $n$th Roots\\Bài Tập: Căn Bậc 2, Căn Bậc 3, \textit{\&} Căn Bậc $n$}
...
\begin{abstract}
	...
	\begin{itemize}
		...
		\item Solution: 
	\end{itemize} which is a supplementary material to my lecture note: 
	
	\textsf{\textbf{Keyword.} Square root, cube root, $n$th root.}
	\vspace{2mm}
	
	\textsf{[vi]} Tài liệu này là 1 bộ sưu tập các bài toán, từ cơ bản đến nâng cao, về \textit{căn bậc 2, căn bậc 3, \& căn bậc $n$}, cũng là phần bổ sung cho bài giảng: \href{https://github.com/NQBH/hobby/blob/master/elementary_mathematics/grade_9/square_root_cube_root/NQBH_square_root_cube_root.pdf}{GitHub\texttt{/}NQBH\texttt{/}hobby\texttt{/}elementary mathematics\texttt{/}grade 9\texttt{/}square- \& cube roots}.
...
\begin{baitoan}
	Cho $a,b,c\in\mathbb{Q}$, $abc\ne0$ \& $a + b + c = 0$. Chứng minh $\sqrt{\dfrac{1}{a^2} + \dfrac{1}{b^2} + \dfrac{1}{c^2}}\in\mathbb{Q}$.
\end{baitoan}
