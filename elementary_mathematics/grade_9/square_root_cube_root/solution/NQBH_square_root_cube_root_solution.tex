...
\begin{proof}[1st giải]
	(a) $\sqrt{-2x + 3}$ xác định $\Leftrightarrow-2x + 3\ge0\Leftrightarrow-2x\ge-3\Leftrightarrow x\le\frac{3}{2} = 1.5$. (b) $\sqrt{\frac{2}{x^2}}$ xác định $\Leftrightarrow\frac{2}{x^2}\ge0$. Vì  $x^2\ge0$, $\forall x\in\mathbb{R}$ nên $\frac{2}{x^2}\ge0\Leftrightarrow x\ne0$ (để cho $\frac{2}{x^2}$ có nghĩa). (c) $\sqrt{\frac{4}{x + 3}}$ xác định $\Leftrightarrow\frac{4}{x + 3}\ge0$. Vì $4 > 0$ nên $\frac{4}{x + 3}\ge0\Leftrightarrow x + 3 > 0\Leftrightarrow x > -3$. (d) Vì $x^2\ge0$, $\forall x\in\mathbb{R}$ nên $x^2 + 6 > 0$. Suy ra $\frac{-5}{x^2 + 6} < 0$, $\forall x\in\mathbb{R}$. Vậy không tồn tại $x\in\mathbb{R}$ để $\sqrt{\frac{-5}{x^2 + 6}}$ có nghĩa.
\end{proof}

\begin{proof}[2nd giải]
	(a) $\sqrt{-2x + 3}$ xác định $\Leftrightarrow-2x + 3\ge0\Leftrightarrow2x\le3\Leftrightarrow x\le\frac{3}{2} = 1.5$. (b) $\sqrt{\frac{2}{x^2}}$ xác định $\Leftrightarrow\frac{2}{x^2} > 0\Leftrightarrow x^2 > 0\Leftrightarrow x\ne0$. (c) $\sqrt{\frac{4}{x + 3}}$ xác định $\Leftrightarrow\frac{4}{x + 3} > 0\Leftrightarrow x + 3 > 0\Leftrightarrow x > -3$. (d) $\sqrt{\frac{-5}{x^2 + 6}}$ xác định $\Leftrightarrow \frac{-5}{x^2 + 6} > 0\Leftrightarrow x^2 + 6 < 0$ vô lý vì $x^2 + 6\ge0 + 6 = 6 > 0$, $\forall x\in\mathbb{R}$. Vậy $\sqrt{\frac{-5}{x^2 + 6}}$ luôn không có nghĩa\texttt{/}xác định.
\end{proof}
...
\begin{proof}[1st giải]
	(a) $5\sqrt{(-2)^4} = 5\sqrt{((-2)^2)^2} = 5|(-2)^2| = 5|4| = 5\cdot4 = 20$. (b) $-4\sqrt{(-3)^6} = -4\sqrt{((-3)^3)^2} = -4|(-3)^3| = -4|-27| = -4\cdot27 = -108$. (c) $\sqrt{\sqrt{(-5)^8}} = \sqrt{\sqrt{((-5)^4})^2} = \sqrt{|(-5)^4|} = \sqrt{((-5)^2)^2} = |(-5)^2| = |25| = 25$. (d) $2\sqrt{(-5)^6} + 3\sqrt{(-2)^8} = 2\sqrt{((-5)^3)^2} + 3\sqrt{((-2)^4)^2} = 2|(-5)^3| + 3|(-2)^4| = 2|-125| + 3|16| = 2\cdot125 + 3\cdot16 = 250 + 48 = 298$.
\end{proof}

\begin{proof}[2nd giải]
	Sử dụng tính chất $a^{2n} = (-a)^{2n}$, $\forall a\in\mathbb{R}$, $n\in\mathbb{N}$, $a^2 + n^2\ne0$.\footnote{Điều kiện $a^2 + n^2\ne0$ nghĩa là $(a,n)\ne(0,0)$, i.e., $a$ \& $n$ không thể cùng bằng 0, nhưng có thể có nhiều nhất 1 trong 2 số bằng 0. Tổng quát hơn, điều kiện $\sum_{i=1}^n a_i^2\ne0\Leftrightarrow(a_1,a_2,\ldots,a_n)\ne(0,0,\ldots,0)$.} (a) $5\sqrt{(-2)^4} = 5\sqrt{2^4} = 5\sqrt{(2^2)^2} = 5|2^2| = 5|4|= 5\cdot4 = 20$. (b) $-4\sqrt{(-3)^6} = -4\sqrt{3^6} = -4\sqrt{(3^3)^2} = -4|3^3| = -4\cdot27 = -108$. (c) $\sqrt{\sqrt{(-5)^8}} = \sqrt{\sqrt{5^8}} = \sqrt{\sqrt{(5^4)^2}} = \sqrt{|5^4|} = \sqrt{5^4} = \sqrt{(5^2)^2} = |5^2| = |25| = 25$. (d) $2\sqrt{(-5)^6} + 3\sqrt{(-2)^8} = 2\sqrt{5^6} + 3\sqrt{2^8} = 2\sqrt{(5^3)^2} + 3\sqrt{(2^4)^2} = 2|5^3| + 3|2^4| = 2|125| + 3|16| = 2\cdot125 + 3\cdot16 = 250 + 48 = 298$.
\end{proof}
...
\begin{proof}[Giải]
	(a) $\sqrt{(4 + \sqrt{2})^2} = |4 + \sqrt{2}| = 4 + \sqrt{2}$ vì $4 + \sqrt{2} > 4 > 0$. (b) $\sqrt{(3 - \sqrt{3})^2} = |3 - \sqrt{3}| = 3 - \sqrt{3}$ vì $9 > 3\Leftrightarrow\sqrt{9} = 3 > \sqrt{3}$. (c) $\sqrt{(4 - \sqrt{17})^2} = |4 - \sqrt{17}| = \sqrt{17} - 4$ vì $16 < 17\Leftrightarrow\sqrt{16} = 4 < \sqrt{17}$. (d) $2\sqrt{3} + \sqrt{(2 - \sqrt{3})^2} = 2\sqrt{3} + |2 - \sqrt{3}| = 2\sqrt{3} + 2 - \sqrt{3} = 2 + \sqrt{3}$ vì $4 > 3\Leftrightarrow\sqrt{4} = 2 > \sqrt{3}$.
\end{proof}
...
\begin{proof}[1st giải (VT $\to$ VP)]
	(a) $9 + 4\sqrt{5} = 5 + 2\cdot2\sqrt{5} + (\sqrt{5})^2 = (\sqrt{5} + 2)^2$. (b) $\sqrt{9 - 4\sqrt{5}} - \sqrt{5} = \sqrt{(\sqrt{5})^2 - 2\sqrt{5}\cdot2 + 2^2} - \sqrt{5} = \sqrt{(\sqrt{5} - 2)^2} - \sqrt{5} = |\sqrt{5} - 2| - \sqrt{5} = \sqrt{5} - 2 - \sqrt{5} = -2$ vì $5 > 4\Leftrightarrow\sqrt{5} > \sqrt{4} = 2$. (c) $(4 - \sqrt{7})^2  = 4^2 - 2\cdot4\cdot\sqrt{7} + (\sqrt{7})^2 = 16 - 8\sqrt{7} + 7 = 23 - 8\sqrt{7}$. (d) $\sqrt{23 + 8\sqrt{7}} - \sqrt{7} = \sqrt{4^2 + 2\cdot4\sqrt{7} + (\sqrt{7})^2} - \sqrt{7} = \sqrt{(4 + \sqrt{7})^2}  - \sqrt{7} = |4 + \sqrt{7}| - \sqrt{7} = 4 + \sqrt{7} - \sqrt{7} = 4$.
\end{proof}

\begin{proof}[2nd giải (VP $\to$ VT)]
	(a) $(\sqrt{5} + 2)^2 = (\sqrt{5})^2 + 2\sqrt{5}\cdot2 + 2^2 = 5 + 4\sqrt{5} + 4 = 9 + 4\sqrt{5}$. (b) $(\sqrt{5} - 2)^2 = (\sqrt{5})^2 - 2\sqrt{5}\cdot2 + 2^2 = 5 - 4\sqrt{5} + 4 = 9 - 4\sqrt{5}\Leftrightarrow|\sqrt{5} - 2| = \sqrt{9 - 4\sqrt{5}}\Leftrightarrow\sqrt{5} - 2 = \sqrt{9 - 4\sqrt{5}}\Leftrightarrow\sqrt{9 - 4\sqrt{5}} - \sqrt{5} = -2$ vì $5 > 4\Leftrightarrow\sqrt{5} > \sqrt{4} = 2$. (c) $23 - 8\sqrt{7} = 4^2 - 2\cdot4\sqrt{7} + (\sqrt{7})^2 = (4 - \sqrt{7})^2$. (d) $(4 + \sqrt{7})^2 = 4^2 + 2\cdot4\sqrt{7} + (\sqrt{7})^2 = 16 + 8\sqrt{7} + 7 = 23 + 8\sqrt{7}\Leftrightarrow|4 + \sqrt{7}| = \sqrt{23 + 8\sqrt{7}}\Leftrightarrow4 + \sqrt{7} = \sqrt{23 + 8\sqrt{7}}\Leftrightarrow\sqrt{23 + 8\sqrt{7}} - \sqrt{7} = 4$.
\end{proof}

\begin{baitoan}[\cite{SBT_Toan_9_tap_1}, 16., p. 7]
	Biểu thức sau đây xác định với giá trị nào của $x$? (a) $\sqrt{(x - 1)(x - 3)}$. (b) $\sqrt{x^2 - 4}$. (c) $\sqrt{\dfrac{x - 2}{x + 3}}$. (d) $\sqrt{\dfrac{2 + x}{5 - x}}$.
\end{baitoan}
...
\begin{proof}[Giải]
	(a) $x^2 - 7 = x^2 - (\sqrt{7})^2 = (x - \sqrt{7})(x + \sqrt{7})$. (b) $x^2  - 2\sqrt{2}x + 2 = (x - \sqrt{2})^2$. (c) $x^2 + 2\sqrt{13}x + 13 = (x + \sqrt{13})^2$.
\end{proof}
...
\begin{proof}[Giải]
	(a) ĐKXĐ: $x\ne-\sqrt{5}$, $\dfrac{x^2 - 5}{x + \sqrt{5}} = \dfrac{(x - \sqrt{5})(x + \sqrt{5})}{x + \sqrt{5}} = x - \sqrt{5}$. (b) ĐKXĐ: $x^2\ne2\Leftrightarrow x\ne\pm\sqrt{2}$, $\dfrac{x^2 + 2\sqrt{2}x + 2}{x^2 - 2} = \dfrac{(x + \sqrt{2})^2}{(x - \sqrt{2})(x + \sqrt{2})} = \dfrac{x + \sqrt{2}}{x - \sqrt{2}}$.
\end{proof}
...
\begin{proof}[Giải]
	(a) $\sqrt{(n + 1)^2} + \sqrt{n^2} = |n + 1| + |n| = n + 1 + n = 2n + 1$ ($\star$) vì $n\in\mathbb{N}\Rightarrow n + 1 > n\ge0$. Mặt khác, $(n + 1)^2 - n^2 = n^2 + 2n + 1 - n^2 = 2n + 1$ ($\star\star$). Từ ($\star$) \& ($\star\star$), suy ra $\sqrt{(n + 1)^2} + \sqrt{n^2} = (n + 1)^2 - n^2$, $\forall n\in\mathbb{N}$. Với $n = 1,2,\ldots,10$:
	\begin{align*}
		\sqrt{2^2} + \sqrt{1^2} &= 2^2 - 1^2,\ \sqrt{3^2} + \sqrt{2^2} = 3^2 - 2^2,\ \sqrt{4^2} + \sqrt{3^2} = 4^2 - 3^2,\ \sqrt{5^2} + \sqrt{4^2} = 5^2 - 4^2,\ \sqrt{6^2} + \sqrt{5^2} = 6^2 - 5^2,\\
		\sqrt{7^2} + \sqrt{6^2} &= 7^2 - 6^2,\ \sqrt{8^2} + \sqrt{7^2} = 8^2 - 7^2,\ \sqrt{9^2} + \sqrt{8^2} = 9^2 - 8^2,\ \sqrt{10^2} + \sqrt{9^2} = 10^2 - 9^2,\ \sqrt{11^2} + \sqrt{10^2} = 11^2 - 10^2.
	\end{align*}
	(b) Có:
	\begin{equation*}
		\sqrt{(x + 1)^2} + \sqrt{x^2} = |x + 1| + |x| = \left\{\begin{split}
			&2x + 1,&&\mbox{nếu } x\ge0,\\
			&1,&&\mbox{nếu } -1\le x < 0,\\
			-&2x - 1,&&\mbox{nếu } x < -1.
	...
	\end{equation*}
	\begin{equation*}
		|(x + 1)^2 - x^2| = |x^2 + 2x + 1 - x^2| = |2x + 1| = \left\{\begin{split}
			&2x + 1,&&\mbox{nếu } x\ge-\frac{1}{2},\\
			-&2x - 1,&&\mbox{nếu } x < -\frac{1}{2}.
		\end{split}\right.\ \forall x\in\mathbb{R}.
	\end{equation*}
	Suy ra $\sqrt{(x + 1)^2} + \sqrt{x^2} = |(x + 1)^2 - x^2|\Leftrightarrow x\ge0$ or $x\le-1\Leftrightarrow x\in\mathbb{R}\backslash(-1,0) = (-\infty,-1]\cup[0,\infty)$.
\end{proof}

\begin{luuy}
	Để tính $(x + 1)^2 - x^2$, ta cũng có thể áp dụng hằng đẳng thức $A^2 - B^2 = (A - B)(A + B)$, thay vì áp dụng hằng đẳng thức $(A + B)^2 = A^2 + 2AB + B^2$ như trên, như sau: $(x + 1)^2 - x^2 = (x + 1 - x)(x + 1 + x) = 1\cdot(2x + 1) = 2x + 1$, $\forall x\in\mathbb{R}$.
\end{luuy}
...
\begin{proof}[Giải]
	(a) ĐKXĐ: $\forall x\in\mathbb{R}$. $\sqrt{(x - 3)^2} = 9\Leftrightarrow|x - 3| = 9\Leftrightarrow x - 3 = \pm9\Leftrightarrow x = 12$ or $x = -6$. Vậy $S = \{-6,12\}$. (b) ĐKXĐ: $\forall x\in\mathbb{R}$. $\sqrt{4x^2 + 4x + 1} = 6\Leftrightarrow\sqrt{(2x + 1)^2} = 6\Leftrightarrow|2x + 1| = 6\Leftrightarrow 2x + 1 = \pm6\Leftrightarrow x = \frac{5}{2}$ or $x = -\frac{7}{2}$. Vậy $S = \left\{-\frac{7}{2},\frac{5}{2}\right\}$.
\end{proof}
...
\begin{proof}[Giải]
	ĐKXĐ: $\forall x\in\mathbb{R}$. Xét các trường hợp tương ứng với giá trị của $c$:
	\begin{itemize}
...
\begin{proof}[Giải]
	(a) $\sqrt{\dfrac{9}{169}} = \dfrac{\sqrt{9}}{\sqrt{169}} = \dfrac{3}{13}$. (b) $\sqrt{\dfrac{25}{144}} = \dfrac{\sqrt{25}}{\sqrt{144}} = \dfrac{5}{12}$. (c) $\sqrt{1\dfrac{9}{16}} = \sqrt{\dfrac{1\cdot16 + 9}{16}} = \sqrt{\dfrac{25}{16}} = \dfrac{\sqrt{25}}{\sqrt{16}} = \dfrac{5}{4}$. (d) $\sqrt{2\dfrac{7}{81}} = \sqrt{\dfrac{2\cdot81 + 7}{81}} = \sqrt{\dfrac{169}{81}} = \dfrac{\sqrt{169}}{\sqrt{81}} = \dfrac{13}{9}$.
\end{proof}
...
\begin{proof}[Giải]
	(a) $\dfrac{\sqrt{2300}}{\sqrt{23}} = \sqrt{\dfrac{2300}{23}} = \sqrt{100} = 10$. (b) $\dfrac{\sqrt{12.5}}{\sqrt{0.5}} = \sqrt{\dfrac{12.5}{0.5}} = \sqrt{25} = 5$. (c) $\dfrac{\sqrt{192}}{\sqrt{12}} = \sqrt{\dfrac{192}{12}} = \sqrt{16} = 4$. (d) \textit{Cách 1}: $\dfrac{\sqrt{6}}{\sqrt{150}} = \sqrt{\dfrac{6}{150}} = \sqrt{\dfrac{1}{25}} = \dfrac{\sqrt{1}}{\sqrt{25}} = \dfrac{1}{5} = 0.2$. \textit{Cách 2}: $\dfrac{\sqrt{6}}{\sqrt{150}} = \sqrt{\dfrac{6}{150}} = \sqrt{\dfrac{1}{25}} = \sqrt{0.04} = 0.2$.
\end{proof}
...
\begin{proof}[Giải]
	(a) $A$ có nghĩa $\Leftrightarrow\frac{2x + 3}{x - 3}\ge0\Leftrightarrow(x\ne3)\land((2x + 3\ge0\land x - 3 > 0)\lor(2x + 3\le0\land x - 3 < 0))$.
\end{proof}
