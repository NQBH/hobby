...
\begin{baitoan}[\cite{SGK_Toan_9_tap_1}, 12., p. 11]
	Tìm $x$ để mỗi căn thức sau có nghĩa: (a) $\sqrt{2x + 7}$. (b) $\sqrt{-3x + 4}$. (c) $\sqrt{\frac{1}{-1 + x}}$. (d) $\sqrt{1 + x^2}$.
\end{baitoan}
...
\begin{baitoan}[\cite{SBT_Toan_9_tap_1}, 12., p. 7]
	 Tìm $x\in\mathbb{R}$ để căn thức sau có nghĩa: (a) $\sqrt{-2x + 3}$. (b) $\sqrt{\frac{2}{x^2}}$. (c) $\sqrt{\frac{4}{x + 3}}$. (d) $\sqrt{\frac{-5}{x^2 + 6}}$.
\end{baitoan}
...
\begin{baitoan}[\cite{SBT_Toan_9_tap_1}, 19., p. 8]
	Tìm ĐKXĐ rồi rút gọn các phân thức: (a) $\frac{x^2 - 5}{x + \sqrt{5}}$. (b) $\frac{x^2 + 2\sqrt{2}x + 2}{x^2 - 2}$.
\end{baitoan}
...
\begin{baitoan}[\cite{SBT_Toan_9_tap_1}, 22., p. 8]
	Chứng minhh: $\sqrt{(n + 1)^2} + \sqrt{n^2} = (n + 1)^2 - n^2$, $\forall n\in\mathbb{N}$. Viết đẳng thức trên với $n = 1,2,\ldots,10$.
\end{baitoan}
