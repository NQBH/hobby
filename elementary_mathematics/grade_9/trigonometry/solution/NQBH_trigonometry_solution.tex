...
\title{Problem {\it\&} Solution: Trigonometry -- Bài Tập  {\it\&} Lời Giải Lượng Giác}
...
\begin{proof}[Giải]
	Từ định lý \ref{thm: 1/h^2 = 1/b^2 + 1/c^2}: $b^2 = ab'$, $c^2 = ac'$, suy ra $b' = \frac{b^2}{a}$, $c' = \frac{c^2}{a}$.
\end{proof}
...
\begin{proof}[Chứng minh]
	(a) Từ định lý \ref{thm: bc = ah}: $bc = ah\Rightarrow h = \frac{bc}{a}$. (b) Từ định lý \ref{thm: 1/h^2 = 1/b^2 + 1/c^2}: $b^2 = ab'$, $c^2 = ac'$, suy ra $\frac{b^2}{c^2} = \frac{ab'}{ac'} = \frac{b'}{c'}$.
\end{proof}
...
\end{baitoan}
Để chứng minh $HA,HB,HC,HD$ tỷ lệ với 1, 2, 4, 8, ta cần tính độ dài của 4 đoạn thẳng đó. Để tính chúng, có nhiều cách. Sau đây là 2 luồng tính: {\bf1.} $HB$ (Pythagore) $\to$ $HC$ (ĐL \ref{thm: h^2 = b'c'}) $\to$ $HD$ (ĐL \ref{thm: h^2 = b'c'}. {\bf2.} $AC$ (ĐL \ref{thm: b^2 = ab' c^2 = ac'}) $\to$ $HC$ $\to$ $HB$ (ĐL \ref{thm: h^2 = b'c'}) $\to$ $HD$ (ĐL \ref{thm: h^2 = b'c'}).

\begin{proof}[1st chứng minh]
	(a) Áp dụng định lý Pythagore cho $\Delta ABH$: $BH = \sqrt{AB^2 - AH^2} = \sqrt{(3\sqrt{5})^2 - 3^2} = 6$ cm. Áp dụng định lý \ref{thm: h^2 = b'c'} vào $\Delta ABC$ vuông \& $\Delta BCD$ vuông: $HB^2 = HA\cdot HC\Rightarrow HC = \dfrac{HB^2}{HC} = \dfrac{6^2}{3} = 12$ cm, \& $HC^2 = HB\cdot HD\Rightarrow HD = \dfrac{HC^2}{HB} = \dfrac{12^2}{6} = 24$ cm. Suy ra $HA:HB:HC:HD = 3:6:12:24 = 1:2:4:8$. (b) Ta tính biểu thức $\dfrac{1}{AB^2} + \dfrac{1}{BC^2} + \dfrac{1}{CD^2}$ theo 2 cách: Áp dụng định lý \ref{thm: 1/h^2 = 1/b^2 + 1/c^2} cho $\Delta ABC$ vuông \& $\Delta BCD$ vuông: $\dfrac{1}{HB^2} = \dfrac{1}{AB^2} + \dfrac{1}{BC^2}$ \& $\dfrac{1}{HC^2} = \dfrac{1}{BC^2} + \dfrac{1}{CD^2}$. Suy ra $\dfrac{1}{AB^2} + \dfrac{1}{BC^2} + \dfrac{1}{CD^2} = \dfrac{1}{HB^2} + \dfrac{1}{CD^2} = \dfrac{1}{AB^2} + \dfrac{1}{HC^2}$ $\Rightarrow\dfrac{1}{HB^2} - \dfrac{1}{HC^2} = \dfrac{1}{AB^2} - \dfrac{1}{CD^2}$.
\end{proof}

\begin{proof}[2nd chứng minh]
	(a) Áp dụng định lý \ref{thm: b^2 = ab' c^2 = ac'} vào $\Delta ABC$: $AB^2 = AH\cdot AC\Rightarrow AC = \dfrac{AB^2}{AH} = \dfrac{(3\sqrt{5})^2}{3} = 15$ cm $\Rightarrow HC = AC - AH = 15 - 3 = 12$ cm. Áp dụng định lý \ref{thm: h^2 = b'c'} 
	cho $\Delta ABC$ vuông \& $\Delta BCD$ vuông: $BH^2 = HA\cdot HC\Rightarrow BH = \sqrt{HA\cdot HC} = \sqrt{3\cdot12} = 6$ cm \& $HC^2 = HB\cdot HD\Rightarrow HD = \dfrac{HC^2}{HB} = \dfrac{12^2}{6} = 24$ cm. Suy ra $HA:HB:HC:HD = 3:6:12:24 = 1:2:4:8$. (b) Áp dụng định lý \ref{thm: 1/h^2 = 1/b^2 + 1/c^2} cho $\Delta ABC$ vuông \& $\Delta BCD$ vuông: $\dfrac{1}{HB^2} = \dfrac{1}{AB^2} + \dfrac{1}{BC^2}$, $\dfrac{1}{HC^2} = \dfrac{1}{BC^2} + \dfrac{1}{CD^2}$. Trừ từng vế của 2 đẳng thức được: $\dfrac{1}{HB^2} - \dfrac{1}{HC^2} = \dfrac{1}{AB^2} - \dfrac{1}{CD^2}$.
\end{proof}

\begin{nhanxet}
	Nếu đẳng thức hình học cần chứng minh có xuất hiện các dấu hiệu như tổng{\tt/}hiệu  nghịch đảo bình phương (hoặc cả 2) của các đoạn thẳng thì nghĩ ngay đến việc áp dụng hệ thức $\frac{1}{h^2} = \frac{1}{b^2} + \frac{1}{c^2}$ cho (các) tam giác vuông thích hợp để suy ra đẳng thức hình học cần chứng minh.
\end{nhanxet}
...
\begin{proof}[Giải]
	Vẽ $BH\bot DE$, $H\in DE$, $BE\parallel AC$, $E\in CD$, mà $AC\bot BD$, nên $BD\bot BE$. Tứ giác $ABEC$ là hình bình hành vì có 2 cặp cạnh đối song song với nhau, suy ra $BE = AC = 16$. Áp dụng định lý \ref{thm: 1/h^2 = 1/b^2 + 1/c^2} cho $\Delta BDE$ vuông tại $B$: $\dfrac{1}{BH^2} = \dfrac{1}{BD^2} + \dfrac{1}{BE^2}\Rightarrow BH = \sqrt{\dfrac{BD^2\cdot BE^2}{BD^2 + BE^2}} = \sqrt{\dfrac{12^2\cdot16^2}{12^2 + 16^2}} = \sqrt{\dfrac{12^2\cdot16^2}{20^2}} = \dfrac{12\cdot16}{20} = 9.6$ cm.
\end{proof}
...
\begin{proof}[Giải]
	Áp dụng định lý \ref{thm: b^2 = ab' c^2 = ac'} cho $\Delta ABC$: 	$\frac{b^2}{c^2} = \frac{ab'}{ac'} = \frac{b'}{c'} = \frac{CH}{BH} = \frac{112}{63} = \frac{16}{9}\Rightarrow\frac{b}{c} = \sqrt{\frac{16}{9}} = \frac{4}{3}$. Áp dụng tính chất đường phân giác: $\frac{DB}{DC} = \frac{AB}{AC} = \frac{c}{b} = \frac{3}{4}\Rightarrow\frac{DC}{4} = \frac{DB}{4} = \frac{DB + DC}{4 + 3} = \frac{BC}{7} = \frac{b' + c'}{7} = \frac{112 + 63}{7} = \frac{175}{7} = 25\Rightarrow DB = 25\cdot3 = 75\Rightarrow DH = DB - HB = 75 - 63 = 12$ cm (hoặc $DC = 25\cdot4 = 100\Rightarrow DH = HC - DC = 112 - 100 = 12$ cm).
\end{proof}
