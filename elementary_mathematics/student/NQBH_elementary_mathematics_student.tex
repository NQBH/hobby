...
\subsection{Grade 6}
Jul 25, 27, 29; Aug 1, 3, 5, 8, 10, 12, 15, 17, 19, 22, 24, 26, 29, \st{31}, Sep \st{2}, 6, 8, 13, 15, 2022.
\begin{enumerate}
...
\subsection{Grade 7}
\begin{enumerate}
	\item \textsc{Đỗ Thị Thùy Dương.} \texttt{[In]} Aug 13, 16, \st{18}, 20, 23, 25, 27, 30; Sep 1, 3, 18, 2022.
	\item \textsc{Lê Tiến Đạt.} \texttt{[In]} Sep 18, 2022.
	\item \textsc{Trần Ngọc Thúy Quyên.} \texttt{[In]} Sep 18, 2022.
	\item \textsc{Đàm Trung Tín.} \texttt{[In]} Aug 2, 4, 6, 9, 11, 13, 16, \st{18}, 20, 23, 25, 27, 30; Sep 1, 3, 18, 2022.
\end{enumerate}
...
\subsection{Grade 10}
\begin{enumerate}
	\item \textsc{Đàm Thị Quỳnh Như.} \texttt{[In]} Aug 9, 12, 14, 16, \st{19}, 21, 23, 26, \st{28}, 30; Sep \st{2}, \st{4}, \st{6}, \st{9}, 11, 14, 16, 2022.

\end{enumerate}

\subsection{Grade 11}
\begin{enumerate}
	\item \textsc{Nguyễn Thị Ngọc Nhi.} \texttt{[In]} Aug 4, 6, 9, 11, 13, 16, 18, 20, 23, \st{25}, 27, \st{30}; Sep \st{1}, \st{3}, 8, \st{10}, 15, 17, 2022.
\end{enumerate}
