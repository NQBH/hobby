...
\subsection{Grade 10}
\begin{enumerate}
	\item \textsc{Đàm Thị Quỳnh Như.} \texttt{[In]} Aug 9, 12, 14, 16, \st{19}, 21, 23, 26, \st{28}, 30; Sep \st{2}, \st{4}, \st{6}, \st{9}, 11, 14, 2022.

\end{enumerate}

\subsection{Grade 11}
\begin{enumerate}
	\item \textsc{Nguyễn Thị Ngọc Nhi.} \texttt{[In]} Aug 4, 6, 9, 11, 13, 16, 18, 20, 23, \st{25}, 27, \st{30}; Sep \st{1}, 3, 2022.
\end{enumerate}
...
\subsection{Grade 10}
\begin{enumerate}
	\item \textsc{Ngô Thị Huỳnh Như.} \texttt{[In]} Sep 14, 2022.
	\item \textsc{Đàm Thị Quỳnh Như.} \texttt{[In]} Aug 9, 12, 14, 16, \st{19}, 21, 23, 26, \st{28}, 30; Sep \st{2}, \st{4}, \st{6}, \st{9}, 11, 14, 2022.
\end{enumerate}

\subsection{Grade 11}
\begin{enumerate}
	\item \textsc{Nguyễn Thị Ngọc Nhi.} \texttt{[In]} Aug 4, 6, 9, 11, 13, 16, 18, 20, 23, \st{25}, 27, \st{30}; Sep \st{1}, \st{3}, 8, 2022.
\end{enumerate}
