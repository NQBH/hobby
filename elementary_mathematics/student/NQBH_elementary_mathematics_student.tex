...
\subsection{Grade 6}
Jul 25, 27, 29; Aug 1, 3, 5, 8, 10, 12, 15, 17, 19, 22, 24, 26, 29; Sep 6, 8, 13, 15, 20, 22, 2022.
\begin{enumerate}
	...
	\begin{itemize}
		\item \textsf{Paid tutor fee.} Aug, 2022.
	\end{itemize}
	\item \textsc{Trương Khánh Quỳnh.} \texttt{[In]} Aug 3, 2022. \texttt{[Out]} Aug 3, 2022.
...
\subsection{Grade 7}
\begin{enumerate}
	\item \textsc{Đỗ Thị Thùy Dương.} \texttt{[In]} Aug 13, 16, 20, 23, 25, 27, 30; Sep 1, 3, 18, 19, 2022.
	\item \textsc{Lê Tiến Đạt.} \texttt{[In]} Sep 18, 19, 2022.
	\item \textsc{Trần Ngọc Thúy Quyên.} \texttt{[In]} Sep 18, 2022.
	\item \textsc{Đàm Trung Tín.} \texttt{[In]} Aug 2, 4, 6, 9, 11, 13, 16, 20, 23, 25, 27, 30; Sep 1, 3, 18, 19, 2022.
\end{enumerate}
...
\subsection{Grade 12}
\begin{enumerate}
	\item \textsc{Du Hoàng Tú.} \texttt{[In]} Sep 20, 21, m2022.
\end{enumerate}
