...
\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Có thể làm nhiễm điện nhiều vật bằng cách cọ xát. \fbox{\bf 2} Vật bị nhiễm điện (vật mang điện tích) có khả năng hút các vật khác.
	}%
}

%------------------------------------------------------------------------------%

\section{2 Loại Điện Tích}

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Có 2 loại điện tích là điện tích dương \& điện tích âm. Các vật nhiễm điện cùng loại thì đẩy nhau, khác loại thì hút nhau. \fbox{\bf 2} Nguyên tử gồm hạt nhân mang điện dương \& các electron mang điện âm chuyển động quanh hạt nhân. \fbox{\bf 3} 1 vật nhiễm điện âm nếu nhận thêm electron, nhiễm điện dương nếu mất bớt electron.
	}%
}

%------------------------------------------------------------------------------%

\section{Dòng Điện -- Nguồn Điện}

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Dòng điện là dòng các điện tích dịch chuyển có hướng. \fbox{\bf 2} Mỗi nguồn điện đều có 2 cực. Dòng điện chạy trong mạch điện kín bao gồm các thiết bị điện được nối liền với 2 cực của nguồn điện bằng dây điện.
	}%
}

%------------------------------------------------------------------------------%

\section{Chất Dẫn Điện \& Chất Cách Điện -- Dòng Điện Trong Kim Loại}

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} \textit{Chất dẫn điện} là chất cho dòng điện đi qua. \textit{Chất cách điện} là chất không cho dòng điện đi qua. \fbox{\bf 2} \textit{Dòng điện trong kim loại} là dòng các electron tự do dịch chuyển có hướng.
	}%
}

%------------------------------------------------------------------------------%

\section{Sơ Đồ Mạch Điện -- Chiều Dòng Điện}
\textit{Công dụng.} Sơ đồ mạch điện là căn cứ để các thợ điện căn cứ vào để có thể mắc các mạch điện đúng như yêu cầu cần có.

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Mạch điện được mô tả bằng sơ đồ \& từ sơ đồ mạch điện có thể lắp mạch điện tương ứng. \fbox{\bf 2} \textit{Chiều dòng điện} là chiều từ cực dương qua dây dẫn \& các thiết bị điện tới cực âm của nguồn điện.
	}%
}
...
\section{Tác Dụng Nhiệt \& Tác Dụng Phát Sáng của Dòng Điện}

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Dòng điện đi qua mọi vật dẫn thông thường, đều làm cho vật dẫn nóng lên. Nếu vật dẫn nóng lên tới nhiệt độ cao thì nó phát sáng. \fbox{\bf 2} Dòng điện có thể làm sáng bóng đèn bút thử điện \& đèn diode phát quang mặc dù các đèn này chưa nóng tới nhiệt độ cao.
	}%
}

%------------------------------------------------------------------------------%

\section{Tác Dụng Từ, Tác Dụng Hóa Học, \& Tác Dụng Sinh Lý của Dòng Điện}

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Dòng điện có tác dụng từ ví nó có thể làm quay kim nam châm. \fbox{\bf 2} Dòng điện có tác dụng hóa học, e.g., khi cho dòng điện đi qua dung dịch muối đồng thì nó tách đồng ra khỏi dung dịch, tạo thành lớp đồng bám trên thỏi than nối với cực âm. \fbox{\bf 3} Dòng điện có tác dụng sinh lý khi đi qua cơ thể người \& các động vật.
	}%
}

%------------------------------------------------------------------------------%

\section{Cường Độ Dòng Điện}

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Dòng điện càng mạnh thì cường độ dòng điện càng lớn. \fbox{\bf 2} Đo cường độ dòng điện bằng ampe kế. \fbox{\bf 3} Đơn vị đo cường độ dòng điện là ampe (A).
	}%
}
...
\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Nguồn điện tạo ra giữa 2 cực của nó 1 hiệu điện thế. \fbox{\bf 2} Đơn vị đo hiệu điện thế là vôn (V). Hiệu điện thế được đo bằng vôn kế. \fbox{\bf 3} Số vôn ghi trên mỗi nguồn điện là giá trị của hiệu điện thế giữa 2 cực của nó khi chưa mắc vào mạch.
	}%
}

%------------------------------------------------------------------------------%

\section{Hiệu Điện Thế Giữa 2 Đầu Dụng Cụ Dùng Điện}

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Trong mạch điện kín, hiệu điện thế giữa 2 đầu bóng đèn tạo ra dòng điện chạy qua bóng đèn đó. \fbox{\bf 2} Đối với 1 bóng đèn nhất định, hiệu điện thế giữa 2 đầu bóng đèn càng lớn thì dòng điện chạy qua bóng đèn có cường độ càng lớn. \fbox{\bf 3} Số vôn ghi trên mỗi dụng cụ điện cho biết hiệu điện thế định mức để dụng cụ đó hoạt động bình thường.
	}%
}

%------------------------------------------------------------------------------%

\section{An Toàn Khi Sử Dụng Điện}

\noindent\fbox{%
	\parbox{\textwidth}{%
		\noindent\textsf{\textbf{Kiến thức cốt lõi.}} \fbox{\bf 1} Cơ thể người là 1 vật dẫn điện. Dòng điện với cường độ $\ge70$ mA đi qua cơ thể người hoặc làm việc với hiệu điện thế 40 V trở lên là nguy hiểm với cơ thể người . \fbox{\bf 2} Cầu chì tự động ngắt mạch khi dòng điện có cường độ tăng quá mức, đặc biệt khi đoản mạch. \fbox{\bf 3} Phải thực hiện các quy tắc an toàn khi sử dụng điện.
	}%
}

%------------------------------------------------------------------------------%

\section{Sự Phụ Thuộc của Cường Độ Dòng Điện Vào Hiệu Điện Thế Giữa 2 Đầu Dây Dẫn}
Khi hiệu điện thế đặt vào 2 đầu bóng đèn càng lớn thì dòng điện chạy qua đèn có cường độ càng lớn \& đèn càng sáng.
...
Về lý thuyết dòng điện không đổi, xem, e.g., \cite[Chap. 1]{SGK_Vat_Ly_9}, \cite[Chủ đề I, pp. 5--8]{Hoe_Vat_Ly_9}.
