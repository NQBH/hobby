...
\begin{quotation}
	Psychotherapy remains the single most helpful technology for the treatment of minor depression \& anxiety $\ldots$ The belief -- espoused not infrequently by health-care cost-cutters in the ``managed care'' industry -- that medication can obviate psychotherapy conceals, I believe, a cynical willingness to let people sufer $\ldots$ [\&] serves as a pretext for denying patients psychotherapy.
\end{quotation}
