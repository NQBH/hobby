...
\end{itemize}
Normal breakups never happen like this, but psychopaths want to ensure that they seem innocent while you appear to be the monster. Even though they are the ones who are cheating \& lying, these steps turn the tables around so that they can play victim \& make sure that you are left with absolutely nothing.'' -- \cite[p. 71]{MacKenzie2015}
...
\& all the while, they made \textit{you} feel like the monster.'' -- \cite[p. 71]{MacKenzie2015}
