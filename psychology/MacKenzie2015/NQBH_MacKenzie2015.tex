...
\section{Resources}
``As you educate yourself, information flow is essential. This is the time to get overloaded with knowledge, books, \& videos. You'll find some that you like, \& others that you don't. The important thing is, find a lot of them. Later on, you'll probably feel comfortable settling down with a few favorite resources, but now is the opportunity to try them all.

Our goal at Psychopath Free is to help you heal in the best way possible. That could be through this book \& our site, or it could be through hundreds of other resources out there. This section is a rapid-fire way to get new survivors up to speed on how much information is available on the topic.

\subsection{Search Terms}
There are a lot of terms besides ``psychopath'' that might yield some very helpful resources. Here are some of the most common words that could help you in your research:
\begin{quote}
	Psychopath, Sociopath, Narcissist, Narcissistic Personality Disorder (NPD), Anti-Social Personality Disorder (ASPD), Borderline Personality Disorder (BPD), Emotional Abuse, Psychological Abuse, Psychological Maltreatment, Emotional Rape, Covert Abuse, Emotional Manipulator, Cluster B Personality Disorders, Psychopathology, Emotional Vampire
\end{quote}

\subsection{Websites}
We do not necessarily endorse any of these sites or blogs, but we believe all survivors should have access to every resource ut there. It is up to you to decide what helps or does not help your healing process.
\begin{itemize}
	\item \url{PsychopathFree.com} (articles \& recovery forums)
	\item \url{PsychopathAwareness.wordperss.com} (blog \& articles)
	\item \url{LoveFraud.com} (blog, articles, \& recovery forums)
	\item \url{DiscardedIndieMom.com} (blog, articles)
	\item \url{NarcissismFree.com} (articles)
	\item \url{SaferelationshipsMagazine.com} (articles)
	\item \url{AlexandraNouri.com} (articles)
	\item \url{DaughtersOfNarcissisticMothers.com} (articles)
	\item \url{TheAbilityToLove.wordpress.com} (articles)
\end{itemize}

\subsection{Facebook Groups}
Facebook groups \& pages are an amazing way to connect with other survivors \& validate your experience! Here are just a few, but you'll discover an entire community of them out there.
\begin{itemize}
	\item After Narcissistic Abuse -- There is Light, Life, \& Love.
	\item Narcissistic Abuse Recovery Central
	\item Respite from Sociopathic Behavior
	\item Psychopath Free
	\item The Empathy Trap Book
\end{itemize}

\subsection{Books}
There are many books written on the topic of psychopathy. Check out some of our favorites, along with the most popular ones out there. Remember that not every resource will be right for you.
\begin{itemize}
	\item \textit{Dangerous Liaisons} (Claudia Moscovici)
	\item \textit{The Seducer} (Claudia Moscovici)
	\item \textit{The Sociopath Next Door} (Martha Stout)
	\item \textit{In Sheep's Clothing} (George Simon)
	\item \textit{Women Who Love Psychopaths} (Sandra Brown)
	\item \textit{How to Spot a Dangerous Man} (Sandra Brown)
	\item \textit{Without Conscience} (Robert Hare)
	\item \textit{Discarded} (Indie Mom)
	\item \textit{The Survivor's Quest} (HealingJourney)
	\item \textit{The Empathy Trap} (Jane McGregor \& Tim McGregor)
	\item \textit{The Sociopath at the Breakfast Table} (Jane McGregor \& Tim McGregor)
	\item \textit{Out of the FOG} (Gary Walters)
	\item \textit{The Smart Girl's Guide to Self-Care} (Shahida Arabi)
	\item \textit{Why Does He Do That?: Inside the Minds of Angry \& Controlling Men} (Lundy Bancroft)
	\item \textit{Snakes in Suits} (Paul Babiak)
	\item \textit{Narcissistic Lovers} (Cynthia Zayn)
	\item \textit{The Wizard of Oz \& Other Narcissists} (Eleanor Payson)
	\item \textit{Help! I'm In Love with a Narcissist} (Steven Carter)
	\item \textit{What Makes Narcissists Tick} (Kathy Krajco)
	\item \textit{Malignant Self-Love} (Sam Vaknin)
	\item \textit{Love Fraud} (Donna Andersen)
\end{itemize}

\subsection*{Articles}
For an extended collection of links, articles, \& videos, please check out our master list -- \& feel free to contribute any that we missed: \url{Resources.PsychopathFree.com}.'' -- \cite[pp. 205--206]{MacKenzie2015}

\section{Appendix: Psychopath Test}
``Psychopaths display a particular set of patterns in their relationships. This 30-question test can help you (or a friend) determine if you might be dating a toxic person.

For each question, add the corresponding answer number to your total score. E.g., if you answer (1) to the 1st question \& (4) to the 2nd question, you have a total of 5 points so far. Then at the end, see which range your final score falls into. If you're bad at math like me, you can simply take the test online at \url{Test.PsychopathFree.com}, which will magically compute the results for you!

\noindent{\sf A. Does this person keep their promises?}
\begin{itemize}
	\item Yes, of course. Whenever my partner makes a promise, I can be confident that they will follow through on it.
	\item Sure, they usually keep their promises \& their behavior aligns pretty closely with their words.
	\item Sometimes. They're not very dependable, but they'll follow through on their words occasionally.
	\item No, their actions never seem to match up with their sweeping words. I've mostly learned not to point it out, otherwise I seem sensitive \& crazy.
\end{itemize}
{\sf B. Does your partner seem to understand your feelings?}
\begin{itemize}
	\item They're very empathetic \& compassionate! They always seem to understand where I'm coming from. If I ever bring up concerns, I know they'll listen \& understand.
	\item Not really, but it's always been this way. Even early on in the relationship, they were never especially caring. They can be pretty self-centered, but they're usually there for me if I really need help.
	\item They're empathetic enough, \& I don't need anything more.
	\item Not anymore. I find myself desperately trying to explain how they might feel if they were in my shoes, but that just seems to annoy them. Or they give me the silent treatment. It makes me feel crazy.
\end{itemize}
{\sf C. Can this person be hypocritical?}
\begin{itemize}
	\item They have never been hypocritical \& they do not judge me for my mistakes. They don't believe they're above the rules.
	\item If they are, I haven't noticed. We're all human after all.
	\item At times, but they're able to admit fault when it's pointed out.
	\item They seem to have extremely high expectations of me, but they behave as if those same standards don't apply to them.
\end{itemize}
{\sf D. Do they ever lie?}
\begin{itemize}
	\item No, they would never lie to me.
	\item No more so than any other person. White lies happen sometimes.
	\item They lie every once in a while, but it doesn't seem malicious or intentional. If caught, they seem embarrassed \& uncomfortable.
	\item Yes, \& nothing ever seems to be their fault. There's always an excuse for everything, even things that don't require excusing.
\end{itemize}
{\sf E. Does this person ever pull away or withhold affection?}
\begin{itemize}
	\item No, my partner would never use these tactics in our relationships. If we ever have problems, we simply communicate them. We don't ignore one another \& wait for someone to break the stalemate.
	\item No, I don't get the sense they're pulling away or trying to avoid me. They might go quiet after an argument or something, but that's about it.
	\item Sometimes, but it's been that way since the start of our relationship. It'd be nice to have consistency with my partner, but if I don't hear from them for a day, that's all right.
	\item Yes, \& it really confuses me after how attentive they were in the beginning of our relationship. It feels like they're constantly making excuses about why they can't communicate or spend time with me.
\end{itemize}
{\sf F. What about your feelings in the relationship?}
\begin{itemize}
	\item I feel calm, peaceful, \& safe in my relationship. It has been consistent since the start.
	\item I'm mostly happy with my relationship \& I know I can communicate with my partner if I have concerns.
	\item I'm not very happy in the relationship, but I still feel comfortable expressing my opinions \& frustrations.
	\item I used to be such an easygoing person, but now I feel jealous, desperate, \& needy all the time.
\end{itemize}
{\sf G. Are you afraid of losing this person?}
\begin{itemize}
	\item Why would I ever worry about losing my partner? I know that our love is mutual, \& that our relationship is healthy. This isn't even something that would enter my mind.
	\item No, we both enjoy one another's company \& share similar feelings about the relationship.
	\item I'm not really 100\% confident about our relationship, but I don't think they'd leave me.
	\item Yes, after 1st showering me with praise \& flattery, they suddenly seem reclusive \& uninterested. I worry that any fight could be our last.
\end{itemize}
{\sf H. Do you trust your partner?}
\begin{itemize}
	\item Absolutely, I would trust them with my life.
	\item Sure, they don't do anything to make me distrust them.
	\item Not really, because they seemed to change into a different person as time went on, so I never really knew what to expect.
	\item No. I can't explain why, but I frequently find myself playing detective \& digging into their claims.
\end{itemize}
{\sf I. Is there drama in your relationship?}
\begin{itemize}
	\item We rarely ever get into arguments because we naturally understand how the other is feeling. We don't try to make each other jealous or create unnecessary tension. We're both striving to build trust with one another.
	\item It's a regular amount of drama for any relationship. Nothing I haven't experienced with my other partners.
	\item We argue a lot, but the same issues don't come up over \& over again. However, I do wish I could be in a relationship with less fighting.
	\item They said they hate drama, but there seems to be so much of it. We're always arguing about the same things. It feels like they're creating drama \& then judging me for reacting to it.
\end{itemize}
{\sf J. How do they handle boredom?}
\begin{itemize}
	\item They never get bored, \& they enjoy spending time alone with their thoughts.
	\item They get bored with mundane tasks, but don't we al;?
	\item They get bored pretty easily, but they don't mind spending periods of time on their own.
	\item They're always bored \& constantly seek attention from others.
\end{itemize}
{\sf K. What about their ex?}
\begin{itemize}
	\item They never mentioned their ex \& it's never been discussed in our relationship.
	\item They're on good terms with their ex but they don't talk or communicate much, so it's not really an issue in our relationship.
	\item They're friends with their ex \& it makes me feel uncomfortable. But they've always been friends, so it's not my place to say anything.
	\item They claim their ``crazy'' ex is jealous of us \& I have nothing to worry about, but for some reason I suspect they're still talking. I feel like I'm always in competition with others for my partner's attention.
\end{itemize}
{\sf L. What was your relationship like in the beginning?}
\begin{itemize}
	\item We were great friends. It didn't move too fast, we just made each other laugh \& had fun together. All of my friends \& family liked them a lot, \& we've been happy together ever since.
	\item Just like any other relationship starts. We got to know each other \& had a bunch of things in common. Things have fizzled down since then, but we still like each other a lot. If there was a honeymoon phase, it certainly didn't consume my life.
	\item Nothing special at 1st. We went on a few dates \& I noticed some things that felt off (like maybe being rude to a waiter), but overall they seemed fine. The more we got to know each other, the more comfortable I became.
	\item Life-consuming! Much more attentive than my previous partners. They seemed to have all the right things in common with me, implying we were perfect for each other. They texted me constantly \& seemed infatuated by every single thing about me. 
\end{itemize}
{\sf M. How does this person treat you?}
\begin{itemize}
	\item They go above \& beyond to listen to my feelings \& understand where I'm coming from. I always feel respected in my relationship. If I bring up a concern, they're always willing to talk about it \& improve their behavior to help our relationship.
	\item Just like anyone else treats me. We joke around, have fun, \& enjoy one another's company. We both treat each other like adults.
	\item They're usually not very nice to me, but it's always been that way. I don't need a lot of affection or mushy kindness, so it's fine.
	\item I don't even know anymore. We have good days, where it feels like the perfect beginning of our relationship again. But usually they're patronizing \& critical, or they ignore me. I feel sensitive \& crazy for being hurt by their behavior.
\end{itemize}
\textbf{Results.}
\begin{itemize}
	\item {\sf13--20: You Know a Genuinely Good Person!} Great news! This person seems like the complete opposite of a psychopath. They are empathetic, warm, \& caring. Their intentions are genuine \& their behavior reflects that. Wishing you a long \& happy relationship!
	\item {\sf21--30: They're Not a Psychopath.} Good news! This person does not seem like a psychopath. You have ups \& downs, just like any normal relationship. As long as you are happy, this is probably a healthy dynamic.
	\item {\sf31--41: You Might Know a Psychopath.} Be careful! There are some red flags about this person. They may or may not be a psychopath, but the bottom line is that you deserve to be in a relationship with someone who makes you happy. Someone who is empathetic, kind, \& compassionate. Does this person embody those qualities?
	\item {\sf42--52: You Definitely Know a Psychopath.} Watch out! This person fits most of the traits of a psychopath. Are you constantly on edge around them? Did you go from feeling elated \& joyful to anxious \& frantic? Do they triangulate you with exes or other potential mates? Are you apologizing \& crying more than you ever have in your life? Do you feel like you've lost your entire sense of self since the start of this relationship? Healthy, loving partners aren't supposed to make you feel bad about yourself. But with psychopaths, the abuse always starts after you're already hooked.'' -- \cite[pp. 207--211]{MacKenzie2015}
\end{itemize}

\subsection{PsychopathFree.Com Survivor Survey Responses}
``Since the original 30 Red Flags were published, they've been shared hundreds of thousands of times all over the Web. As the source exploded in popularity, it was important to me that each red flag be accurate \& validating to \textit{all} survivors -- not just a list of Jackson's experiences with the pronoun changed from ``me'' to ``you.''

\& so, the closeted statistician in me put together an anonymous survey for survivors to rate each red flag on a scale of 1 to 5, from ``Strongly Disagree'' to ``Strongly Agree,'' along with a free response section for stuff I missed. I thought a dozen or so people might take the time to fill in this out \& set me straight.

So you can only imagine my surprise when more than a thousand survivors stepped up to the plate to share their feedback. All red flags had a majority response of ``Strongly Agree,'' which was absolutely shocking to me. But some rated slightly lower than others, so I was determined to reexamine those \& make improvements for the new book. The updated red flags in this book are based directly on the most commonly mentioned phrases from a thousand survivors all around the world. \& like anything else I write, they're always a work in progress, so I invite you to share your own feedback \& criticism at \url{Survey.PsychopathFree.com}.

\textbf{Extracted Common Phrases from Free Responses.}
\begin{itemize}
	\item Eroded my boundaries.
	\item I groveled for forgiveness even though it was their fault.
	\item Chameleon could fit into any situation.
	\item Creates drama.
	\item Abuse was subtle \& covert.
	\item Seemed amused at my worst.
	\item I begged for them.
	\item Stared blankly when I was hurt.
	\item My life becomes complete chaos \& confusion.
	\item Mysterious childhood.
	\item Father ignored them.
	\item Mommy issues.
	\item Alcohol \& addiction.
	\item No closure, sudden end.
	\item Gossiped about me.
	\item Control by hypnosis \& neuro-linguistic programming.
	\item Flirting{\tt/}triangulating with everyone.
	\item They became my entire life \& I was isolated.
	\item Invokes pity \& sympathy.
	\item Word salad arguments made no sense.'' -- \cite[pp. 211--212]{MacKenzie2015}
\end{itemize}
