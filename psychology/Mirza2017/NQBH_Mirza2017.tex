...
``There is a lot of information out there about narcissism, which is really helpful to research. You dealt with a covert narcissist, but the core traits are the same, so the information will help. Since the covert type takes some more digging to find, I found it helpful to read books about manipulation \& control as well to understand what that looks like.

\subsection{Books I Recommend}

\begin{itemize}
	\item \textit{The Wizard of Oz \& other Narcissists} by Eleanor D. Payson, M.S.W.
	\item \textit{Psychopath Free} by Jackson MacKenzie
	\item \textit{In Sheep's Clothing: Understanding \& Dealing with Manipulative People} by George K. Simon, Ph.D.
	\item 30 Covert Emotional Manipulation Tactics: How Manipulators Take Control In Personal Relationships by Adelyn Birch
	\item \textit{Why Does He Do That?: Inside the Minds of Angry \& Controlling Men} by Lundy Bancroft
	\item \textit{Healing from Hidden Abuse: A Journey Through the Stages of Recovery from Psychological Abuse} by Shannon Thomas.
	\item \textit{Will I Ever Be Good Enough: Healing the Daughters of Narcissistic Mothers} by Karyl McBride
	\item \textit{The Safest Place Possible: A Guide to Healing \& Transformation} by Debbie Mirza (This is about healing \& self-love)
	\item \textit{The Secret Language of Your Body: The Essential Guide to Health \& Wellness} by Inna Segal (This is the book mentioned in Chapter 12)
\end{itemize}

\subsection{YouTube Channels I Recommend}
YouTube is a fantastic resource with a lot of people talking about narcissism. Use your own intuition as your guide as you watch videos. Notice how your body reacts when you listen. If you find your stomach tightening, your head feeling foggy, or your body feeling off, move to another video. Not everyone is giving accurate information. Trust your body. It recognizes truth.
\begin{itemize}
	\item Inner Integration -- Meredith Miller
	\item Tracy A. Malone
	\item Dad Surviving Divorce
\end{itemize}
...
\begin{itemize}
	\item \url{https://narcissistabusesupport.com/}
	\item \url{http://www.kaleahlaroche.com/}
	\item \url{https://www.psychopathfree.com/}
	\item \url{https://www.wnaad.com/}
	\item\url{ https//www.innerintegration.com}
\end{itemize}

\subsection{Articles \& Books Quoted}

\begin{itemize}
	\item \url{www.psychologytoday.com/blog/hope-relationships/201512/what-is-emotional-abuse}
	\item \url{www.psychologytoday.com/blog/traversing-the-inner-terrain/201609/when-is-it-emotional-abuse}
	\item {\small\url{https://www.psychologytoday.com/blog/here-there-and-everywhere/201701/11-warning-signs-gaslighting-in-relationships}}
	\item \textit{Blink: The Power of Thinking Without Thinking} by Malcolm Gladwell -- Quoted in Chapter 12.
	\item YouTube Video Referenced on Intermittent Reinforcement: \url{https://www.youtube.com/watch?v=kan2ZGqEOso}
	\item Helpful Documentary: 	Holy Hell \url{www.imdb.com/title/tt5278464}.'' -- \cite[pp. 173--174]{Mirza2017}
\end{itemize}
